// Code generated for linux/386 by 'ccgo -o test.go /home/builduser/hid/amalgamation/hid_libusb_amalgamation.c', DO NOT EDIT.
...
const __GCC_ATOMIC_CHAR8_T_LOCK_FREE = 2
...
const __STDC_ISO_10646__ = 201206
...
func libusb_control_transfer_get_data(tls *libc.TLS, transfer uintptr) (r uintptr) {
	return (*libusb_transfer)(unsafe.Pointer(transfer)).Fbuffer + uintptr(libc.Uint32FromInt64(8))
}
...
func libusb_fill_control_transfer(tls *libc.TLS, transfer uintptr, dev_handle uintptr, buffer uintptr, __ccgo_fp_callback libusb_transfer_cb_fn, user_data uintptr, timeout uint32) {
	...
	if setup != 0 {
		(*libusb_transfer)(unsafe.Pointer(transfer)).Flength = libc.Int32FromUint32(libc.Uint32FromInt64(8) + uint32(libusb_cpu_to_le16(tls, (*libusb_control_setup)(unsafe.Pointer(setup)).FwLength)))
	}
...
func libusb_set_iso_packet_lengths(tls *libc.TLS, transfer uintptr, length uint32) {
	...
	for {
		...
		(*(*libusb_iso_packet_descriptor)(unsafe.Pointer(transfer + 40 + uintptr(i)*12))).Flength = length
		goto _1
	_1:
		;
		i = i + 1
...
func libusb_get_iso_packet_buffer(tls *libc.TLS, transfer uintptr, packet uint32) (r uintptr) {
	...
	for {
		...
		offset = offset + (*(*libusb_iso_packet_descriptor)(unsafe.Pointer(transfer + 40 + uintptr(i)*12))).Flength
		goto _1
	_1:
		;
		i = i + 1
...
func libusb_get_iso_packet_buffer_simple(tls *libc.TLS, transfer uintptr, packet uint32) (r uintptr) {
	...
	return (*libusb_transfer)(unsafe.Pointer(transfer)).Fbuffer + uintptr(libc.Int32FromUint32((*(*libusb_iso_packet_descriptor)(unsafe.Pointer(transfer + 40))).Flength)*_packet)
}
...
type atomic_long = int32

type atomic_ulong = uint32
...
type atomic_intptr_t = int32

type atomic_uintptr_t = uint32

type atomic_size_t = uint32

type atomic_ptrdiff_t = int32
...
func __CPU_AND_S(tls *libc.TLS, __size size_t, __dest uintptr, __src1 uintptr, __src2 uintptr) {
	...
	__i = uint32(0)
	for {
		if !(__i < __size/uint32(4)) {
			break
		}
		*(*uint32)(unsafe.Pointer(__dest + uintptr(__i)*4)) = *(*uint32)(unsafe.Pointer(__src1 + uintptr(__i)*4)) & *(*uint32)(unsafe.Pointer(__src2 + uintptr(__i)*4))
		goto _1
	_1:
		;
		__i = __i + 1
...
var __func__ = [23]int8{'u', 's', 'b', 'i', '_', 'm', 'u', 't', 'e', 'x', '_', 's', 't', 'a', 't', 'i', 'c', '_', 'l', 'o', 'c', 'k'}
...
var __func__1 = [25]int8{'u', 's', 'b', 'i', '_', 'm', 'u', 't', 'e', 'x', '_', 's', 't', 'a', 't', 'i', 'c', '_', 'u', 'n', 'l', 'o', 'c', 'k'}
...
var __func__2 = [16]int8{'u', 's', 'b', 'i', '_', 'm', 'u', 't', 'e', 'x', '_', 'i', 'n', 'i', 't'}
...
var __func__3 = [16]int8{'u', 's', 'b', 'i', '_', 'm', 'u', 't', 'e', 'x', '_', 'l', 'o', 'c', 'k'}
...
var __func__4 = [18]int8{'u', 's', 'b', 'i', '_', 'm', 'u', 't', 'e', 'x', '_', 'u', 'n', 'l', 'o', 'c', 'k'}
...
var __func__5 = [19]int8{'u', 's', 'b', 'i', '_', 'm', 'u', 't', 'e', 'x', '_', 'd', 'e', 's', 't', 'r', 'o', 'y'}
...
var __func__6 = [15]int8{'u', 's', 'b', 'i', '_', 'c', 'o', 'n', 'd', '_', 'w', 'a', 'i', 't'}
...
var __func__7 = [17]int8{'u', 's', 'b', 'i', '_', 'c', 'o', 'n', 'd', '_', 's', 'i', 'g', 'n', 'a', 'l'}
...
var __func__8 = [20]int8{'u', 's', 'b', 'i', '_', 'c', 'o', 'n', 'd', '_', 'b', 'r', 'o', 'a', 'd', 'c', 'a', 's', 't'}
...
var __func__9 = [18]int8{'u', 's', 'b', 'i', '_', 'c', 'o', 'n', 'd', '_', 'd', 'e', 's', 't', 'r', 'o', 'y'}
...
var __func__10 = [20]int8{'u', 's', 'b', 'i', '_', 't', 'l', 's', '_', 'k', 'e', 'y', '_', 'c', 'r', 'e', 'a', 't', 'e'}
...
var __func__11 = [17]int8{'u', 's', 'b', 'i', '_', 't', 'l', 's', '_', 'k', 'e', 'y', '_', 's', 'e', 't'}
...
var __func__12 = [20]int8{'u', 's', 'b', 'i', '_', 't', 'l', 's', '_', 'k', 'e', 'y', '_', 'd', 'e', 'l', 'e', 't', 'e'}
...
var __func__13 = [17]int8{'u', 's', 'b', 'i', '_', 'g', 'e', 't', '_', 'c', 'o', 'n', 't', 'e', 'x', 't'}
...
var __func__14 = [24]int8{'u', 's', 'b', 'i', '_', 'g', 'e', 't', '_', 'm', 'o', 'n', 'o', 't', 'o', 'n', 'i', 'c', '_', 't', 'i', 'm', 'e'}
...
var __func__15 = [19]int8{'u', 's', 'b', 'i', '_', 'g', 'e', 't', '_', 'r', 'e', 'a', 'l', '_', 't', 'i', 'm', 'e'}
...
func usbi_get_context_priv(tls *libc.TLS, ctx uintptr) (r uintptr) {
	return ctx + uintptr((libc.Uint32FromInt64(352)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
}

func usbi_get_device_priv(tls *libc.TLS, dev uintptr) (r uintptr) {
	return dev + uintptr((libc.Uint32FromInt64(68)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
}

func usbi_get_device_handle_priv(tls *libc.TLS, dev_handle uintptr) (r uintptr) {
	return dev_handle + uintptr((libc.Uint32FromInt64(44)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
}
...
var __func__16 = [18]int8{'u', 's', 'b', 'i', '_', 'c', 'r', 'e', 'a', 't', 'e', '_', 'e', 'v', 'e', 'n', 't'}
...
var __func__17 = [19]int8{'u', 's', 'b', 'i', '_', 'd', 'e', 's', 't', 'r', 'o', 'y', '_', 'e', 'v', 'e', 'n', 't'}
...
func usbi_signal_event(tls *libc.TLS, event uintptr) {
	...
	*(*uint64_t)(unsafe.Pointer(bp)) = uint64(1)
	r = libc.Xwrite(tls, *(*int32)(unsafe.Pointer(event + 1*4)), bp, uint32(8))
	if libc.Uint32FromInt32(r) != uint32(8) {
		usbi_log(tls, libc.UintptrFromInt32(0), int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__18)), __ccgo_ts+802, 0)
	}
}

var __func__18 = [18]int8{'u', 's', 'b', 'i', '_', 's', 'i', 'g', 'n', 'a', 'l', '_', 'e', 'v', 'e', 'n', 't'}
...
func usbi_alloc_event_data(tls *libc.TLS, ctx uintptr) (r int32) {
	...
	ievent_source = uintptr(uint32((*list_head)(unsafe.Pointer(ctx+304)).Fnext) - uint32(libc.UintptrFromInt32(0)+8))
	for {
		if !(ievent_source+8 != ctx+304) {
			break
		}
		(*libusb_context)(unsafe.Pointer(ctx)).Fevent_data_cnt = (*libusb_context)(unsafe.Pointer(ctx)).Fevent_data_cnt + 1
		goto _1
	_1:
		;
		ievent_source = uintptr(uint32((*usbi_event_source)(unsafe.Pointer(ievent_source)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+8))
	}
	fds = libc.Xcalloc(tls, (*libusb_context)(unsafe.Pointer(ctx)).Fevent_data_cnt, uint32(8))
	if !(fds != 0) {
...
func usbi_wait_for_events(tls *libc.TLS, ctx uintptr, reported_events uintptr, timeout_ms int32) (r int32) {
	...
	nfds = (*libusb_context)(unsafe.Pointer(ctx)).Fevent_data_cnt
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__20)), __ccgo_ts+839, libc.VaList(bp+8, nfds, timeout_ms))
	...
	internal_fds = v1
	fds = fds + uintptr(internal_fds)*8
	nfds = nfds - libc.Uint32FromInt32(internal_fds)
	usbi_mutex_lock(tls, ctx+272)
	if (*libusb_context)(unsafe.Pointer(ctx)).Fevent_flags&uint32(USBI_EVENT_EVENT_SOURCES_MODIFIED) != 0 {
		ievent_source = uintptr(uint32((*list_head)(unsafe.Pointer(ctx+312)).Fnext) - uint32(libc.UintptrFromInt32(0)+8))
		for {
			if !(ievent_source+8 != ctx+312) {
				break
			}
			n = uint32(0)
			for {
	...
	if num_ready != 0 {
		...
		(*usbi_reported_events)(unsafe.Pointer(reported_events)).Fevent_data_count = nfds
	}
	goto done
done:
	;
...
var __func__20 = [21]int8{'u', 's', 'b', 'i', '_', 'w', 'a', 'i', 't', '_', 'f', 'o', 'r', '_', 'e', 'v', 'e', 'n', 't', 's'}
...
var __func__21 = [15]int8{'u', 's', 'b', 'i', '_', 'c', 'o', 'n', 'd', '_', 'i', 'n', 'i', 't'}
...
func usbi_cond_timedwait(tls *libc.TLS, cond uintptr, mutex uintptr, tv uintptr) (r1 int32) {
	...
	v1 = bp + 8
	*(*int32)(unsafe.Pointer(v1)) = int32(int64(*(*int32)(unsafe.Pointer(v1))) + (*timeval)(unsafe.Pointer(tv)).Ftv_usec*libc.Int64FromInt32(1000))
	if (*(*timespec)(unsafe.Pointer(bp))).Ftv_nsec >= int32(1000000000) {
		(*(*timespec)(unsafe.Pointer(bp))).Ftv_nsec -= int32(1000000000)
		(*(*timespec)(unsafe.Pointer(bp))).Ftv_sec = (*(*timespec)(unsafe.Pointer(bp))).Ftv_sec + 1
	}
...
func usbi_get_tid(tls *libc.TLS) (r uint32) {
	var tid, v1 uint32
	_, _ = tid, v1
	if tl_tid != 0 {
		return tl_tid
	}
	tid = libc.Uint32FromInt32(libc.Xsyscall(tls, int32(224), 0))
	if tid == libc.Uint32FromInt32(2147483647)*libc.Uint32FromUint32(2)+libc.Uint32FromUint32(1) {
		tid = uint32(libc.Xpthread_self(tls))
	}
	v1 = tid
	tl_tid = v1
	return v1
...
type __kernel_mode_t = uint16

type __kernel_ipc_pid_t = uint16

type __kernel_uid_t = uint16

type __kernel_gid_t = uint16

type __kernel_old_dev_t = uint16

type __kernel_long_t = int32

type __kernel_ulong_t = uint32

type __kernel_ino_t = uint32

type __kernel_pid_t = int32

type __kernel_suseconds_t = int32
...
type __kernel_size_t = uint32

type __kernel_ssize_t = int32

type __kernel_ptrdiff_t = int32

type __kernel_fsid_t = struct {
	Fval [2]int32
}

type __kernel_off_t = int32

type __kernel_loff_t = int64

type __kernel_old_time_t = int32

type __kernel_time_t = int32

type __kernel_time64_t = int64

type __kernel_clock_t = int32
...
func dev_has_config0(tls *libc.TLS, dev uintptr) (r int32) {
	...
	for {
		...
		config = (*linux_device_priv)(unsafe.Pointer(priv)).Fconfig_descriptors + uintptr(idx)*8
...
func get_usbfs_fd(tls *libc.TLS, dev uintptr, access_mode int32, silent int32) (r int32) {
	...
	defer tls.Free(64)
	var ctx uintptr
	var delay_ms, fd int32
	var retry, v1 uint8_t
	var _ /* delay_ts at bp+24 */ timespec
	var _ /* path at bp+0 */ [24]int8
	_, _, _, _, _ = ctx, delay_ms, fd, retry, v1
	ctx = (*libusb_device)(unsafe.Pointer(dev)).Fctx
	if usbdev_names != 0 {
		libc.X__builtin_snprintf(tls, bp, uint32(24), __ccgo_ts+1119, libc.VaList(bp+48, libc.Int32FromUint8((*libusb_device)(unsafe.Pointer(dev)).Fbus_number), libc.Int32FromUint8((*libusb_device)(unsafe.Pointer(dev)).Fdevice_address)))
	} else {
		libc.X__builtin_snprintf(tls, bp, uint32(24), __ccgo_ts+1136, libc.VaList(bp+48, libc.Int32FromUint8((*libusb_device)(unsafe.Pointer(dev)).Fbus_number), libc.Int32FromUint8((*libusb_device)(unsafe.Pointer(dev)).Fdevice_address)))
	}
	...
	if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(2) {
		...
		*(*timespec)(unsafe.Pointer(bp + 24)) = timespec{
			Ftv_nsec: delay_ms * int32(1000) * int32(1000),
		}
		retry = uint8(3)
		for {
			v1 = retry
...
var __func__22 = [13]int8{'g', 'e', 't', '_', 'u', 's', 'b', 'f', 's', '_', 'f', 'd'}
...
var __func__23 = [16]int8{'i', 's', '_', 'u', 's', 'b', 'd', 'e', 'v', '_', 'e', 'n', 't', 'r', 'y'}

func find_usbfs_path(tls *libc.TLS) (r uintptr) {
	var dir, entry, path, v1 uintptr
	_, _, _, _ = dir, entry, path, v1
	path = __ccgo_ts + 1348
	...
	if dir != 0 {
		for {
			...
			if int32(*(*int8)(unsafe.Pointer(entry + 19))) == int32('.') {
				continue
			}
			break
		}
...
var __func__24 = [19]int8{'g', 'e', 't', '_', 'k', 'e', 'r', 'n', 'e', 'l', '_', 'v', 'e', 'r', 's', 'i', 'o', 'n'}
...
func op_init(tls *libc.TLS, ctx uintptr) (r1 int32) {
	...
	var _ /* statfsbuf at bp+12 */ statfs1
	...
	if !(kernel_version_ge(tls, bp, int32(2), int32(6), int32(32)) != 0) {
		...
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__25)), __ccgo_ts+1463, libc.VaList(bp+104, (*(*kernel_version)(unsafe.Pointer(bp))).Fmajor, (*(*kernel_version)(unsafe.Pointer(bp))).Fminor, v1))
		return int32(LIBUSB_ERROR_NOT_SUPPORTED)
	}
	usbfs_path = find_usbfs_path(tls)
	if !(usbfs_path != 0) {
		usbfs_path = __ccgo_ts + 1348
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__25)), __ccgo_ts+1512, libc.VaList(bp+104, usbfs_path))
	} else {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__25)), __ccgo_ts+1551, libc.VaList(bp+104, usbfs_path))
	}
	...
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__25)), __ccgo_ts+1569, libc.VaList(bp+104, max_iso_packet_len))
	if sysfs_available == -int32(1) {
		r = libc.Xstatfs(tls, __ccgo_ts+1612, bp+12)
		if r == 0 && (*(*statfs1)(unsafe.Pointer(bp + 12))).Ff_type == uint32(0x62656572) {
...
var __func__25 = [8]int8{'o', 'p', '_', 'i', 'n', 'i', 't'}
...
var __func__26 = [8]int8{'o', 'p', '_', 'e', 'x', 'i', 't'}
...
var __func__27 = [14]int8{'o', 'p', '_', 's', 'e', 't', '_', 'o', 'p', 't', 'i', 'o', 'n'}
...
func op_get_device_string(tls *libc.TLS, dev uintptr, string_type libusb_device_string_type, buffer uintptr, length int32) (r1 int32) {
	...
	r = libc.Xread(tls, fd, buffer, libc.Uint32FromInt32(length-int32(1)))
	if r < 0 {
		r = *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))
		libc.Xclose(tls, fd)
		if r == int32(19) {
			return int32(LIBUSB_ERROR_NO_DEVICE)
		}
	...
	libc.Xclose(tls, fd)
	*(*int8)(unsafe.Pointer(buffer + uintptr(r))) = 0
	for r != 0 && (int32(*(*int8)(unsafe.Pointer(buffer + uintptr(r)))) == 0 || int32(*(*int8)(unsafe.Pointer(buffer + uintptr(r)))) == int32('\n')) {
		v1 = r
		r = r - 1
...
var __func__28 = [21]int8{'o', 'p', '_', 'g', 'e', 't', '_', 'd', 'e', 'v', 'i', 'c', 'e', '_', 's', 't', 'r', 'i', 'n', 'g'}
...
func open_sysfs_attr(tls *libc.TLS, ctx uintptr, sysfs_dir uintptr, attr uintptr) (r int32) {
	...
	defer tls.Free(288)
	var fd int32
	var _ /* filename at bp+0 */ [256]int8
	_ = fd
	libc.X__builtin_snprintf(tls, bp, uint32(256), __ccgo_ts+1860, libc.VaList(bp+264, sysfs_dir, attr))
...
var __func__29 = [16]int8{'o', 'p', 'e', 'n', '_', 's', 'y', 's', 'f', 's', '_', 'a', 't', 't', 'r'}
...
func read_sysfs_attr(tls *libc.TLS, ctx uintptr, sysfs_dir uintptr, attr uintptr, max_value int32, value_p uintptr) (r1 int32) {
	...
	var _ /* endptr at bp+20 */ uintptr
	_, _, _ = fd, r, value
	fd = open_sysfs_attr(tls, ctx, sysfs_dir, attr)
	if fd < 0 {
		return fd
	}
	r = libc.Xread(tls, fd, bp, uint32(libc.Uint32FromInt64(20)-libc.Uint32FromInt32(1)))
	if r < 0 {
		r = *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))
		libc.Xclose(tls, fd)
		if r == int32(19) {
		...
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__30)), __ccgo_ts+1824, libc.VaList(bp+32, attr, r))
		return int32(LIBUSB_ERROR_IO)
	}
	libc.Xclose(tls, fd)
	if r == 0 {
	...
	if !(libc.BoolInt32(libc.Uint32FromInt8((*(*[20]int8)(unsafe.Pointer(bp)))[0])-libc.Uint32FromUint8('0') < libc.Uint32FromInt32(10)) != 0) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__30)), __ccgo_ts+1912, libc.VaList(bp+32, attr))
		return int32(LIBUSB_ERROR_IO)
	} else {
		if int32((*(*[20]int8)(unsafe.Pointer(bp)))[r-int32(1)]) != int32('\n') {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__30)), __ccgo_ts+1953, libc.VaList(bp+32, attr))
		} else {
			r = r - 1
		}
	}
	(*(*[20]int8)(unsafe.Pointer(bp)))[r] = int8('\000')
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	value = libc.Xstrtol(tls, bp, bp+20, int32(10))
	if bp == *(*uintptr)(unsafe.Pointer(bp + 20)) || value < 0 || value > max_value || *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__30)), __ccgo_ts+1992, libc.VaList(bp+32, attr, bp))
		return int32(LIBUSB_ERROR_INVALID_PARAM)
	} else {
		if int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 20))))) != int32('\000') {
			if int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 20))))) == int32('.') && libc.BoolInt32(libc.Uint32FromInt8(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 20)) + libc.UintptrFromInt32(1))))-uint32('0') < uint32(10)) != 0 {
				*(*uintptr)(unsafe.Pointer(bp + 20)) = *(*uintptr)(unsafe.Pointer(bp + 20)) + 1
				for libc.BoolInt32(libc.Uint32FromInt8(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 20)))))-uint32('0') < uint32(10)) != 0 {
					*(*uintptr)(unsafe.Pointer(bp + 20)) = *(*uintptr)(unsafe.Pointer(bp + 20)) + 1
				}
			}
			if int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 20))))) != int32('\000') {
	...
	*(*int32)(unsafe.Pointer(value_p)) = value
	return 0
}

var __func__30 = [16]int8{'r', 'e', 'a', 'd', '_', 's', 'y', 's', 'f', 's', '_', 'a', 't', 't', 'r'}
...
func linux_get_device_address(tls *libc.TLS, ctx uintptr, detached int32, busnum uintptr, devaddr uintptr, dev_node uintptr, sys_name uintptr, fd int32) (r1 int32) {
	...
	var fd_path uintptr
	var r int32
	var _ /* proc_path at bp+4 */ [32]int8
	...
	if !(sysfs_available != 0) || detached != 0 || !(sys_name != 0) {
		if !(dev_node != 0) && fd >= 0 {
			fd_path = libc.X__builtin_alloca(tls, uint32(4096))
			libc.X__builtin_snprintf(tls, bp+4, uint32(32), __ccgo_ts+2101, libc.VaList(bp+48, fd))
			r = libc.Xreadlink(tls, bp+4, fd_path, libc.Uint32FromInt32(libc.Int32FromInt32(4096)-libc.Int32FromInt32(1)))
			if r > 0 {
				*(*int8)(unsafe.Pointer(fd_path + uintptr(r))) = int8('\000')
				dev_node = fd_path
			}
		}
		if !(dev_node != 0) {
		...
		if !(libc.Xstrncmp(tls, dev_node, __ccgo_ts+1348, uint32(12)) != 0) {
...
var __func__31 = [25]int8{'l', 'i', 'n', 'u', 'x', '_', 'g', 'e', 't', '_', 'd', 'e', 'v', 'i', 'c', 'e', '_', 'a', 'd', 'd', 'r', 'e', 's', 's'}
...
func seek_to_next_config(tls *libc.TLS, ctx uintptr, buffer uintptr, len1 size_t) (r int32) {
	...
	for len1 > uint32(0) {
		...
		if len1 < uint32((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__32)), __ccgo_ts+2253, libc.VaList(bp+8, uint32((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)-len1))
			return int32(LIBUSB_ERROR_IO)
		}
		offset = offset + libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)
		buffer = buffer + uintptr((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)
		len1 = len1 - uint32((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)
	}
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__32)), __ccgo_ts+2283, 0)
	return int32(LIBUSB_ERROR_IO)
}

var __func__32 = [20]int8{'s', 'e', 'e', 'k', '_', 't', 'o', '_', 'n', 'e', 'x', 't', '_', 'c', 'o', 'n', 'f', 'i', 'g'}
...
func parse_config_descriptors(tls *libc.TLS, dev uintptr) (r int32) {
	...
	(*linux_device_priv)(unsafe.Pointer(priv)).Fconfig_descriptors = libc.Xmalloc(tls, uint32(num_configs)*uint32(8))
	...
	remaining = (*linux_device_priv)(unsafe.Pointer(priv)).Fdescriptors_len - uint32(18)
	idx = uint8(0)
	for {
		if !(libc.Int32FromUint8(idx) < libc.Int32FromUint8(num_configs)) {
			break
		}
		if remaining < uint32(9) {
		...
		if (*linux_device_priv)(unsafe.Pointer(priv)).Fsysfs_dir != 0 {
			...
			if uint32(config_len) > remaining {
		...
		(*(*config_descriptor)(unsafe.Pointer((*linux_device_priv)(unsafe.Pointer(priv)).Fconfig_descriptors + uintptr(idx)*8))).Fdesc = config_desc
		(*(*config_descriptor)(unsafe.Pointer((*linux_device_priv)(unsafe.Pointer(priv)).Fconfig_descriptors + uintptr(idx)*8))).Factual_len = uint32(config_len)
		buffer = buffer + uintptr(config_len)
		remaining = remaining - uint32(config_len)
		goto _1
	_1:
		;
		idx = idx + 1
...
var __func__33 = [25]int8{'p', 'a', 'r', 's', 'e', '_', 'c', 'o', 'n', 'f', 'i', 'g', '_', 'd', 'e', 's', 'c', 'r', 'i', 'p', 't', 'o', 'r', 's'}
	...
	for {
		...
		if libc.Int32FromUint8((*usbi_configuration_descriptor)(unsafe.Pointer((*config_descriptor)(unsafe.Pointer(config)).Fdesc)).FbConfigurationValue) == libc.Int32FromUint8(value) {
			*(*uintptr)(unsafe.Pointer(buffer)) = (*config_descriptor)(unsafe.Pointer(config)).Fdesc
			return libc.Int32FromUint32((*config_descriptor)(unsafe.Pointer(config)).Factual_len)
		}
		goto _1
	_1:
		;
...
func op_get_active_config_descriptor(tls *libc.TLS, dev uintptr, buffer uintptr, len1 size_t) (r1 int32) {
	...
	var r int32
	var v1 uint32
	var _ /* active_config at bp+4 */ int32
	var _ /* config_desc at bp+0 */ uintptr
	_, _, _ = priv, r, v1
	priv = usbi_get_device_priv(tls, dev)
	if (*linux_device_priv)(unsafe.Pointer(priv)).Fsysfs_dir != 0 {
		r = sysfs_get_active_config(tls, dev, bp+4)
		if r < 0 {
			return r
		}
	} else {
		*(*int32)(unsafe.Pointer(bp + 4)) = (*linux_device_priv)(unsafe.Pointer(priv)).Factive_config
	}
	...
	r = op_get_config_descriptor_by_value(tls, dev, libc.Uint8FromInt32(*(*int32)(unsafe.Pointer(bp + 4))), bp)
	if r < 0 {
		return r
	}
	if len1 < libc.Uint32FromInt32(r) {
		v1 = len1
	} else {
		v1 = libc.Uint32FromInt32(r)
	}
	len1 = v1
...
var __func__34 = [32]int8{'o', 'p', '_', 'g', 'e', 't', '_', 'a', 'c', 't', 'i', 'v', 'e', '_', 'c', 'o', 'n', 'f', 'i', 'g', '_', 'd', 'e', 's', 'c', 'r', 'i', 'p', 't', 'o', 'r'}
...
func op_get_config_descriptor(tls *libc.TLS, dev uintptr, config_index uint8_t, buffer uintptr, len1 size_t) (r int32) {
	...
	config = (*linux_device_priv)(unsafe.Pointer(priv)).Fconfig_descriptors + uintptr(config_index)*8
...
func usbfs_get_active_config(tls *libc.TLS, dev uintptr, fd int32) (r1 int32) {
	...
	var _ /* ctrl at bp+4 */ usbfs_ctrltransfer
	_, _ = priv, r
	priv = usbi_get_device_priv(tls, dev)
	*(*uint8_t)(unsafe.Pointer(bp)) = uint8(0)
	*(*usbfs_ctrltransfer)(unsafe.Pointer(bp + 4)) = usbfs_ctrltransfer{
	...
	r = libc.Xioctl(tls, fd, libc.Int32FromUint32(uint32((libc.Uint32FromUint32(2)|libc.Uint32FromUint32(1))<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(0)))|libc.Uint32FromInt64(16)<<libc.Int32FromInt32(16)), libc.VaList(bp+32, bp+4))
	if r < 0 {
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(19) {
			return int32(LIBUSB_ERROR_NO_DEVICE)
		}
		usbi_log(tls, (*libusb_device)(unsafe.Pointer(dev)).Fctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__35)), __ccgo_ts+2563, libc.VaList(bp+32, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))))
		if (*linux_device_priv)(unsafe.Pointer(priv)).Fconfig_descriptors != 0 {
...
var __func__35 = [24]int8{'u', 's', 'b', 'f', 's', '_', 'g', 'e', 't', '_', 'a', 'c', 't', 'i', 'v', 'e', '_', 'c', 'o', 'n', 'f', 'i', 'g'}
...
var __func__36 = [16]int8{'u', 's', 'b', 'f', 's', '_', 'g', 'e', 't', '_', 's', 'p', 'e', 'e', 'd'}
...
func initialize_device(tls *libc.TLS, dev uintptr, busnum uint8_t, devaddr uint8_t, sysfs_dir uintptr, wrapped_fd int32) (r1 int32) {
	...
	if sysfs_dir != 0 {
		...
		if read_sysfs_attr(tls, ctx, sysfs_dir, __ccgo_ts+2629, int32(2147483647), bp) == 0 {
	...
	for cond := true; cond; cond = (*linux_device_priv)(unsafe.Pointer(priv)).Fdescriptors_len == alloc_len {
		desc_read_length = uint32(256)
		alloc_len = alloc_len + desc_read_length
		...
		*(*size_t)(unsafe.Pointer(priv + 8)) += libc.Uint32FromInt32(nb)
	}
	if fd != wrapped_fd {
		libc.Xclose(tls, fd)
	}
	if (*linux_device_priv)(unsafe.Pointer(priv)).Fdescriptors_len < uint32(18) {
	...
	libc.Xmemcpy(tls, dev+32, (*linux_device_priv)(unsafe.Pointer(priv)).Fdescriptors, uint32(18))
	if sysfs_dir != 0 {
		usbi_localize_device_descriptor(tls, dev+32)
		return int32(LIBUSB_SUCCESS)
	}
	if wrapped_fd < 0 {
...
var __func__37 = [18]int8{'i', 'n', 'i', 't', 'i', 'a', 'l', 'i', 'z', 'e', '_', 'd', 'e', 'v', 'i', 'c', 'e'}

func linux_get_parent_info(tls *libc.TLS, dev uintptr, sysfs_dir uintptr) (r int32) {
	bp := tls.Alloc(64)
	defer tls.Free(64)
	var add_parent, port_number, ret int32
	...
	ctx = (*libusb_device)(unsafe.Pointer(dev)).Fctx
	add_parent = int32(1)
	if !(sysfs_dir != 0) || !(libc.Xstrncmp(tls, sysfs_dir, __ccgo_ts+2835, uint32(3)) != 0) {
		return int32(LIBUSB_SUCCESS)
	}
	*(*uintptr)(unsafe.Pointer(bp)) = libc.Xstrdup(tls, sysfs_dir)
	...
	if v3 || v2 != 0 {
		start = tmp + uintptr(1)
		port_number = libc.Xstrtol(tls, start, bp+4, int32(10))
		if port_number < 0 || port_number > int32(2147483647) || start == *(*uintptr)(unsafe.Pointer(bp + 4)) || int32('\000') != int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 4))))) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__38)), __ccgo_ts+2839, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(bp))))
			libc.Xfree(tls, *(*uintptr)(unsafe.Pointer(bp)))
			return int32(LIBUSB_ERROR_OTHER)
		} else {
			(*libusb_device)(unsafe.Pointer(dev)).Fport_number = libc.Uint8FromInt32(port_number)
		}
		*(*int8)(unsafe.Pointer(tmp)) = int8('\000')
	} else {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__38)), __ccgo_ts+2891, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(bp))))
		libc.Xfree(tls, *(*uintptr)(unsafe.Pointer(bp)))
		return int32(LIBUSB_SUCCESS)
	}
	if !(libc.Xstrchr(tls, *(*uintptr)(unsafe.Pointer(bp)), int32('-')) != 0) {
		tmp = *(*uintptr)(unsafe.Pointer(bp))
		ret = libc.Xasprintf(tls, bp, __ccgo_ts+2935, libc.VaList(bp+16, tmp))
		libc.Xfree(tls, tmp)
		if ret < 0 {
			return int32(LIBUSB_ERROR_NO_MEM)
		}
...
retry:
	;
	usbi_mutex_lock(tls, ctx+20)
	it = uintptr(uint32((*list_head)(unsafe.Pointer(ctx+44)).Fnext) - uint32(libc.UintptrFromInt32(0)+20))
	for {
		if !(it+20 != ctx+44) {
			break
		}
	...
	_4:
		;
		it = uintptr(uint32((*libusb_device)(unsafe.Pointer(it)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+20))
	}
	usbi_mutex_unlock(tls, ctx+20)
	if !((*libusb_device)(unsafe.Pointer(dev)).Fparent_dev != 0) && add_parent != 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__38)), __ccgo_ts+2941, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(bp))))
		sysfs_scan_device(tls, ctx, *(*uintptr)(unsafe.Pointer(bp)))
		add_parent = 0
		goto retry
	}
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__38)), __ccgo_ts+2991, libc.VaList(bp+16, dev, sysfs_dir, (*libusb_device)(unsafe.Pointer(dev)).Fparent_dev, *(*uintptr)(unsafe.Pointer(bp)), libc.Int32FromUint8((*libusb_device)(unsafe.Pointer(dev)).Fport_number)))
	libc.Xfree(tls, *(*uintptr)(unsafe.Pointer(bp)))
	return int32(LIBUSB_SUCCESS)
}

var __func__38 = [22]int8{'l', 'i', 'n', 'u', 'x', '_', 'g', 'e', 't', '_', 'p', 'a', 'r', 'e', 'n', 't', '_', 'i', 'n', 'f', 'o'}
...
func linux_enumerate_device(tls *libc.TLS, ctx uintptr, busnum uint8_t, devaddr uint8_t, sysfs_dir uintptr) (r1 int32) {
	...
	session_id = libc.Uint32FromInt32(libc.Int32FromUint8(busnum)<<int32(8) | libc.Int32FromUint8(devaddr))
...
var __func__39 = [23]int8{'l', 'i', 'n', 'u', 'x', '_', 'e', 'n', 'u', 'm', 'e', 'r', 'a', 't', 'e', '_', 'd', 'e', 'v', 'i', 'c', 'e'}
...
func linux_hotplug_enumerate(tls *libc.TLS, busnum uint8_t, devaddr uint8_t, sys_name uintptr) {
	...
	ctx = uintptr(uint32((*list_head)(unsafe.Pointer(uintptr(unsafe.Pointer(&active_contexts_list)))).Fnext) - uint32(libc.UintptrFromInt32(0)+344))
	for {
		if !(ctx+344 != uintptr(unsafe.Pointer(&active_contexts_list))) {
			break
		}
	...
	_1:
		;
		ctx = uintptr(uint32((*libusb_context)(unsafe.Pointer(ctx)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+344))
	}
...
var __func__40 = [26]int8{'l', 'i', 'n', 'u', 'x', '_', 'd', 'e', 'v', 'i', 'c', 'e', '_', 'd', 'i', 's', 'c', 'o', 'n', 'n', 'e', 'c', 't', 'e', 'd'}
...
func parse_u8(tls *libc.TLS, str uintptr, val_p uintptr) (r int32) {
	...
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	...
	if num < 0 || num > int32(libc.Int32FromInt32(0xff)) || *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != 0 {
		return 0
	}
	if *(*uintptr)(unsafe.Pointer(bp)) == str || int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp))))) != int32('\000') {
		return 0
	}
	*(*uint8_t)(unsafe.Pointer(val_p)) = libc.Uint8FromInt32(num)
	return int32(1)
}
...
func usbfs_scan_busdir(tls *libc.TLS, ctx uintptr, busnum uint8_t) (r1 int32) {
	...
	var _ /* dirpath at bp+0 */ [20]int8
	_, _, _, _ = dir, entry, r, v1
	r = int32(LIBUSB_ERROR_IO)
	libc.X__builtin_snprintf(tls, bp, uint32(20), __ccgo_ts+3175, libc.VaList(bp+32, libc.Int32FromUint8(busnum)))
...
var __func__41 = [18]int8{'u', 's', 'b', 'f', 's', '_', 's', 'c', 'a', 'n', '_', 'b', 'u', 's', 'd', 'i', 'r'}
...
var __func__42 = [22]int8{'u', 's', 'b', 'f', 's', '_', 'g', 'e', 't', '_', 'd', 'e', 'v', 'i', 'c', 'e', '_', 'l', 'i', 's', 't'}
...
func sysfs_get_device_list(tls *libc.TLS, ctx uintptr) (r int32) {
	...
	for {
		...
		if !(libc.BoolInt32(libc.Uint32FromInt8(*(*int8)(unsafe.Pointer(entry + 19)))-libc.Uint32FromUint8('0') < libc.Uint32FromInt32(10)) != 0) && libc.Xstrncmp(tls, entry+19, __ccgo_ts+2835, uint32(3)) != 0 || libc.Xstrchr(tls, entry+19, int32(':')) != 0 {
			continue
		}
		...
		num_enumerated = num_enumerated + 1
	}
...
var __func__43 = [22]int8{'s', 'y', 's', 'f', 's', '_', 'g', 'e', 't', '_', 'd', 'e', 'v', 'i', 'c', 'e', '_', 'l', 'i', 's', 't'}
...
func initialize_handle(tls *libc.TLS, handle uintptr, fd int32) (r1 int32) {
	...
	r = libc.Xioctl(tls, fd, libc.Int32FromUint32(uint32(libc.Uint32FromUint32(2)<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(26)))|libc.Uint32FromInt64(4)<<libc.Int32FromInt32(16)), libc.VaList(bp+8, hpriv+12))
	if r < 0 {
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(25) {
			...
			usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__44)), __ccgo_ts+3386, libc.VaList(bp+8, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))))
		}
	...
	return usbi_add_event_source(tls, v1, (*linux_device_handle_priv)(unsafe.Pointer(hpriv)).Ffd, int16(0x004))
}

var __func__44 = [18]int8{'i', 'n', 'i', 't', 'i', 'a', 'l', 'i', 'z', 'e', '_', 'h', 'a', 'n', 'd', 'l', 'e'}

func op_wrap_sys_device(tls *libc.TLS, ctx uintptr, handle uintptr, sys_dev intptr_t) (r1 int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	var dev, hpriv uintptr
	var fd, r int32
	var _ /* busnum at bp+0 */ uint8_t
	var _ /* ci at bp+8 */ usbfs_connectinfo
	var _ /* devaddr at bp+1 */ uint8_t
	_, _, _, _ = dev, fd, hpriv, r
	hpriv = usbi_get_device_handle_priv(tls, handle)
	fd = sys_dev
	r = linux_get_device_address(tls, ctx, int32(1), bp, bp+1, libc.UintptrFromInt32(0), libc.UintptrFromInt32(0), fd)
	if r < 0 {
		r = libc.Xioctl(tls, fd, libc.Int32FromUint32(uint32(libc.Uint32FromUint32(1)<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(17)))|libc.Uint32FromInt64(8)<<libc.Int32FromInt32(16)), libc.VaList(bp+24, bp+8))
		if r < 0 {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__45)), __ccgo_ts+3410, libc.VaList(bp+24, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))))
			return int32(LIBUSB_ERROR_IO)
		}
		*(*uint8_t)(unsafe.Pointer(bp)) = uint8(0)
		*(*uint8_t)(unsafe.Pointer(bp + 1)) = uint8((*(*usbfs_connectinfo)(unsafe.Pointer(bp + 8))).Fdevnum)
	}
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__45)), __ccgo_ts+3439, libc.VaList(bp+24, fd))
	dev = usbi_alloc_device(tls, ctx, uint32(0))
	if !(dev != 0) {
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	...
	libc.X__c11_atomic_storeInt32(tls, dev+52, int32(libc.Int32FromInt32(1)), libc.Int32FromInt32(5))
...
var __func__45 = [19]int8{'o', 'p', '_', 'w', 'r', 'a', 'p', '_', 's', 'y', 's', '_', 'd', 'e', 'v', 'i', 'c', 'e'}
...
func op_open(tls *libc.TLS, handle uintptr) (r1 int32) {
	...
	if fd < 0 {
		if fd == int32(LIBUSB_ERROR_NO_DEVICE) {
			usbi_mutex_static_lock(tls, uintptr(unsafe.Pointer(&linux_hotplug_lock)))
			if libc.X__c11_atomic_loadInt32(tls, (*libusb_device_handle)(unsafe.Pointer(handle)).Fdev+52, libc.Int32FromInt32(5)) != 0 {
				if handle != 0 {
					v1 = (*libusb_device)(unsafe.Pointer((*libusb_device_handle)(unsafe.Pointer(handle)).Fdev)).Fctx
				} else {
					v1 = libc.UintptrFromInt32(0)
				}
				usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__46)), __ccgo_ts+3471, 0)
...
var __func__46 = [8]int8{'o', 'p', '_', 'o', 'p', 'e', 'n'}
...
var __func__47 = [21]int8{'o', 'p', '_', 'g', 'e', 't', '_', 'c', 'o', 'n', 'f', 'i', 'g', 'u', 'r', 'a', 't', 'i', 'o', 'n'}
...
func op_set_configuration(tls *libc.TLS, handle uintptr, _config int32) (r1 int32) {
	...
	*(*int32)(unsafe.Pointer(bp)) = _config
	...
	r = libc.Xioctl(tls, fd, libc.Int32FromUint32(uint32(libc.Uint32FromUint32(2)<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(5)))|libc.Uint32FromInt64(4)<<libc.Int32FromInt32(16)), libc.VaList(bp+16, bp))
	if r < 0 {
...
var __func__48 = [21]int8{'o', 'p', '_', 's', 'e', 't', '_', 'c', 'o', 'n', 'f', 'i', 'g', 'u', 'r', 'a', 't', 'i', 'o', 'n'}
...
func claim_interface(tls *libc.TLS, handle uintptr, _iface uint32) (r1 int32) {
	...
	*(*uint32)(unsafe.Pointer(bp)) = _iface
	...
	hpriv = usbi_get_device_handle_priv(tls, handle)
	fd = (*linux_device_handle_priv)(unsafe.Pointer(hpriv)).Ffd
	r = libc.Xioctl(tls, fd, libc.Int32FromUint32(uint32(libc.Uint32FromUint32(2)<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(15)))|libc.Uint32FromInt64(4)<<libc.Int32FromInt32(16)), libc.VaList(bp+16, bp))
	if r < 0 {
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(2) {
			return int32(LIBUSB_ERROR_NOT_FOUND)
		} else {
...
var __func__49 = [16]int8{'c', 'l', 'a', 'i', 'm', '_', 'i', 'n', 't', 'e', 'r', 'f', 'a', 'c', 'e'}
...
func release_interface(tls *libc.TLS, handle uintptr, _iface uint32) (r1 int32) {
	...
	*(*uint32)(unsafe.Pointer(bp)) = _iface
	...
	hpriv = usbi_get_device_handle_priv(tls, handle)
	fd = (*linux_device_handle_priv)(unsafe.Pointer(hpriv)).Ffd
	r = libc.Xioctl(tls, fd, libc.Int32FromUint32(uint32(libc.Uint32FromUint32(2)<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(16)))|libc.Uint32FromInt64(4)<<libc.Int32FromInt32(16)), libc.VaList(bp+16, bp))
	if r < 0 {
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(19) {
			return int32(LIBUSB_ERROR_NO_DEVICE)
		}
...
var __func__50 = [18]int8{'r', 'e', 'l', 'e', 'a', 's', 'e', '_', 'i', 'n', 't', 'e', 'r', 'f', 'a', 'c', 'e'}
...
func op_set_interface(tls *libc.TLS, handle uintptr, interface1 uint8_t, altsetting uint8_t) (r1 int32) {
	...
	r = libc.Xioctl(tls, fd, libc.Int32FromUint32(uint32(libc.Uint32FromUint32(2)<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(4)))|libc.Uint32FromInt64(8)<<libc.Int32FromInt32(16)), libc.VaList(bp+16, bp))
	if r < 0 {
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(22) {
			return int32(LIBUSB_ERROR_NOT_FOUND)
		} else {
...
var __func__51 = [17]int8{'o', 'p', '_', 's', 'e', 't', '_', 'i', 'n', 't', 'e', 'r', 'f', 'a', 'c', 'e'}
...
func op_clear_halt(tls *libc.TLS, handle uintptr, endpoint uint8) (r1 int32) {
	...
	*(*uint32)(unsafe.Pointer(bp)) = uint32(endpoint)
	r = libc.Xioctl(tls, fd, libc.Int32FromUint32(uint32(libc.Uint32FromUint32(2)<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(21)))|libc.Uint32FromInt64(4)<<libc.Int32FromInt32(16)), libc.VaList(bp+16, bp))
	if r < 0 {
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(2) {
			return int32(LIBUSB_ERROR_NOT_FOUND)
		} else {
...
var __func__52 = [14]int8{'o', 'p', '_', 'c', 'l', 'e', 'a', 'r', '_', 'h', 'a', 'l', 't'}

func op_reset_device(tls *libc.TLS, handle uintptr) (r1 int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	var fd, r, ret int32
	var hpriv, v2 uintptr
	var i uint8_t
	_, _, _, _, _, _ = fd, hpriv, i, r, ret, v2
	hpriv = usbi_get_device_handle_priv(tls, handle)
	fd = (*linux_device_handle_priv)(unsafe.Pointer(hpriv)).Ffd
	ret = 0
	i = uint8(0)
	for {
		...
		if (*libusb_device_handle)(unsafe.Pointer(handle)).Fclaimed_interfaces&(uint32(1)<<i) != 0 {
	...
	for {
		...
		if !((*libusb_device_handle)(unsafe.Pointer(handle)).Fclaimed_interfaces&(libc.Uint32FromUint32(1)<<i) != 0) {
			goto _3
		}
		...
		if r != 0 {
			...
			usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__53)), __ccgo_ts+3710, libc.VaList(bp+8, libc.Int32FromUint8(i), libusb_error_name(tls, r)))
			*(*uint32)(unsafe.Pointer(handle + 24)) &= ^(libc.Uint32FromUint32(1) << i)
			ret = int32(LIBUSB_ERROR_NOT_FOUND)
		}
		goto _3
	_3:
...
var __func__53 = [16]int8{'o', 'p', '_', 'r', 'e', 's', 'e', 't', '_', 'd', 'e', 'v', 'i', 'c', 'e'}

func do_streams_ioctl(tls *libc.TLS, handle uintptr, req uint32, num_streams uint32_t, endpoints uintptr, num_endpoints int32) (r1 int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	var fd, r int32
	...
	streams = libc.Xmalloc(tls, uint32(uint32(8)+libc.Uint32FromInt32(num_endpoints)))
	if !(streams != 0) {
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	...
	libc.Xmemcpy(tls, streams+8, endpoints, libc.Uint32FromInt32(num_endpoints))
	r = libc.Xioctl(tls, fd, libc.Int32FromUint32(req), libc.VaList(bp+8, streams))
...
var __func__54 = [17]int8{'d', 'o', '_', 's', 't', 'r', 'e', 'a', 'm', 's', '_', 'i', 'o', 'c', 't', 'l'}

func op_alloc_streams(tls *libc.TLS, handle uintptr, num_streams uint32_t, endpoints uintptr, num_endpoints int32) (r int32) {
	return do_streams_ioctl(tls, handle, uint32(libc.Uint32FromUint32(2)<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(28)))|libc.Uint32FromInt64(8)<<libc.Int32FromInt32(16), num_streams, endpoints, num_endpoints)
}

func op_free_streams(tls *libc.TLS, handle uintptr, endpoints uintptr, num_endpoints int32) (r int32) {
	return do_streams_ioctl(tls, handle, uint32(libc.Uint32FromUint32(2)<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(29)))|libc.Uint32FromInt64(8)<<libc.Int32FromInt32(16), uint32(0), endpoints, num_endpoints)
}
...
var __func__55 = [17]int8{'o', 'p', '_', 'd', 'e', 'v', '_', 'm', 'e', 'm', '_', 'a', 'l', 'l', 'o', 'c'}
...
var __func__56 = [16]int8{'o', 'p', '_', 'd', 'e', 'v', '_', 'm', 'e', 'm', '_', 'f', 'r', 'e', 'e'}
...
func op_kernel_driver_active(tls *libc.TLS, handle uintptr, interface1 uint8_t) (r1 int32) {
	...
	r = libc.Xioctl(tls, fd, libc.Int32FromUint32(uint32(libc.Uint32FromUint32(1)<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(8)))|libc.Uint32FromInt64(260)<<libc.Int32FromInt32(16)), libc.VaList(bp+272, bp))
	if r < 0 {
...
var __func__57 = [24]int8{'o', 'p', '_', 'k', 'e', 'r', 'n', 'e', 'l', '_', 'd', 'r', 'i', 'v', 'e', 'r', '_', 'a', 'c', 't', 'i', 'v', 'e'}
...
func op_detach_kernel_driver(tls *libc.TLS, handle uintptr, interface1 uint8_t) (r1 int32) {
	...
	var _ /* getdrv at bp+12 */ usbfs_getdriver
	_, _, _, _ = fd, hpriv, r, v1
	hpriv = usbi_get_device_handle_priv(tls, handle)
	fd = (*linux_device_handle_priv)(unsafe.Pointer(hpriv)).Ffd
	...
	(*(*usbfs_getdriver)(unsafe.Pointer(bp + 12))).Finterface1 = uint32(interface1)
	r = libc.Xioctl(tls, fd, libc.Int32FromUint32(uint32(libc.Uint32FromUint32(1)<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(8)))|libc.Uint32FromInt64(260)<<libc.Int32FromInt32(16)), libc.VaList(bp+280, bp+12))
	if r == 0 && !(libc.Xstrcmp(tls, bp+12+4, __ccgo_ts+3878) != 0) {
		return int32(LIBUSB_ERROR_NOT_FOUND)
	}
	r = libc.Xioctl(tls, fd, libc.Int32FromUint32(uint32((libc.Uint32FromUint32(2)|libc.Uint32FromUint32(1))<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(18)))|libc.Uint32FromInt64(12)<<libc.Int32FromInt32(16)), libc.VaList(bp+280, bp))
	if r < 0 {
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(61) {
			return int32(LIBUSB_ERROR_NOT_FOUND)
		} else {
		...
		usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__58)), __ccgo_ts+3884, libc.VaList(bp+280, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))))
		return int32(LIBUSB_ERROR_OTHER)
	}
	return 0
}

var __func__58 = [24]int8{'o', 'p', '_', 'd', 'e', 't', 'a', 'c', 'h', '_', 'k', 'e', 'r', 'n', 'e', 'l', '_', 'd', 'r', 'i', 'v', 'e', 'r'}
...
func op_attach_kernel_driver(tls *libc.TLS, handle uintptr, interface1 uint8_t) (r1 int32) {
	...
	(*(*usbfs_ioctl)(unsafe.Pointer(bp))).Fdata = libc.UintptrFromInt32(0)
	r = libc.Xioctl(tls, fd, libc.Int32FromUint32(uint32((libc.Uint32FromUint32(2)|libc.Uint32FromUint32(1))<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(18)))|libc.Uint32FromInt64(12)<<libc.Int32FromInt32(16)), libc.VaList(bp+24, bp))
	if r < 0 {
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(61) {
			return int32(LIBUSB_ERROR_NOT_FOUND)
		} else {
...
var __func__59 = [24]int8{'o', 'p', '_', 'a', 't', 't', 'a', 'c', 'h', '_', 'k', 'e', 'r', 'n', 'e', 'l', '_', 'd', 'r', 'i', 'v', 'e', 'r'}
...
func detach_kernel_driver_and_claim(tls *libc.TLS, handle uintptr, interface1 uint8_t) (r1 int32) {
	...
	r = libc.Xioctl(tls, fd, libc.Int32FromUint32(uint32(libc.Uint32FromUint32(2)<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(27)))|libc.Uint32FromInt64(264)<<libc.Int32FromInt32(16)), libc.VaList(bp+272, bp))
	if r == 0 {
		return 0
	}
...
var __func__60 = [31]int8{'d', 'e', 't', 'a', 'c', 'h', '_', 'k', 'e', 'r', 'n', 'e', 'l', '_', 'd', 'r', 'i', 'v', 'e', 'r', '_', 'a', 'n', 'd', '_', 'c', 'l', 'a', 'i', 'm'}
...
func discard_urbs(tls *libc.TLS, itransfer uintptr, first int32, last_plus_one int32) (r int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	var hpriv, tpriv, transfer, urb, v2 uintptr
	var i, ret int32
	_, _, _, _, _, _, _ = hpriv, i, ret, tpriv, transfer, urb, v2
	transfer = itransfer + uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
	...
	for {
		...
		if libc.Int32FromUint8((*libusb_transfer)(unsafe.Pointer(transfer)).Ftype1) == int32(LIBUSB_TRANSFER_TYPE_ISOCHRONOUS) {
			urb = *(*uintptr)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(tpriv)) + uintptr(i)*4))
		} else {
			urb = (*linux_transfer_priv)(unsafe.Pointer(tpriv)).F__ccgo0_0.Furbs + uintptr(i)*44
		}
		...
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(22) {
			if (*usbi_transfer)(unsafe.Pointer(transfer-uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev != 0 {
				v2 = (*libusb_device)(unsafe.Pointer((*usbi_transfer)(unsafe.Pointer(transfer - uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev)).Fctx
			} else {
				v2 = libc.UintptrFromInt32(0)
			}
			...
			if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(19) {
				...
				usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__61)), __ccgo_ts+4016, 0)
				...
				usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__61)), __ccgo_ts+4073, libc.VaList(bp+8, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))))
				ret = int32(LIBUSB_ERROR_OTHER)
			}
		}
		goto _1
...
var __func__61 = [13]int8{'d', 'i', 's', 'c', 'a', 'r', 'd', '_', 'u', 'r', 'b', 's'}
...
func submit_bulk_transfer(tls *libc.TLS, itransfer uintptr) (r1 int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	var bulk_buffer_len, i, is_out, last_urb_partial, num_urbs, r, use_bulk_continuation, v1 int32
	var hpriv, tpriv, transfer, urb, urbs, v3 uintptr
	_, _, _, _, _, _, _, _, _, _, _, _, _, _ = bulk_buffer_len, hpriv, i, is_out, last_urb_partial, num_urbs, r, tpriv, transfer, urb, urbs, use_bulk_continuation, v1, v3
	transfer = itransfer + uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
	tpriv = usbi_get_transfer_priv(tls, itransfer)
	hpriv = usbi_get_device_handle_priv(tls, (*libusb_transfer)(unsafe.Pointer(transfer)).Fdev_handle)
	...
	if (*usbi_transfer)(unsafe.Pointer(transfer-uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev != 0 {
		v3 = (*libusb_device)(unsafe.Pointer((*usbi_transfer)(unsafe.Pointer(transfer - uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev)).Fctx
	} else {
	...
	urbs = libc.Xcalloc(tls, libc.Uint32FromInt32(num_urbs), uint32(44))
	if !(urbs != 0) {
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	...
	for {
		...
		case int32(LIBUSB_TRANSFER_TYPE_BULK):
			...
			*(*uint32)(unsafe.Add(unsafe.Pointer(urb), 28)) = uint32(0)
		case int32(LIBUSB_TRANSFER_TYPE_BULK_STREAM):
			(*usbfs_urb)(unsafe.Pointer(urb)).Ftype1 = uint8(3)
			*(*uint32)(unsafe.Add(unsafe.Pointer(urb), 28)) = (*usbi_transfer)(unsafe.Pointer(itransfer)).Fstream_id
		...
		r = libc.Xioctl(tls, (*linux_device_handle_priv)(unsafe.Pointer(hpriv)).Ffd, libc.Int32FromUint32(uint32(libc.Uint32FromUint32(2)<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(10)))|libc.Uint32FromInt64(44)<<libc.Int32FromInt32(16)), libc.VaList(bp+8, urb))
		if r == 0 {
			goto _4
		}
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(19) {
			...
			if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(12) {
				...
				usbi_log(tls, v3, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__62)), __ccgo_ts+4148, libc.VaList(bp+8, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))))
				r = int32(LIBUSB_ERROR_IO)
			}
		}
		if i == 0 {
			...
			usbi_log(tls, v3, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__62)), __ccgo_ts+4175, 0)
			libc.Xfree(tls, urbs)
		...
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(121) {
			v1 = int32(COMPLETED_EARLY)
		} else {
			v1 = int32(SUBMIT_FAILED)
		}
		(*linux_transfer_priv)(unsafe.Pointer(tpriv)).Freap_action = v1
		*(*int32)(unsafe.Pointer(tpriv + 12)) += num_urbs - i
		...
		usbi_log(tls, v3, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__62)), __ccgo_ts+4204, libc.VaList(bp+8, i))
		return 0
		goto _4
	_4:
		;
...
var __func__62 = [21]int8{'s', 'u', 'b', 'm', 'i', 't', '_', 'b', 'u', 'l', 'k', '_', 't', 'r', 'a', 'n', 's', 'f', 'e', 'r'}

func submit_iso_transfer(tls *libc.TLS, itransfer uintptr) (r1 int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	var alloc_size size_t
	var hpriv, tpriv, transfer, urb, urb_buffer, urbs, v2 uintptr
	var i, j, k, num_packets, num_packets_in_urb, num_packets_remaining, num_urbs, r, v5 int32
	var packet_len, total_len uint32
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = alloc_size, hpriv, i, j, k, num_packets, num_packets_in_urb, num_packets_remaining, num_urbs, packet_len, r, total_len, tpriv, transfer, urb, urb_buffer, urbs, v2, v5
	transfer = itransfer + uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
	tpriv = usbi_get_transfer_priv(tls, itransfer)
	hpriv = usbi_get_device_handle_priv(tls, (*libusb_transfer)(unsafe.Pointer(transfer)).Fdev_handle)
	...
	for {
		...
		packet_len = (*(*libusb_iso_packet_descriptor)(unsafe.Pointer(transfer + 40 + uintptr(i)*12))).Flength
		...
		total_len = total_len + packet_len
		goto _1
	_1:
		;
		i = i + 1
	...
	usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__63)), __ccgo_ts+4103, libc.VaList(bp+8, num_urbs, (*libusb_transfer)(unsafe.Pointer(transfer)).Flength))
	urbs = libc.Xcalloc(tls, libc.Uint32FromInt32(num_urbs), uint32(4))
	if !(urbs != 0) {
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	*(*uintptr)(unsafe.Pointer(tpriv)) = urbs
	...
	for {
		...
		alloc_size = uint32(uint32(44) + libc.Uint32FromInt32(num_packets_in_urb)*uint32(12))
		urb = libc.Xcalloc(tls, uint32(1), alloc_size)
		if !(urb != 0) {
			free_iso_urbs(tls, tpriv)
			return int32(LIBUSB_ERROR_NO_MEM)
		}
		*(*uintptr)(unsafe.Pointer(urbs + uintptr(i)*4)) = urb
		k = 0
		for {
			if !(k < num_packets_in_urb) {
				break
			}
			packet_len = (*(*libusb_iso_packet_descriptor)(unsafe.Pointer(transfer + 40 + uintptr(j)*12))).Flength
			v2 = urb + 16
			*(*int32)(unsafe.Pointer(v2)) = int32(uint32(*(*int32)(unsafe.Pointer(v2))) + packet_len)
			(*(*usbfs_iso_packet_desc)(unsafe.Pointer(urb + 44 + uintptr(k)*12))).Flength = packet_len
			goto _6
		_6:
			;
			j = j + 1
		...
		(*usbfs_urb)(unsafe.Pointer(urb)).Fendpoint = (*libusb_transfer)(unsafe.Pointer(transfer)).Fendpoint
		(*usbfs_urb)(unsafe.Pointer(urb)).F__ccgo8_28.Fnumber_of_packets = num_packets_in_urb
		(*usbfs_urb)(unsafe.Pointer(urb)).Fbuffer = urb_buffer
		urb_buffer = urb_buffer + uintptr((*usbfs_urb)(unsafe.Pointer(urb)).Fbuffer_length)
		num_packets_remaining = num_packets_remaining - num_packets_in_urb
		goto _4
	_4:
		;
		i = i + 1
	...
	for {
		...
		r = libc.Xioctl(tls, (*linux_device_handle_priv)(unsafe.Pointer(hpriv)).Ffd, libc.Int32FromUint32(uint32(libc.Uint32FromUint32(2)<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(10)))|libc.Uint32FromInt64(44)<<libc.Int32FromInt32(16)), libc.VaList(bp+8, *(*uintptr)(unsafe.Pointer(urbs + uintptr(i)*4))))
		if r == 0 {
			goto _8
		}
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(19) {
			...
			if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(22) {
				...
				usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__63)), __ccgo_ts+4345, 0)
				...
				if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(90) {
					...
					usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__63)), __ccgo_ts+4382, 0)
					r = int32(LIBUSB_ERROR_INVALID_PARAM)
				} else {
					if (*usbi_transfer)(unsafe.Pointer(transfer-uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev != 0 {
						v2 = (*libusb_device)(unsafe.Pointer((*usbi_transfer)(unsafe.Pointer(transfer - uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev)).Fctx
					...
					usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__63)), __ccgo_ts+4148, libc.VaList(bp+8, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))))
					r = int32(LIBUSB_ERROR_IO)
				}
			}
		}
		if i == 0 {
			...
			usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__63)), __ccgo_ts+4175, 0)
			free_iso_urbs(tls, tpriv)
			return r
		}
		...
		usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__63)), __ccgo_ts+4204, libc.VaList(bp+8, i))
		return 0
		goto _8
	_8:
		;
...
var __func__63 = [20]int8{'s', 'u', 'b', 'm', 'i', 't', '_', 'i', 's', 'o', '_', 't', 'r', 'a', 'n', 's', 'f', 'e', 'r'}
...
func submit_control_transfer(tls *libc.TLS, itransfer uintptr) (r1 int32) {
	...
	transfer = itransfer + uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
	hpriv = usbi_get_device_handle_priv(tls, (*libusb_transfer)(unsafe.Pointer(transfer)).Fdev_handle)
	if libc.Uint32FromInt32((*libusb_transfer)(unsafe.Pointer(transfer)).Flength)-libc.Uint32FromInt64(8) > uint32(4096) {
		return int32(LIBUSB_ERROR_INVALID_PARAM)
	}
	urb = libc.Xcalloc(tls, uint32(1), uint32(44))
	if !(urb != 0) {
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	...
	if r < 0 {
		...
		if (*usbi_transfer)(unsafe.Pointer(transfer-uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev != 0 {
			v1 = (*libusb_device)(unsafe.Pointer((*usbi_transfer)(unsafe.Pointer(transfer - uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev)).Fctx
		} else {
			v1 = libc.UintptrFromInt32(0)
		}
...
var __func__64 = [24]int8{'s', 'u', 'b', 'm', 'i', 't', '_', 'c', 'o', 'n', 't', 'r', 'o', 'l', '_', 't', 'r', 'a', 'n', 's', 'f', 'e', 'r'}
...
var __func__65 = [19]int8{'o', 'p', '_', 's', 'u', 'b', 'm', 'i', 't', '_', 't', 'r', 'a', 'n', 's', 'f', 'e', 'r'}
...
var __func__66 = [23]int8{'o', 'p', '_', 'c', 'l', 'e', 'a', 'r', '_', 't', 'r', 'a', 'n', 's', 'f', 'e', 'r', '_', 'p', 'r', 'i', 'v'}

func handle_bulk_completion(tls *libc.TLS, itransfer uintptr, urb uintptr) (r int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	var target, tpriv, transfer, v1 uintptr
	var urb_idx, v13 int32
	_, _, _, _, _, _ = target, tpriv, transfer, urb_idx, v1, v13
	tpriv = usbi_get_transfer_priv(tls, itransfer)
	transfer = itransfer + uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
	urb_idx = (int32(urb) - int32((*linux_transfer_priv)(unsafe.Pointer(tpriv)).F__ccgo0_0.Furbs)) / 44
	...
	(*linux_transfer_priv)(unsafe.Pointer(tpriv)).Fnum_retired = (*linux_transfer_priv)(unsafe.Pointer(tpriv)).Fnum_retired + 1
	if (*linux_transfer_priv)(unsafe.Pointer(tpriv)).Freap_action != int32(NORMAL) {
		...
		usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__67)), __ccgo_ts+4501, libc.VaList(bp+8, (*usbfs_urb)(unsafe.Pointer(urb)).Fstatus))
		if (*usbfs_urb)(unsafe.Pointer(urb)).Factual_length > 0 {
			...
			usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__67)), __ccgo_ts+4530, libc.VaList(bp+8, (*usbfs_urb)(unsafe.Pointer(urb)).Factual_length))
			if (*usbfs_urb)(unsafe.Pointer(urb)).Fbuffer != target {
				...
				usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__67)), __ccgo_ts+4564, libc.VaList(bp+8, int32((*usbfs_urb)(unsafe.Pointer(urb)).Fbuffer)-int32((*libusb_transfer)(unsafe.Pointer(transfer)).Fbuffer), int32(target)-int32((*libusb_transfer)(unsafe.Pointer(transfer)).Fbuffer)))
				libc.Xmemmove(tls, target, (*usbfs_urb)(unsafe.Pointer(urb)).Fbuffer, libc.Uint32FromInt32((*usbfs_urb)(unsafe.Pointer(urb)).Factual_length))
			}
			*(*int32)(unsafe.Pointer(itransfer + 60)) += (*usbfs_urb)(unsafe.Pointer(urb)).Factual_length
		}
		if (*linux_transfer_priv)(unsafe.Pointer(tpriv)).Fnum_retired == (*linux_transfer_priv)(unsafe.Pointer(tpriv)).Fnum_urbs {
			...
			usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__67)), __ccgo_ts+4614, 0)
	...
	*(*int32)(unsafe.Pointer(itransfer + 60)) += (*usbfs_urb)(unsafe.Pointer(urb)).Factual_length
	...
	case -int32(108):
		...
		usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__67)), __ccgo_ts+4657, 0)
	...
	case -int32(32):
		...
		usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__67)), __ccgo_ts+4672, 0)
	...
	case -int32(75):
		...
		usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__67)), __ccgo_ts+4696, libc.VaList(bp+8, (*usbfs_urb)(unsafe.Pointer(urb)).Factual_length))
		if (*linux_transfer_priv)(unsafe.Pointer(tpriv)).Freap_status == int32(LIBUSB_TRANSFER_COMPLETED) {
	...
	case -int32(63):
		...
		usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__67)), __ccgo_ts+4723, libc.VaList(bp+8, (*usbfs_urb)(unsafe.Pointer(urb)).Fstatus))
	...
	default:
		...
		usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__67)), __ccgo_ts+4746, libc.VaList(bp+8, (*usbfs_urb)(unsafe.Pointer(urb)).Fstatus))
		(*linux_transfer_priv)(unsafe.Pointer(tpriv)).Freap_action = int32(ERROR)
		goto cancel_remaining
	}
	if (*linux_transfer_priv)(unsafe.Pointer(tpriv)).Fnum_retired == (*linux_transfer_priv)(unsafe.Pointer(tpriv)).Fnum_urbs {
		...
		usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__67)), __ccgo_ts+4773, 0)
		goto completed
	} else {
		if (*usbfs_urb)(unsafe.Pointer(urb)).Factual_length < (*usbfs_urb)(unsafe.Pointer(urb)).Fbuffer_length {
			...
			usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__67)), __ccgo_ts+4815, libc.VaList(bp+8, (*usbfs_urb)(unsafe.Pointer(urb)).Factual_length, (*usbfs_urb)(unsafe.Pointer(urb)).Fbuffer_length))
			if (*linux_transfer_priv)(unsafe.Pointer(tpriv)).Freap_action == int32(NORMAL) {
...
var __func__67 = [23]int8{'h', 'a', 'n', 'd', 'l', 'e', '_', 'b', 'u', 'l', 'k', '_', 'c', 'o', 'm', 'p', 'l', 'e', 't', 'i', 'o', 'n'}

func handle_iso_completion(tls *libc.TLS, itransfer uintptr, urb uintptr) (r int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	var i, num_urbs, urb_idx, v5 int32
	var lib_desc, tpriv, transfer, urb_desc, v2 uintptr
	var status libusb_transfer_status
	_, _, _, _, _, _, _, _, _, _ = i, lib_desc, num_urbs, status, tpriv, transfer, urb_desc, urb_idx, v2, v5
	transfer = itransfer + uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
	tpriv = usbi_get_transfer_priv(tls, itransfer)
	...
	for {
		...
		if urb == *(*uintptr)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(tpriv)) + uintptr(i)*4)) {
			urb_idx = i + int32(1)
			break
		}
		goto _1
	...
	usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+4872, libc.VaList(bp+8, (*usbfs_urb)(unsafe.Pointer(urb)).Fstatus, urb_idx, num_urbs))
	i = 0
	for {
		if !(i < (*usbfs_urb)(unsafe.Pointer(urb)).F__ccgo8_28.Fnumber_of_packets) {
			break
		}
		urb_desc = urb + 44 + uintptr(i)*12
		v2 = tpriv + 20
		v5 = *(*int32)(unsafe.Pointer(v2))
		*(*int32)(unsafe.Pointer(v2)) = *(*int32)(unsafe.Pointer(v2)) + 1
		lib_desc = transfer + 40 + uintptr(v5)*12
		...
		case libc.Uint32FromInt32(-libc.Int32FromInt32(108)):
			...
			usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+4919, libc.VaList(bp+8, i))
		...
		case libc.Uint32FromInt32(-libc.Int32FromInt32(32)):
			...
			usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+4946, libc.VaList(bp+8, i))
		...
		case libc.Uint32FromInt32(-libc.Int32FromInt32(75)):
			...
			usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+4982, libc.VaList(bp+8, i))
		...
		case libc.Uint32FromInt32(-libc.Int32FromInt32(18)):
			...
			usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+5009, libc.VaList(bp+8, i, (*usbfs_iso_packet_desc)(unsafe.Pointer(urb_desc)).Fstatus))
		...
		default:
			...
			usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+5044, libc.VaList(bp+8, i, (*usbfs_iso_packet_desc)(unsafe.Pointer(urb_desc)).Fstatus))
			(*libusb_iso_packet_descriptor)(unsafe.Pointer(lib_desc)).Fstatus = int32(LIBUSB_TRANSFER_ERROR)
			break
		}
	...
	if (*linux_transfer_priv)(unsafe.Pointer(tpriv)).Freap_action != int32(NORMAL) {
		...
		usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+5083, libc.VaList(bp+8, (*usbfs_urb)(unsafe.Pointer(urb)).Fstatus))
		if (*linux_transfer_priv)(unsafe.Pointer(tpriv)).Fnum_retired == num_urbs {
			...
			usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+5105, 0)
			free_iso_urbs(tls, tpriv)
			if (*linux_transfer_priv)(unsafe.Pointer(tpriv)).Freap_action == int32(CANCELLED) {
				usbi_mutex_unlock(tls, itransfer)
	...
	case -int32(108):
		...
		usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+4657, 0)
	...
	default:
		...
		usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+4746, libc.VaList(bp+8, (*usbfs_urb)(unsafe.Pointer(urb)).Fstatus))
	...
	if (*linux_transfer_priv)(unsafe.Pointer(tpriv)).Fnum_retired == num_urbs {
		...
		usbi_log(tls, v2, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+4773, 0)
		free_iso_urbs(tls, tpriv)
		usbi_mutex_unlock(tls, itransfer)
...
var __func__68 = [22]int8{'h', 'a', 'n', 'd', 'l', 'e', '_', 'i', 's', 'o', '_', 'c', 'o', 'm', 'p', 'l', 'e', 't', 'i', 'o', 'n'}

func handle_control_completion(tls *libc.TLS, itransfer uintptr, urb uintptr) (r int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	var status int32
	var tpriv, v1 uintptr
	_, _, _ = status, tpriv, v1
	tpriv = usbi_get_transfer_priv(tls, itransfer)
	usbi_mutex_lock(tls, itransfer)
	if (*usbi_transfer)(unsafe.Pointer(itransfer)).Fdev != 0 {
		v1 = (*libusb_device)(unsafe.Pointer((*usbi_transfer)(unsafe.Pointer(itransfer)).Fdev)).Fctx
	...
	*(*int32)(unsafe.Pointer(itransfer + 60)) += (*usbfs_urb)(unsafe.Pointer(urb)).Factual_length
	if (*linux_transfer_priv)(unsafe.Pointer(tpriv)).Freap_action == int32(CANCELLED) {
		if (*usbfs_urb)(unsafe.Pointer(urb)).Fstatus != 0 && (*usbfs_urb)(unsafe.Pointer(urb)).Fstatus != -int32(2) {
			...
			usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__69)), __ccgo_ts+5171, libc.VaList(bp+8, (*usbfs_urb)(unsafe.Pointer(urb)).Fstatus))
		}
		libc.Xfree(tls, (*linux_transfer_priv)(unsafe.Pointer(tpriv)).F__ccgo0_0.Furbs)
		(*linux_transfer_priv)(unsafe.Pointer(tpriv)).F__ccgo0_0.Furbs = libc.UintptrFromInt32(0)
		usbi_mutex_unlock(tls, itransfer)
	...
	case -int32(108):
		...
		usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__69)), __ccgo_ts+4657, 0)
		status = int32(LIBUSB_TRANSFER_NO_DEVICE)
	case -int32(32):
		if (*usbi_transfer)(unsafe.Pointer(itransfer)).Fdev != 0 {
			v1 = (*libusb_device)(unsafe.Pointer((*usbi_transfer)(unsafe.Pointer(itransfer)).Fdev)).Fctx
		...
		usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__69)), __ccgo_ts+5206, 0)
	...
	case -int32(75):
		...
		usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__69)), __ccgo_ts+4696, libc.VaList(bp+8, (*usbfs_urb)(unsafe.Pointer(urb)).Factual_length))
	...
	case -int32(63):
		...
		usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__69)), __ccgo_ts+4723, libc.VaList(bp+8, (*usbfs_urb)(unsafe.Pointer(urb)).Fstatus))
		status = int32(LIBUSB_TRANSFER_ERROR)
	default:
		if (*usbi_transfer)(unsafe.Pointer(itransfer)).Fdev != 0 {
			v1 = (*libusb_device)(unsafe.Pointer((*usbi_transfer)(unsafe.Pointer(itransfer)).Fdev)).Fctx
		...
		usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__69)), __ccgo_ts+4746, libc.VaList(bp+8, (*usbfs_urb)(unsafe.Pointer(urb)).Fstatus))
		status = int32(LIBUSB_TRANSFER_ERROR)
		break
	}
	libc.Xfree(tls, (*linux_transfer_priv)(unsafe.Pointer(tpriv)).F__ccgo0_0.Furbs)
...
var __func__69 = [26]int8{'h', 'a', 'n', 'd', 'l', 'e', '_', 'c', 'o', 'n', 't', 'r', 'o', 'l', '_', 'c', 'o', 'm', 'p', 'l', 'e', 't', 'i', 'o', 'n'}

func reap_for_handle(tls *libc.TLS, handle uintptr) (r1 int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	var hpriv, itransfer, transfer, v1 uintptr
	var r int32
	var _ /* urb at bp+0 */ uintptr
	_, _, _, _, _ = hpriv, itransfer, r, transfer, v1
	hpriv = usbi_get_device_handle_priv(tls, handle)
	*(*uintptr)(unsafe.Pointer(bp)) = libc.UintptrFromInt32(0)
	r = libc.Xioctl(tls, (*linux_device_handle_priv)(unsafe.Pointer(hpriv)).Ffd, libc.Int32FromUint32(uint32(libc.Uint32FromUint32(1)<<libc.Int32FromInt32(30)|libc.Uint32FromInt32(libc.Int32FromUint8('U')<<libc.Int32FromInt32(8))|libc.Uint32FromInt32(libc.Int32FromInt32(13)))|libc.Uint32FromInt64(4)<<libc.Int32FromInt32(16)), libc.VaList(bp+16, bp))
	if r < 0 {
	...
	default:
		...
		usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__70)), __ccgo_ts+5293, libc.VaList(bp+16, libc.Int32FromUint8((*libusb_transfer)(unsafe.Pointer(transfer)).Ftype1)))
		return int32(LIBUSB_ERROR_OTHER)
	}
	return r1
}

var __func__70 = [16]int8{'r', 'e', 'a', 'p', '_', 'f', 'o', 'r', '_', 'h', 'a', 'n', 'd', 'l', 'e'}

func op_handle_events(tls *libc.TLS, ctx uintptr, event_data uintptr, count uint32, num_ready uint32) (r1 int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	var fds, handle, hpriv, pollfd1, v3 uintptr
	var n uint32
	var r, reap_count, v4 int32
	var v5 bool
	_, _, _, _, _, _, _, _, _, _ = fds, handle, hpriv, n, pollfd1, r, reap_count, v3, v4, v5
	fds = event_data
	usbi_mutex_lock(tls, ctx+52)
	n = uint32(0)
	for {
		...
		num_ready = num_ready - 1
		handle = uintptr(uint32((*list_head)(unsafe.Pointer(ctx+76)).Fnext) - uint32(libc.UintptrFromInt32(0)+28))
		for {
			if !(handle+28 != ctx+76) {
				break
			}
		...
		_2:
			;
			handle = uintptr(uint32((*libusb_device_handle)(unsafe.Pointer(handle)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+28))
		}
		if !(hpriv != 0) || (*linux_device_handle_priv)(unsafe.Pointer(hpriv)).Ffd != (*pollfd)(unsafe.Pointer(pollfd1)).Ffd {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__71)), __ccgo_ts+5323, libc.VaList(bp+8, (*pollfd)(unsafe.Pointer(pollfd1)).Ffd))
			goto _1
		}
...
out:
	;
	usbi_mutex_unlock(tls, ctx+52)
	return r
}

var __func__71 = [17]int8{'o', 'p', '_', 'h', 'a', 'n', 'd', 'l', 'e', '_', 'e', 'v', 'e', 'n', 't', 's'}

func init() {
	p := unsafe.Pointer(&usbi_backend)
	*(*uintptr)(unsafe.Add(p, 8)) = __ccgo_fp(op_init)
	*(*uintptr)(unsafe.Add(p, 12)) = __ccgo_fp(op_exit)
	*(*uintptr)(unsafe.Add(p, 16)) = __ccgo_fp(op_set_option)
	*(*uintptr)(unsafe.Add(p, 24)) = __ccgo_fp(op_get_device_string)
	*(*uintptr)(unsafe.Add(p, 28)) = __ccgo_fp(op_hotplug_poll)
	*(*uintptr)(unsafe.Add(p, 32)) = __ccgo_fp(op_wrap_sys_device)
	*(*uintptr)(unsafe.Add(p, 36)) = __ccgo_fp(op_open)
	*(*uintptr)(unsafe.Add(p, 40)) = __ccgo_fp(op_close)
	*(*uintptr)(unsafe.Add(p, 44)) = __ccgo_fp(op_get_active_config_descriptor)
	*(*uintptr)(unsafe.Add(p, 48)) = __ccgo_fp(op_get_config_descriptor)
	*(*uintptr)(unsafe.Add(p, 52)) = __ccgo_fp(op_get_config_descriptor_by_value)
	*(*uintptr)(unsafe.Add(p, 56)) = __ccgo_fp(op_get_configuration)
	*(*uintptr)(unsafe.Add(p, 60)) = __ccgo_fp(op_set_configuration)
	*(*uintptr)(unsafe.Add(p, 64)) = __ccgo_fp(op_claim_interface)
	*(*uintptr)(unsafe.Add(p, 68)) = __ccgo_fp(op_release_interface)
	*(*uintptr)(unsafe.Add(p, 72)) = __ccgo_fp(op_set_interface)
	*(*uintptr)(unsafe.Add(p, 76)) = __ccgo_fp(op_clear_halt)
	*(*uintptr)(unsafe.Add(p, 80)) = __ccgo_fp(op_reset_device)
	*(*uintptr)(unsafe.Add(p, 84)) = __ccgo_fp(op_alloc_streams)
	*(*uintptr)(unsafe.Add(p, 88)) = __ccgo_fp(op_free_streams)
	*(*uintptr)(unsafe.Add(p, 92)) = __ccgo_fp(op_dev_mem_alloc)
	*(*uintptr)(unsafe.Add(p, 96)) = __ccgo_fp(op_dev_mem_free)
	*(*uintptr)(unsafe.Add(p, 100)) = __ccgo_fp(op_kernel_driver_active)
	*(*uintptr)(unsafe.Add(p, 104)) = __ccgo_fp(op_detach_kernel_driver)
	*(*uintptr)(unsafe.Add(p, 108)) = __ccgo_fp(op_attach_kernel_driver)
	*(*uintptr)(unsafe.Add(p, 124)) = __ccgo_fp(op_destroy_device)
	*(*uintptr)(unsafe.Add(p, 128)) = __ccgo_fp(op_submit_transfer)
	*(*uintptr)(unsafe.Add(p, 132)) = __ccgo_fp(op_cancel_transfer)
	*(*uintptr)(unsafe.Add(p, 136)) = __ccgo_fp(op_clear_transfer_priv)
	*(*uintptr)(unsafe.Add(p, 140)) = __ccgo_fp(op_handle_events)
}
...
var __func__72 = [18]int8{'s', 'e', 't', '_', 'f', 'd', '_', 'c', 'l', 'o', 'e', 'x', 'e', 'c', '_', 'n', 'b'}
...
var __func__73 = [34]int8{'l', 'i', 'n', 'u', 'x', '_', 'n', 'e', 't', 'l', 'i', 'n', 'k', '_', 's', 't', 'a', 'r', 't', '_', 'e', 'v', 'e', 'n', 't', '_', 'm', 'o', 'n', 'i', 't', 'o', 'r'}
...
var __func__74 = [33]int8{'l', 'i', 'n', 'u', 'x', '_', 'n', 'e', 't', 'l', 'i', 'n', 'k', '_', 's', 't', 'o', 'p', '_', 'e', 'v', 'e', 'n', 't', '_', 'm', 'o', 'n', 'i', 't', 'o', 'r'}
...
func netlink_message_parse(tls *libc.TLS, buffer uintptr, len1 size_t, key uintptr) (r uintptr) {
	...
	for buffer < end && *(*int8)(unsafe.Pointer(buffer)) != 0 {
		if libc.Xstrncmp(tls, buffer, key, keylen) == 0 && int32(*(*int8)(unsafe.Pointer(buffer + uintptr(keylen)))) == int32('=') {
			return buffer + uintptr(keylen) + uintptr(1)
		}
		buffer = buffer + uintptr(libc.Xstrlen(tls, buffer)+uint32(1))
	}
	return libc.UintptrFromInt32(0)
}
...
func linux_netlink_parse(tls *libc.TLS, buffer uintptr, len1 size_t, detached uintptr, sys_name uintptr, busnum uintptr, devaddr uintptr) (r int32) {
	...
	*(*uint8_t)(unsafe.Pointer(devaddr)) = uint8(0)
	...
	if tmp != 0 {
		*(*uint8_t)(unsafe.Pointer(busnum)) = uint8(libc.Xstrtoul(tls, tmp, libc.UintptrFromInt32(0), int32(10)) & libc.Uint32FromInt32(0xff))
		...
		*(*uint8_t)(unsafe.Pointer(devaddr)) = uint8(libc.Xstrtoul(tls, tmp, libc.UintptrFromInt32(0), int32(10)) & libc.Uint32FromInt32(0xff))
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != 0 {
			*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
			return -int32(1)
		}
		...
		*(*uint8_t)(unsafe.Pointer(busnum)) = uint8(libc.Xstrtoul(tls, slash-uintptr(3), libc.UintptrFromInt32(0), int32(10)) & libc.Uint32FromInt32(0xff))
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != 0 {
			*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
			return -int32(1)
		}
		*(*uint8_t)(unsafe.Pointer(devaddr)) = uint8(libc.Xstrtoul(tls, slash+uintptr(1), libc.UintptrFromInt32(0), int32(10)) & libc.Uint32FromInt32(0xff))
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != 0 {
			*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
			return -int32(1)
		}
...
var __func__75 = [20]int8{'l', 'i', 'n', 'u', 'x', '_', 'n', 'e', 't', 'l', 'i', 'n', 'k', '_', 'p', 'a', 'r', 's', 'e'}

func linux_netlink_read_message(tls *libc.TLS) (r1 int32) {
	bp := tls.Alloc(2176)
	defer tls.Free(2176)
	var cmsg, cred, v1 uintptr
	var len1 ssize_t
	var r int32
	var _ /* busnum at bp+2076 */ uint8_t
	var _ /* cred_buffer at bp+0 */ [24]int8
	var _ /* detached at bp+2080 */ int32
	var _ /* devaddr at bp+2077 */ uint8_t
	var _ /* iov at bp+2096 */ iovec
	var _ /* msg at bp+2104 */ msghdr
	var _ /* msg_buffer at bp+24 */ [2048]int8
	var _ /* sa_nl at bp+2084 */ sockaddr_nl
	var _ /* sys_name at bp+2072 */ uintptr
	_, _, _, _, _ = cmsg, cred, len1, r, v1
	*(*uintptr)(unsafe.Pointer(bp + 2072)) = libc.UintptrFromInt32(0)
	*(*iovec)(unsafe.Pointer(bp + 2096)) = iovec{
		Fiov_base: bp + 24,
		Fiov_len:  uint32(2048),
	}
	*(*msghdr)(unsafe.Pointer(bp + 2104)) = msghdr{
		Fmsg_name:       bp + 2084,
		Fmsg_namelen:    uint32(12),
		Fmsg_iov:        bp + 2096,
		Fmsg_iovlen:     int32(1),
		Fmsg_control:    bp,
		Fmsg_controllen: uint32(24),
	}
	len1 = libc.Xrecvmsg(tls, linux_netlink_socket, bp+2104, 0)
	if len1 == -int32(1) {
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(11) && *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(4) {
			usbi_log(tls, libc.UintptrFromInt32(0), int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__76)), __ccgo_ts+6038, libc.VaList(bp+2144, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))))
		}
		return -int32(1)
	}
	if len1 < int32(32) || (*(*msghdr)(unsafe.Pointer(bp + 2104))).Fmsg_flags&int32(0x0020) != 0 {
		usbi_log(tls, libc.UintptrFromInt32(0), int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__76)), __ccgo_ts+6085, 0)
		return -int32(1)
	}
	if (*(*sockaddr_nl)(unsafe.Pointer(bp + 2084))).Fnl_groups != uint32(1) || (*(*sockaddr_nl)(unsafe.Pointer(bp + 2084))).Fnl_pid != uint32(0) {
		usbi_log(tls, libc.UintptrFromInt32(0), int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__76)), __ccgo_ts+6116, libc.VaList(bp+2144, (*(*sockaddr_nl)(unsafe.Pointer(bp + 2084))).Fnl_groups, (*(*sockaddr_nl)(unsafe.Pointer(bp + 2084))).Fnl_pid))
		return -int32(1)
	}
	if (*msghdr)(unsafe.Pointer(bp+2104)).Fmsg_controllen >= uint32(12) {
		v1 = (*msghdr)(unsafe.Pointer(bp + 2104)).Fmsg_control
	} else {
		v1 = libc.UintptrFromInt32(0)
	}
	cmsg = v1
	...
	cred = cmsg + libc.UintptrFromInt32(1)*12
	if (*ucred)(unsafe.Pointer(cred)).Fuid != uint32(0) {
		usbi_log(tls, libc.UintptrFromInt32(0), int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__76)), __ccgo_ts+6224, libc.VaList(bp+2144, (*ucred)(unsafe.Pointer(cred)).Fuid))
		return -int32(1)
	}
	r = linux_netlink_parse(tls, bp+24, libc.Uint32FromInt32(len1), bp+2080, bp+2072, bp+2076, bp+2077)
	if r != 0 {
		return r
	}
	if *(*int32)(unsafe.Pointer(bp + 2080)) != 0 {
		v1 = __ccgo_ts + 6277
	} else {
		v1 = __ccgo_ts + 6281
	}
	usbi_log(tls, libc.UintptrFromInt32(0), int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__76)), __ccgo_ts+6284, libc.VaList(bp+2144, libc.Int32FromUint8(*(*uint8_t)(unsafe.Pointer(bp + 2076))), libc.Int32FromUint8(*(*uint8_t)(unsafe.Pointer(bp + 2077))), *(*uintptr)(unsafe.Pointer(bp + 2072)), v1))
	if *(*int32)(unsafe.Pointer(bp + 2080)) != 0 {
		linux_device_disconnected(tls, *(*uint8_t)(unsafe.Pointer(bp + 2076)), *(*uint8_t)(unsafe.Pointer(bp + 2077)))
	} else {
		linux_hotplug_enumerate(tls, *(*uint8_t)(unsafe.Pointer(bp + 2076)), *(*uint8_t)(unsafe.Pointer(bp + 2077)), *(*uintptr)(unsafe.Pointer(bp + 2072)))
	}
	return 0
}

var __func__76 = [27]int8{'l', 'i', 'n', 'u', 'x', '_', 'n', 'e', 't', 'l', 'i', 'n', 'k', '_', 'r', 'e', 'a', 'd', '_', 'm', 'e', 's', 's', 'a', 'g', 'e'}
...
func linux_netlink_event_thread_main(tls *libc.TLS, arg uintptr) (r1 uintptr) {
	...
	*(*[2]pollfd)(unsafe.Pointer(bp)) = [2]pollfd{
	...
	for int32(1) != 0 {
		r = libc.Xpoll(tls, bp, uint32(2), -int32(1))
		if r == -int32(1) {
			if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(4) {
				continue
			}
...
var __func__77 = [32]int8{'l', 'i', 'n', 'u', 'x', '_', 'n', 'e', 't', 'l', 'i', 'n', 'k', '_', 'e', 'v', 'e', 'n', 't', '_', 't', 'h', 'r', 'e', 'a', 'd', '_', 'm', 'a', 'i', 'n'}
...
var default_debug_level = int32(-int32(1))
...
func discovered_devs_alloc(tls *libc.TLS) (r uintptr) {
	var ret uintptr
	_ = ret
	ret = libc.Xmalloc(tls, uint32(libc.Uint32FromInt64(8)+libc.Uint32FromInt64(4)*libc.Uint32FromInt32(16)))
	if ret != 0 {
		(*discovered_devs)(unsafe.Pointer(ret)).Flen1 = uint32(0)
		(*discovered_devs)(unsafe.Pointer(ret)).Fcapacity = uint32(16)
	}
	return ret
}
...
func discovered_devs_free(tls *libc.TLS, discdevs uintptr) {
	...
	for {
		...
		libusb_unref_device(tls, *(*uintptr)(unsafe.Pointer(discdevs + 8 + uintptr(i)*4)))
		goto _1
	_1:
		;
		i = i + 1
...
func discovered_devs_append(tls *libc.TLS, discdevs uintptr, dev uintptr) (r uintptr) {
	...
	if len1 < (*discovered_devs)(unsafe.Pointer(discdevs)).Fcapacity {
		*(*uintptr)(unsafe.Pointer(discdevs + 8 + uintptr(len1)*4)) = libusb_ref_device(tls, dev)
		(*discovered_devs)(unsafe.Pointer(discdevs)).Flen1 = (*discovered_devs)(unsafe.Pointer(discdevs)).Flen1 + 1
		return discdevs
	}
	...
	capacity = (*discovered_devs)(unsafe.Pointer(discdevs)).Fcapacity + uint32(16)
	new_discdevs = libc.Xrealloc(tls, discdevs, uint32(8)+uint32(4)*capacity)
	if !(new_discdevs != 0) {
...
var __func__78 = [23]int8{'d', 'i', 's', 'c', 'o', 'v', 'e', 'r', 'e', 'd', '_', 'd', 'e', 'v', 's', '_', 'a', 'p', 'p', 'e', 'n', 'd'}

func usbi_alloc_device(tls *libc.TLS, ctx uintptr, session_id uint32) (r uintptr) {
	var dev uintptr
	var priv_size size_t
	_, _ = dev, priv_size
	priv_size = usbi_backend.Fdevice_priv_size
	dev = libc.Xcalloc(tls, uint32(1), uint32((libc.Uint32FromInt64(68)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)) + priv_size))
	if !(dev != 0) {
		return libc.UintptrFromInt32(0)
	}
	libc.X__c11_atomic_storeInt32(tls, dev, int32(libc.Int32FromInt32(1)), libc.Int32FromInt32(5))
...
func usbi_detach_device(tls *libc.TLS, dev uintptr) {
	...
	_ = ctx
	ctx = (*libusb_device)(unsafe.Pointer(dev)).Fctx
	libc.X__c11_atomic_storeInt32(tls, dev+52, int32(libc.Int32FromInt32(0)), libc.Int32FromInt32(5))
	usbi_mutex_lock(tls, ctx+20)
	list_del(tls, dev+20)
	usbi_mutex_unlock(tls, ctx+20)
}
...
var __func__79 = [21]int8{'u', 's', 'b', 'i', '_', 's', 'a', 'n', 'i', 't', 'i', 'z', 'e', '_', 'd', 'e', 'v', 'i', 'c', 'e'}

func usbi_get_device_by_session_id(tls *libc.TLS, ctx uintptr, session_id uint32) (r uintptr) {
	var dev, ret uintptr
	_, _ = dev, ret
	ret = libc.UintptrFromInt32(0)
	usbi_mutex_lock(tls, ctx+20)
	dev = uintptr(uint32((*list_head)(unsafe.Pointer(ctx+44)).Fnext) - uint32(libc.UintptrFromInt32(0)+20))
	for {
		if !(dev+20 != ctx+44) {
			break
		}
	...
	_1:
		;
		dev = uintptr(uint32((*libusb_device)(unsafe.Pointer(dev)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+20))
	}
	usbi_mutex_unlock(tls, ctx+20)
	return ret
}
...
func libusb_get_device_list(tls *libc.TLS, ctx uintptr, list uintptr) (r1 ssize_t) {
	...
	*(*uintptr)(unsafe.Pointer(bp)) = discovered_devs_alloc(tls)
	...
	len1 = libc.Int32FromUint32((*discovered_devs)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp)))).Flen1)
	ret = libc.Xcalloc(tls, libc.Uint32FromInt32(len1)+uint32(1), uint32(4))
	if !(ret != 0) {
		len1 = int32(LIBUSB_ERROR_NO_MEM)
		goto out
	}
	*(*uintptr)(unsafe.Pointer(ret + uintptr(len1)*4)) = libc.UintptrFromInt32(0)
	i = 0
	for {
		if !(i < len1) {
			break
		}
		dev1 = *(*uintptr)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp)) + 8 + uintptr(i)*4))
		*(*uintptr)(unsafe.Pointer(ret + uintptr(i)*4)) = libusb_ref_device(tls, dev1)
		goto _2
	_2:
		;
		i = i + 1
...
var __func__80 = [23]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 'd', 'e', 'v', 'i', 'c', 'e', '_', 'l', 'i', 's', 't'}
...
func libusb_free_device_list(tls *libc.TLS, list uintptr, unref_devices int32) {
	...
	if unref_devices != 0 {
		...
		for {
			v2 = i
			i = i + 1
			v1 = *(*uintptr)(unsafe.Pointer(list + uintptr(v2)*4))
			dev = v1
...
func libusb_get_session_data(tls *libc.TLS, dev uintptr) (r uint32) {
...
func libusb_get_port_numbers(tls *libc.TLS, dev uintptr, port_numbers uintptr, port_numbers_len int32) (r int32) {
	...
	if i < port_numbers_len {
		libc.Xmemmove(tls, port_numbers, port_numbers+uintptr(i), libc.Uint32FromInt32(port_numbers_len-i))
	}
	return port_numbers_len - i
}

var __func__81 = [24]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 'p', 'o', 'r', 't', '_', 'n', 'u', 'm', 'b', 'e', 'r', 's'}
...
func find_endpoint(tls *libc.TLS, config uintptr, endpoint uint8) (r uintptr) {
	...
	for {
		...
		iface = (*libusb_config_descriptor)(unsafe.Pointer(config)).Finterface1 + uintptr(iface_idx)*8
		altsetting_idx = 0
		for {
			if !(altsetting_idx < (*libusb_interface)(unsafe.Pointer(iface)).Fnum_altsetting) {
				break
			}
			altsetting = (*libusb_interface)(unsafe.Pointer(iface)).Faltsetting + uintptr(altsetting_idx)*24
			ep_idx = 0
			for {
				if !(ep_idx < libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(altsetting)).FbNumEndpoints)) {
					break
				}
				ep = (*libusb_interface_descriptor)(unsafe.Pointer(altsetting)).Fendpoint + uintptr(ep_idx)*20
		...
		_2:
			;
			altsetting_idx = altsetting_idx + 1
		}
		goto _1
	_1:
		;
...
var __func__82 = [27]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 'm', 'a', 'x', '_', 'p', 'a', 'c', 'k', 'e', 't', '_', 's', 'i', 'z', 'e'}
...
func get_endpoint_max_packet_size(tls *libc.TLS, dev uintptr, ep uintptr) (r1 int32) {
	...
	if speed < int32(LIBUSB_SPEED_SUPER) || r < 0 {
		...
		if ep_type == int32(LIBUSB_ENDPOINT_TRANSFER_TYPE_ISOCHRONOUS) || ep_type == int32(LIBUSB_ENDPOINT_TRANSFER_TYPE_INTERRUPT) {
			r = r * (int32(1) + libc.Int32FromUint16(val)>>int32(11)&int32(3))
		}
	}
	return r
}
...
var __func__83 = [31]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 'm', 'a', 'x', '_', 'i', 's', 'o', '_', 'p', 'a', 'c', 'k', 'e', 't', '_', 's', 'i', 'z', 'e'}
...
var __func__84 = [31]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 'm', 'a', 'x', '_', 'a', 'l', 't', '_', 'p', 'a', 'c', 'k', 'e', 't', '_', 's', 'i', 'z', 'e'}

func libusb_ref_device(tls *libc.TLS, dev uintptr) (r uintptr) {
	var refcnt int32
	var v1 bool
	_, _ = refcnt, v1
	refcnt = int32(int32(libc.X__c11_atomic_fetch_addInt32(tls, dev, libc.Int32FromInt32(1), libc.Int32FromInt32(5))) + libc.Int32FromInt32(1))
	if v1 = refcnt >= int32(2); !v1 {
...
var __func__85 = [18]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'r', 'e', 'f', '_', 'd', 'e', 'v', 'i', 'c', 'e'}

func libusb_unref_device(tls *libc.TLS, dev uintptr) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	var idx, refcnt int32
	var v1 bool
	_, _, _ = idx, refcnt, v1
	if !(dev != 0) {
		return
	}
	refcnt = int32(int32(libc.X__c11_atomic_fetch_addInt32(tls, dev, int32(-libc.Int32FromInt32(1)), libc.Int32FromInt32(5))) - libc.Int32FromInt32(1))
	if v1 = refcnt >= 0; !v1 {
	...
	if refcnt == 0 {
		...
		for {
			...
			libc.Xfree(tls, *(*uintptr)(unsafe.Pointer(dev + 56 + uintptr(idx)*4)))
			goto _2
		_2:
			;
			idx = idx + 1
...
var __func__86 = [20]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'u', 'n', 'r', 'e', 'f', '_', 'd', 'e', 'v', 'i', 'c', 'e'}
...
func libusb_wrap_sys_device(tls *libc.TLS, ctx uintptr, sys_dev intptr_t, dev_handle uintptr) (r1 int32) {
	...
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__87)), __ccgo_ts+6742, libc.VaList(bp+8, libc.Uint32FromInt32(sys_dev)))
	ctx = usbi_get_context(tls, ctx)
	if !(usbi_backend.Fwrap_sys_device != 0) {
		return int32(LIBUSB_ERROR_NOT_SUPPORTED)
	}
	_dev_handle = libc.Xcalloc(tls, uint32(1), uint32((libc.Uint32FromInt64(44)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)) + priv_size))
	if !(_dev_handle != 0) {
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	...
	if r < 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__87)), __ccgo_ts+6763, libc.VaList(bp+8, libc.Uint32FromInt32(sys_dev), r))
		usbi_mutex_destroy(tls, _dev_handle)
		libc.Xfree(tls, _dev_handle)
		return r
	}
	usbi_mutex_lock(tls, ctx+52)
	list_add(tls, _dev_handle+28, ctx+76)
	usbi_mutex_unlock(tls, ctx+52)
	*(*uintptr)(unsafe.Pointer(dev_handle)) = _dev_handle
	return 0
}

var __func__87 = [23]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'w', 'r', 'a', 'p', '_', 's', 'y', 's', '_', 'd', 'e', 'v', 'i', 'c', 'e'}

func libusb_open(tls *libc.TLS, dev uintptr, dev_handle uintptr) (r1 int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	var _dev_handle, ctx uintptr
	var priv_size size_t
	var r int32
	_, _, _, _ = _dev_handle, ctx, priv_size, r
	ctx = (*libusb_device)(unsafe.Pointer(dev)).Fctx
	priv_size = usbi_backend.Fdevice_handle_priv_size
	usbi_log(tls, (*libusb_device)(unsafe.Pointer(dev)).Fctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__88)), __ccgo_ts+6795, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_device)(unsafe.Pointer(dev)).Fbus_number), libc.Int32FromUint8((*libusb_device)(unsafe.Pointer(dev)).Fdevice_address)))
	if !(libc.X__c11_atomic_loadInt32(tls, dev+52, libc.Int32FromInt32(5)) != 0) {
		return int32(LIBUSB_ERROR_NO_DEVICE)
	}
	_dev_handle = libc.Xcalloc(tls, uint32(1), uint32((libc.Uint32FromInt64(44)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)) + priv_size))
	if !(_dev_handle != 0) {
	...
	if r < 0 {
		usbi_log(tls, (*libusb_device)(unsafe.Pointer(dev)).Fctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__88)), __ccgo_ts+6806, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_device)(unsafe.Pointer(dev)).Fbus_number), libc.Int32FromUint8((*libusb_device)(unsafe.Pointer(dev)).Fdevice_address), r))
		libusb_unref_device(tls, dev)
		usbi_mutex_destroy(tls, _dev_handle)
		libc.Xfree(tls, _dev_handle)
		return r
...
var __func__88 = [12]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'o', 'p', 'e', 'n'}
...
func libusb_open_device_with_vid_pid(tls *libc.TLS, ctx uintptr, vendor_id uint16_t, product_id uint16_t) (r1 uintptr) {
	...
	var _ /* dev_handle at bp+4 */ uintptr
	...
	*(*uintptr)(unsafe.Pointer(bp + 4)) = libc.UintptrFromInt32(0)
	...
	for {
		v2 = i
		i = i + 1
		v1 = *(*uintptr)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp)) + uintptr(v2)*4))
		dev = v1
		if !(v1 != libc.UintptrFromInt32(0)) {
			break
		}
		r = libusb_get_device_descriptor(tls, dev, bp+8)
		if r < 0 {
			goto out
		}
		if libc.Int32FromUint16((*(*libusb_device_descriptor)(unsafe.Pointer(bp + 8))).FidVendor) == libc.Int32FromUint16(vendor_id) && libc.Int32FromUint16((*(*libusb_device_descriptor)(unsafe.Pointer(bp + 8))).FidProduct) == libc.Int32FromUint16(product_id) {
			found = dev
			break
		}
	}
	if found != 0 {
		r = libusb_open(tls, found, bp+4)
		if r < 0 {
			*(*uintptr)(unsafe.Pointer(bp + 4)) = libc.UintptrFromInt32(0)
		}
	}
...
func do_close(tls *libc.TLS, ctx uintptr, dev_handle uintptr) {
	...
	usbi_mutex_lock(tls, ctx+124)
	itransfer = uintptr(uint32((*list_head)(unsafe.Pointer(ctx+148)).Fnext) - uint32(libc.UintptrFromInt32(0)+28))
	tmp = uintptr(uint32((*usbi_transfer)(unsafe.Pointer(itransfer)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+28))
	for {
		if !(itransfer+28 != ctx+148) {
			break
		}
		transfer = itransfer + uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
		...
		if !(state_flags&uint32(USBI_TRANSFER_DEVICE_DISAPPEARED) != 0) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__89)), __ccgo_ts+6828, 0)
			if state_flags&uint32(USBI_TRANSFER_CANCELLING) != 0 {
				usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__89)), __ccgo_ts+6943, 0)
			} else {
				usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__89)), __ccgo_ts+7031, 0)
			}
		}
		list_del(tls, itransfer+28)
		(*libusb_transfer)(unsafe.Pointer(transfer)).Fdev_handle = libc.UintptrFromInt32(0)
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__89)), __ccgo_ts+7121, libc.VaList(bp+8, transfer, dev_handle))
		goto _1
	_1:
		;
		itransfer = tmp
		tmp = uintptr(uint32((*usbi_transfer)(unsafe.Pointer(tmp)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+28))
	}
	usbi_mutex_unlock(tls, ctx+124)
	usbi_mutex_lock(tls, ctx+52)
	list_del(tls, dev_handle+28)
	usbi_mutex_unlock(tls, ctx+52)
...
var __func__89 = [9]int8{'d', 'o', '_', 'c', 'l', 'o', 's', 'e'}

func libusb_close(tls *libc.TLS, dev_handle uintptr) {
	var ctx, v1 uintptr
	var event_flags, v2 uint32
	var handling_events int32
	_, _, _, _, _ = ctx, event_flags, handling_events, v1, v2
	if !(dev_handle != 0) {
		return
	}
	if dev_handle != 0 {
	...
	if !(handling_events != 0) {
		...
		v1 = ctx + 300
		v2 = *(*uint32)(unsafe.Pointer(v1))
		*(*uint32)(unsafe.Pointer(v1)) = *(*uint32)(unsafe.Pointer(v1)) + 1
		if !(v2 != 0) {
			*(*uint32)(unsafe.Pointer(ctx + 296)) |= uint32(USBI_EVENT_DEVICE_CLOSE)
		}
		if !(event_flags != 0) {
			usbi_signal_event(tls, ctx+12)
		}
		usbi_mutex_unlock(tls, ctx+272)
	...
	if !(handling_events != 0) {
		...
		*(*uint32)(unsafe.Pointer(v1)) = *(*uint32)(unsafe.Pointer(v1)) - 1
		v2 = *(*uint32)(unsafe.Pointer(v1))
		if !(v2 != 0) {
			*(*uint32)(unsafe.Pointer(ctx + 296)) &= libc.Uint32FromInt32(^int32(USBI_EVENT_DEVICE_CLOSE))
		}
		if !((*libusb_context)(unsafe.Pointer(ctx)).Fevent_flags != 0) {
			usbi_clear_event(tls, ctx+12)
		}
		usbi_mutex_unlock(tls, ctx+272)
...
var __func__90 = [13]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'c', 'l', 'o', 's', 'e'}
...
func libusb_get_configuration(tls *libc.TLS, dev_handle uintptr, config uintptr) (r1 int32) {
	...
	*(*uint8_t)(unsafe.Pointer(bp)) = uint8(0)
	...
	if r == int32(LIBUSB_ERROR_NOT_SUPPORTED) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__91)), __ccgo_ts+7197, 0)
		...
		if r == int32(1) {
			...
			if r == 0 {
				usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__91)), __ccgo_ts+7229, 0)
				r = int32(LIBUSB_ERROR_IO)
			} else {
				usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__91)), __ccgo_ts+7267, libc.VaList(bp+16, r))
			}
		}
	}
	if r == 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__91)), __ccgo_ts+7292, libc.VaList(bp+16, libc.Int32FromUint8(*(*uint8_t)(unsafe.Pointer(bp)))))
		*(*int32)(unsafe.Pointer(config)) = libc.Int32FromUint8(*(*uint8_t)(unsafe.Pointer(bp)))
	}
	return r
}

var __func__91 = [25]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 'c', 'o', 'n', 'f', 'i', 'g', 'u', 'r', 'a', 't', 'i', 'o', 'n'}
...
func libusb_set_configuration(tls *libc.TLS, dev_handle uintptr, configuration int32) (r int32) {
	...
	usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__92)), __ccgo_ts+7309, libc.VaList(bp+8, configuration))
...
var __func__92 = [25]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 's', 'e', 't', '_', 'c', 'o', 'n', 'f', 'i', 'g', 'u', 'r', 'a', 't', 'i', 'o', 'n'}
...
func libusb_claim_interface(tls *libc.TLS, dev_handle uintptr, interface_number int32) (r1 int32) {
	...
	usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__93)), __ccgo_ts+7326, libc.VaList(bp+8, interface_number))
	if interface_number < 0 || interface_number >= int32(32) {
		return int32(LIBUSB_ERROR_INVALID_PARAM)
	}
	if !(libc.X__c11_atomic_loadInt32(tls, (*libusb_device_handle)(unsafe.Pointer(dev_handle)).Fdev+52, libc.Int32FromInt32(5)) != 0) {
		return int32(LIBUSB_ERROR_NO_DEVICE)
	}
	usbi_mutex_lock(tls, dev_handle)
	if (*libusb_device_handle)(unsafe.Pointer(dev_handle)).Fclaimed_interfaces&uint32(libc.Uint32FromUint32(1)<<interface_number) != 0 {
		goto out
	}
	...
	if r == 0 {
		*(*uint32)(unsafe.Pointer(dev_handle + 24)) |= uint32(uint32(1) << interface_number)
	}
	goto out
out:
	;
...
var __func__93 = [23]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'c', 'l', 'a', 'i', 'm', '_', 'i', 'n', 't', 'e', 'r', 'f', 'a', 'c', 'e'}
...
func libusb_release_interface(tls *libc.TLS, dev_handle uintptr, interface_number int32) (r1 int32) {
	...
	usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__94)), __ccgo_ts+7326, libc.VaList(bp+8, interface_number))
	if interface_number < 0 || interface_number >= int32(32) {
		return int32(LIBUSB_ERROR_INVALID_PARAM)
	}
	usbi_mutex_lock(tls, dev_handle)
	...
	if r == 0 {
		*(*uint32)(unsafe.Pointer(dev_handle + 24)) &= uint32(^(libc.Uint32FromUint32(1) << interface_number))
	}
	goto out
out:
	;
...
var __func__94 = [25]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'r', 'e', 'l', 'e', 'a', 's', 'e', '_', 'i', 'n', 't', 'e', 'r', 'f', 'a', 'c', 'e'}
...
func libusb_set_interface_alt_setting(tls *libc.TLS, dev_handle uintptr, interface_number int32, alternate_setting int32) (r int32) {
	...
	usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__95)), __ccgo_ts+7339, libc.VaList(bp+8, interface_number, alternate_setting))
	if interface_number < 0 || interface_number >= int32(32) {
		return int32(LIBUSB_ERROR_INVALID_PARAM)
	}
...
var __func__95 = [33]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 's', 'e', 't', '_', 'i', 'n', 't', 'e', 'r', 'f', 'a', 'c', 'e', '_', 'a', 'l', 't', '_', 's', 'e', 't', 't', 'i', 'n', 'g'}
...
func libusb_clear_halt(tls *libc.TLS, dev_handle uintptr, endpoint uint8) (r int32) {
	...
	usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__96)), __ccgo_ts+7366, libc.VaList(bp+8, libc.Int32FromUint8(endpoint)))
	if !(libc.X__c11_atomic_loadInt32(tls, (*libusb_device_handle)(unsafe.Pointer(dev_handle)).Fdev+52, libc.Int32FromInt32(5)) != 0) {
		return int32(LIBUSB_ERROR_NO_DEVICE)
	}
...
var __func__96 = [18]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'c', 'l', 'e', 'a', 'r', '_', 'h', 'a', 'l', 't'}
...
var __func__97 = [20]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'r', 'e', 's', 'e', 't', '_', 'd', 'e', 'v', 'i', 'c', 'e'}
...
func libusb_alloc_streams(tls *libc.TLS, dev_handle uintptr, num_streams uint32_t, endpoints uintptr, num_endpoints int32) (r int32) {
	...
	usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__98)), __ccgo_ts+7380, libc.VaList(bp+8, num_streams, num_endpoints))
...
var __func__98 = [21]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'a', 'l', 'l', 'o', 'c', '_', 's', 't', 'r', 'e', 'a', 'm', 's'}
...
func libusb_free_streams(tls *libc.TLS, dev_handle uintptr, endpoints uintptr, num_endpoints int32) (r int32) {
	...
	usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__99)), __ccgo_ts+7398, libc.VaList(bp+8, num_endpoints))
...
var __func__99 = [20]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'f', 'r', 'e', 'e', '_', 's', 't', 'r', 'e', 'a', 'm', 's'}
...
func libusb_kernel_driver_active(tls *libc.TLS, dev_handle uintptr, interface_number int32) (r int32) {
	...
	usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__100)), __ccgo_ts+7326, libc.VaList(bp+8, interface_number))
	if interface_number < 0 || interface_number >= int32(32) {
		return int32(LIBUSB_ERROR_INVALID_PARAM)
	}
	if !(libc.X__c11_atomic_loadInt32(tls, (*libusb_device_handle)(unsafe.Pointer(dev_handle)).Fdev+52, libc.Int32FromInt32(5)) != 0) {
...
var __func__100 = [28]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'k', 'e', 'r', 'n', 'e', 'l', '_', 'd', 'r', 'i', 'v', 'e', 'r', '_', 'a', 'c', 't', 'i', 'v', 'e'}
...
func libusb_detach_kernel_driver(tls *libc.TLS, dev_handle uintptr, interface_number int32) (r int32) {
	...
	usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__101)), __ccgo_ts+7326, libc.VaList(bp+8, interface_number))
	if interface_number < 0 || interface_number >= int32(32) {
		return int32(LIBUSB_ERROR_INVALID_PARAM)
	}
	if !(libc.X__c11_atomic_loadInt32(tls, (*libusb_device_handle)(unsafe.Pointer(dev_handle)).Fdev+52, libc.Int32FromInt32(5)) != 0) {
...
var __func__101 = [28]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'd', 'e', 't', 'a', 'c', 'h', '_', 'k', 'e', 'r', 'n', 'e', 'l', '_', 'd', 'r', 'i', 'v', 'e', 'r'}
...
func libusb_attach_kernel_driver(tls *libc.TLS, dev_handle uintptr, interface_number int32) (r int32) {
	...
	usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__102)), __ccgo_ts+7326, libc.VaList(bp+8, interface_number))
	if interface_number < 0 || interface_number >= int32(32) {
		return int32(LIBUSB_ERROR_INVALID_PARAM)
	}
	if !(libc.X__c11_atomic_loadInt32(tls, (*libusb_device_handle)(unsafe.Pointer(dev_handle)).Fdev+52, libc.Int32FromInt32(5)) != 0) {
...
var __func__102 = [28]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'a', 't', 't', 'a', 'c', 'h', '_', 'k', 'e', 'r', 'n', 'e', 'l', '_', 'd', 'r', 'i', 'v', 'e', 'r'}
...
func libusb_endpoint_supports_raw_io(tls *libc.TLS, dev_handle uintptr, endpoint uint8_t) (r int32) {
	...
	if v1 = usbi_backend.Fendpoint_set_raw_io != libc.UintptrFromInt32(0); !v1 {
		libc.X__assert_fail(tls, __ccgo_ts+7405, __ccgo_ts+6668, int32(2274), uintptr(unsafe.Pointer(&__func__103)))
	}
	_ = v1 || libc.Bool(libc.Int32FromInt32(0) != 0)
	if v1 = usbi_backend.Fget_max_raw_io_transfer_size != libc.UintptrFromInt32(0); !v1 {
		libc.X__assert_fail(tls, __ccgo_ts+7446, __ccgo_ts+6668, int32(2275), uintptr(unsafe.Pointer(&__func__103)))
	}
	_ = v1 || libc.Bool(libc.Int32FromInt32(0) != 0)
...
var __func__103 = [32]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'e', 'n', 'd', 'p', 'o', 'i', 'n', 't', '_', 's', 'u', 'p', 'p', 'o', 'r', 't', 's', '_', 'r', 'a', 'w', '_', 'i', 'o'}
...
func libusb_set_option(tls *libc.TLS, ctx uintptr, option libusb_option, va uintptr) (r1 int32) {
	...
	_, _, _, _, _, _, _ = ap, arg, is_default_context, log_cb, r, v3, v4
	arg = 0
	r = int32(LIBUSB_SUCCESS)
	...
	if libc.UintptrFromInt32(0) == ctx {
		...
		if int32(LIBUSB_OPTION_LOG_LEVEL) == option {
			*(*int32)(unsafe.Pointer(uintptr(unsafe.Pointer(&default_context_options)) + uintptr(option)*8 + 4)) = arg
		} else {
			if int32(LIBUSB_OPTION_LOG_CB) == option {
				*(*libusb_log_cb)(unsafe.Pointer(uintptr(unsafe.Pointer(&default_context_options)) + uintptr(option)*8 + 4)) = log_cb
	...
	case int32(LIBUSB_OPTION_LOG_LEVEL):
		if !((*libusb_context)(unsafe.Pointer(ctx)).Fdebug_fixed != 0) {
			...
			if is_default_context != 0 {
				...
				libc.X__c11_atomic_storeInt32(tls, uintptr(unsafe.Pointer(&default_debug_level)), v3, libc.Int32FromInt32(5))
			}
		}
...
func get_env_debug_level(tls *libc.TLS) (r libusb_log_level) {
	var dbg uintptr
	var dbg_level, v1, v2 int32
	var level libusb_log_level
	_, _, _, _, _ = dbg, dbg_level, level, v1, v2
	level = int32(LIBUSB_LOG_LEVEL_NONE)
	dbg = libc.Xgetenv(tls, __ccgo_ts+7496)
	if dbg != 0 {
		dbg_level = libc.Xstrtol(tls, dbg, libc.UintptrFromInt32(0), int32(10))
		if dbg_level < int32(LIBUSB_LOG_LEVEL_NONE) {
			v1 = int32(LIBUSB_LOG_LEVEL_NONE)
		} else {
			if dbg_level > int32(LIBUSB_LOG_LEVEL_DEBUG) {
				v2 = int32(LIBUSB_LOG_LEVEL_DEBUG)
			} else {
				v2 = dbg_level
			}
			v1 = v2
...
func libusb_init_context(tls *libc.TLS, ctx uintptr, options uintptr, num_options int32) (r1 int32) {
	...
	var priv_size size_t
	_, _, _, _, _ = _ctx, i, option, priv_size, r
	priv_size = usbi_backend.Fcontext_priv_size
	usbi_mutex_static_lock(tls, uintptr(unsafe.Pointer(&default_context_lock)))
	if !(ctx != 0) && default_context_refcnt > 0 {
		usbi_log(tls, usbi_default_context, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__104)), __ccgo_ts+7509, 0)
	...
	usbi_mutex_static_unlock(tls, uintptr(unsafe.Pointer(&active_contexts_lock)))
	_ctx = libc.Xcalloc(tls, uint32(1), uint32((libc.Uint32FromInt64(352)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)) + priv_size))
	if !(_ctx != 0) {
		usbi_mutex_static_unlock(tls, uintptr(unsafe.Pointer(&default_context_lock)))
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	(*libusb_context)(unsafe.Pointer(_ctx)).Fdebug = int32(LIBUSB_LOG_LEVEL_NONE)
	if libc.Xgetenv(tls, __ccgo_ts+7496) != 0 {
		...
		if default_context_options[int32(LIBUSB_OPTION_LOG_LEVEL)].Fis_set != 0 {
			(*libusb_context)(unsafe.Pointer(_ctx)).Fdebug = *(*int32)(unsafe.Pointer(uintptr(unsafe.Pointer(&default_context_options)) + uintptr(LIBUSB_OPTION_LOG_LEVEL)*8 + 4))
		}
	}
	usbi_mutex_init(tls, _ctx+20)
	usbi_mutex_init(tls, _ctx+52)
	list_init(tls, _ctx+44)
	list_init(tls, _ctx+76)
	option = 0
	for {
		if !(option < int32(LIBUSB_OPTION_MAX)) {
			break
		...
		if int32(LIBUSB_OPTION_LOG_CB) != option {
			...
			r = libusb_set_option(tls, _ctx, option, libc.VaList(bp+8, *(*libusb_log_cb)(unsafe.Pointer(uintptr(unsafe.Pointer(&default_context_options)) + uintptr(option)*8 + 4))))
		}
		if int32(LIBUSB_SUCCESS) != r {
			goto err_free_ctx
		}
	...
	for {
		...
		switch (*(*libusb_init_option)(unsafe.Pointer(options + uintptr(i)*8))).Foption {
		case int32(LIBUSB_OPTION_LOG_CB):
			r = libusb_set_option(tls, _ctx, (*(*libusb_init_option)(unsafe.Pointer(options + uintptr(i)*8))).Foption, libc.VaList(bp+8, *(*libusb_log_cb)(unsafe.Pointer(options + uintptr(i)*8 + 4))))
		case int32(LIBUSB_OPTION_LOG_LEVEL):
			fallthrough
		case int32(LIBUSB_OPTION_USE_USBDK):
			fallthrough
		...
		case int32(LIBUSB_OPTION_MAX):
			fallthrough
		default:
			r = libusb_set_option(tls, _ctx, (*(*libusb_init_option)(unsafe.Pointer(options + uintptr(i)*8))).Foption, libc.VaList(bp+8, *(*int32)(unsafe.Pointer(options + uintptr(i)*8 + 4))))
		}
		if int32(LIBUSB_SUCCESS) != r {
			goto err_free_ctx
		}
	...
	if !(ctx != 0) {
		...
		libc.X__c11_atomic_storeInt32(tls, uintptr(unsafe.Pointer(&default_debug_level)), (*libusb_context)(unsafe.Pointer(_ctx)).Fdebug, libc.Int32FromInt32(5))
		usbi_log(tls, usbi_default_context, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__104)), __ccgo_ts+7533, 0)
	}
	usbi_log(tls, _ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__104)), __ccgo_ts+7557, libc.VaList(bp+8, libc.Int32FromUint16(libusb_version_internal.Fmajor), libc.Int32FromUint16(libusb_version_internal.Fminor), libc.Int32FromUint16(libusb_version_internal.Fmicro), libc.Int32FromUint16(libusb_version_internal.Fnano), libusb_version_internal.Frc))
	r = usbi_io_init(tls, _ctx)
	if r < 0 {
		goto err_free_ctx
	}
	usbi_mutex_static_lock(tls, uintptr(unsafe.Pointer(&active_contexts_lock)))
	list_add(tls, _ctx+344, uintptr(unsafe.Pointer(&active_contexts_list)))
	usbi_mutex_static_unlock(tls, uintptr(unsafe.Pointer(&active_contexts_lock)))
	...
	if ctx != 0 {
		*(*uintptr)(unsafe.Pointer(ctx)) = _ctx
		if !(usbi_fallback_context != 0) {
			if int32(libc.X__c11_atomic_loadInt32(tls, uintptr(unsafe.Pointer(&default_debug_level)), libc.Int32FromInt32(5))) == -int32(1) {
				libc.X__c11_atomic_storeInt32(tls, uintptr(unsafe.Pointer(&default_debug_level)), (*libusb_context)(unsafe.Pointer(_ctx)).Fdebug, libc.Int32FromInt32(5))
			}
			usbi_fallback_context = _ctx
			usbi_log(tls, usbi_fallback_context, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__104)), __ccgo_ts+7579, 0)
		}
	}
	usbi_mutex_static_unlock(tls, uintptr(unsafe.Pointer(&default_context_lock)))
	return 0
...
err_free_ctx:
	...
	usbi_mutex_destroy(tls, _ctx+52)
	usbi_mutex_destroy(tls, _ctx+20)
	libc.Xfree(tls, _ctx)
	usbi_mutex_static_unlock(tls, uintptr(unsafe.Pointer(&default_context_lock)))
	return r
}

var __func__104 = [20]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'i', 'n', 'i', 't', '_', 'c', 'o', 'n', 't', 'e', 'x', 't'}
...
func libusb_exit(tls *libc.TLS, ctx uintptr) {
	...
	if !(ctx != 0) {
		if !(usbi_default_context != 0) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__105)), __ccgo_ts+7622, 0)
			usbi_mutex_static_unlock(tls, uintptr(unsafe.Pointer(&default_context_lock)))
			return
		}
		default_context_refcnt = default_context_refcnt - 1
		...
		if v1 > 0 {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__105)), __ccgo_ts+7659, 0)
			usbi_mutex_static_unlock(tls, uintptr(unsafe.Pointer(&default_context_lock)))
			return
		}
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__105)), __ccgo_ts+7690, 0)
	...
	usbi_mutex_static_unlock(tls, uintptr(unsafe.Pointer(&default_context_lock)))
	usbi_io_exit(tls, _ctx)
	dev = uintptr(uint32((*list_head)(unsafe.Pointer(_ctx+44)).Fnext) - uint32(libc.UintptrFromInt32(0)+20))
	for {
		if !(dev+20 != _ctx+44) {
			break
		}
		usbi_log(tls, _ctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__105)), __ccgo_ts+7717, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_device)(unsafe.Pointer(dev)).Fbus_number), libc.Int32FromUint8((*libusb_device)(unsafe.Pointer(dev)).Fdevice_address)))
	...
	if !((*list_head)(unsafe.Pointer(_ctx+76)).Fnext == _ctx+76) {
		usbi_log(tls, _ctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__105)), __ccgo_ts+7747, 0)
	}
	usbi_mutex_destroy(tls, _ctx+52)
	usbi_mutex_destroy(tls, _ctx+20)
	libc.Xfree(tls, _ctx)
...
var __func__105 = [12]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'e', 'x', 'i', 't'}
...
func log_v(tls *libc.TLS, ctx uintptr, level libusb_log_level, function uintptr, format uintptr, args va_list) {
	...
	var default_level_value, global_debug, header_len, text_len, v1 int32
	var prefix uintptr
	var _ /* buf at bp+0 */ [1024]int8
	var _ /* timestamp at bp+1024 */ timespec
	_, _, _, _, _, _, _ = ctx_level, default_level_value, global_debug, header_len, prefix, text_len, v1
	if ctx != 0 {
		ctx_level = (*libusb_context)(unsafe.Pointer(ctx)).Fdebug
	} else {
		default_level_value = libc.X__c11_atomic_loadInt32(tls, uintptr(unsafe.Pointer(&default_debug_level)), libc.Int32FromInt32(5))
		if default_level_value < 0 {
			v1 = get_env_debug_level(tls)
		} else {
			v1 = default_level_value
		}
		ctx_level = v1
	}
	if ctx_level < level {
	...
	case int32(LIBUSB_LOG_LEVEL_ERROR):
		prefix = __ccgo_ts + 7782
	case int32(LIBUSB_LOG_LEVEL_WARNING):
		prefix = __ccgo_ts + 7788
	case int32(LIBUSB_LOG_LEVEL_INFO):
		prefix = __ccgo_ts + 7796
	case int32(LIBUSB_LOG_LEVEL_DEBUG):
		prefix = __ccgo_ts + 7801
	default:
		prefix = __ccgo_ts + 7807
		break
	}
	if global_debug != 0 {
		if !(has_debug_header_been_displayed != 0) {
			has_debug_header_been_displayed = int32(1)
			log_str(tls, int32(LIBUSB_LOG_LEVEL_DEBUG), __ccgo_ts+7815)
			log_str(tls, int32(LIBUSB_LOG_LEVEL_DEBUG), __ccgo_ts+7880)
		}
		usbi_get_monotonic_time(tls, bp+1024)
		(*timespec)(unsafe.Pointer(bp + 1024)).Ftv_sec = (*timespec)(unsafe.Pointer(bp+1024)).Ftv_sec - (*timespec)(unsafe.Pointer(uintptr(unsafe.Pointer(&timestamp_origin)))).Ftv_sec
		(*timespec)(unsafe.Pointer(bp + 1024)).Ftv_nsec = (*timespec)(unsafe.Pointer(bp+1024)).Ftv_nsec - (*timespec)(unsafe.Pointer(uintptr(unsafe.Pointer(&timestamp_origin)))).Ftv_nsec
		if (*timespec)(unsafe.Pointer(bp+1024)).Ftv_nsec < 0 {
			(*timespec)(unsafe.Pointer(bp + 1024)).Ftv_sec = (*timespec)(unsafe.Pointer(bp+1024)).Ftv_sec - 1
			*(*int32)(unsafe.Pointer(bp + 1024 + 8)) += int32(1000000000)
		}
		header_len = libc.X__builtin_snprintf(tls, bp, uint32(1024), __ccgo_ts+7962, libc.VaList(bp+1048, int32((*(*timespec)(unsafe.Pointer(bp + 1024))).Ftv_sec), (*(*timespec)(unsafe.Pointer(bp + 1024))).Ftv_nsec/libc.Int32FromInt32(1000), usbi_get_tid(tls), prefix, function))
	} else {
		header_len = libc.X__builtin_snprintf(tls, bp, uint32(1024), __ccgo_ts+8000, libc.VaList(bp+1048, prefix, function))
	}
	if header_len < 0 || header_len >= libc.Int32FromInt64(1024) {
		header_len = 0
	}
	text_len = libc.X__builtin_vsnprintf(tls, bp+uintptr(header_len), uint32(1024)-uint32(libc.Uint32FromInt32(header_len)), format, args)
	...
	if header_len+text_len+libc.Int32FromInt64(2) >= libc.Int32FromInt64(1024) {
		text_len = text_len - (header_len + text_len + libc.Int32FromInt64(2) - libc.Int32FromInt64(1024))
	}
	libc.Xstrcpy(tls, bp+uintptr(header_len)+uintptr(text_len), __ccgo_ts+8017)
...
func parse_endpoint(tls *libc.TLS, ctx uintptr, endpoint uintptr, buffer uintptr, size int32) (r int32) {
	...
	parsed = 0
	if size < int32(2) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__106)), __ccgo_ts+8500, libc.VaList(bp+8, size, int32(2)))
		return int32(LIBUSB_ERROR_IO)
	}
	header = buffer
	if libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbDescriptorType) != int32(LIBUSB_DT_ENDPOINT) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__106)), __ccgo_ts+8537, libc.VaList(bp+8, libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbDescriptorType), int32(LIBUSB_DT_ENDPOINT)))
		return parsed
	} else {
		if libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength) < int32(7) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__106)), __ccgo_ts+8580, libc.VaList(bp+8, libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)))
			return int32(LIBUSB_ERROR_IO)
		} else {
			if libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength) > size {
				usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__106)), __ccgo_ts+8610, libc.VaList(bp+8, size, libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)))
				return parsed
			}
		}
	}
	...
	buffer = buffer + uintptr((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)
	size = size - libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)
	parsed = parsed + libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)
	begin = buffer
	for size >= int32(2) {
		header = buffer
		if libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength) < int32(2) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__106)), __ccgo_ts+8647, libc.VaList(bp+8, libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)))
			return int32(LIBUSB_ERROR_IO)
		} else {
			if libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength) > size {
				usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__106)), __ccgo_ts+8678, libc.VaList(bp+8, size, libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)))
				return parsed
			}
		}
		...
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__106)), __ccgo_ts+8709, libc.VaList(bp+8, libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbDescriptorType)))
		buffer = buffer + uintptr((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)
		size = size - libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)
		parsed = parsed + libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)
	}
	len1 = int32(buffer) - int32(begin)
	if len1 <= 0 {
		return parsed
	}
	extra = libc.Xmalloc(tls, libc.Uint32FromInt32(len1))
	if !(extra != 0) {
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	libc.Xmemcpy(tls, extra, begin, libc.Uint32FromInt32(len1))
	(*libusb_endpoint_descriptor)(unsafe.Pointer(endpoint)).Fextra = extra
	(*libusb_endpoint_descriptor)(unsafe.Pointer(endpoint)).Fextra_length = len1
	return parsed
}

var __func__106 = [15]int8{'p', 'a', 'r', 's', 'e', '_', 'e', 'n', 'd', 'p', 'o', 'i', 'n', 't'}
...
func clear_interface(tls *libc.TLS, usb_interface uintptr) {
	...
	if (*libusb_interface)(unsafe.Pointer(usb_interface)).Faltsetting != 0 {
		...
		for {
			...
			ifp = (*libusb_interface)(unsafe.Pointer(usb_interface)).Faltsetting + uintptr(i)*24
			...
			if (*libusb_interface_descriptor)(unsafe.Pointer(ifp)).Fendpoint != 0 {
				...
				for {
					...
					clear_endpoint(tls, (*libusb_interface_descriptor)(unsafe.Pointer(ifp)).Fendpoint+uintptr(j)*20)
					goto _2
				_2:
					;
					j = j + 1
...
func parse_interface(tls *libc.TLS, ctx uintptr, usb_interface uintptr, buffer uintptr, size int32) (r1 int32) {
	...
	for size >= int32(9) {
		altsetting = libc.Xrealloc(tls, (*libusb_interface)(unsafe.Pointer(usb_interface)).Faltsetting, uint32(24)*uint32(libc.Uint32FromInt32((*libusb_interface)(unsafe.Pointer(usb_interface)).Fnum_altsetting+libc.Int32FromInt32(1))))
		if !(altsetting != 0) {
			r = int32(LIBUSB_ERROR_NO_MEM)
			goto err
		}
		(*libusb_interface)(unsafe.Pointer(usb_interface)).Faltsetting = altsetting
		ifp = altsetting + uintptr((*libusb_interface)(unsafe.Pointer(usb_interface)).Fnum_altsetting)*24
		...
		if libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(ifp)).FbDescriptorType) != int32(LIBUSB_DT_INTERFACE) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__107)), __ccgo_ts+8537, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(ifp)).FbDescriptorType), int32(LIBUSB_DT_INTERFACE)))
			return parsed
		} else {
			if libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(ifp)).FbLength) < int32(9) {
				usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__107)), __ccgo_ts+8734, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(ifp)).FbLength)))
				r = int32(LIBUSB_ERROR_IO)
				goto err
			} else {
				if libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(ifp)).FbLength) > size {
					usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__107)), __ccgo_ts+8765, libc.VaList(bp+8, size, libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(ifp)).FbLength)))
					return parsed
				} else {
					if libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(ifp)).FbNumEndpoints) > int32(32) {
						usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__107)), __ccgo_ts+8798, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(ifp)).FbNumEndpoints)))
						r = int32(LIBUSB_ERROR_IO)
						goto err
					}
				}
		...
		(*libusb_interface)(unsafe.Pointer(usb_interface)).Fnum_altsetting = (*libusb_interface)(unsafe.Pointer(usb_interface)).Fnum_altsetting + 1
		(*libusb_interface_descriptor)(unsafe.Pointer(ifp)).Fextra = libc.UintptrFromInt32(0)
		(*libusb_interface_descriptor)(unsafe.Pointer(ifp)).Fextra_length = 0
		(*libusb_interface_descriptor)(unsafe.Pointer(ifp)).Fendpoint = libc.UintptrFromInt32(0)
		...
		buffer = buffer + uintptr((*libusb_interface_descriptor)(unsafe.Pointer(ifp)).FbLength)
		parsed = parsed + libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(ifp)).FbLength)
		size = size - libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(ifp)).FbLength)
		begin = buffer
		for size >= int32(2) {
			header = buffer
			if libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength) < int32(2) {
				usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__107)), __ccgo_ts+8822, libc.VaList(bp+8, libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)))
				r = int32(LIBUSB_ERROR_IO)
				goto err
			} else {
				if libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength) > size {
					usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__107)), __ccgo_ts+8855, libc.VaList(bp+8, size, libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)))
					return parsed
				}
			}
			if libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbDescriptorType) == int32(LIBUSB_DT_INTERFACE) || libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbDescriptorType) == int32(LIBUSB_DT_ENDPOINT) || libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbDescriptorType) == int32(LIBUSB_DT_CONFIG) || libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbDescriptorType) == int32(LIBUSB_DT_DEVICE) {
		...
		if len1 > 0 {
			...
			(*libusb_interface_descriptor)(unsafe.Pointer(ifp)).Fextra_length = len1
		}
		if libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(ifp)).FbNumEndpoints) > 0 {
			endpoint = libc.Xcalloc(tls, uint32((*libusb_interface_descriptor)(unsafe.Pointer(ifp)).FbNumEndpoints), uint32(20))
			if !(endpoint != 0) {
				r = int32(LIBUSB_ERROR_NO_MEM)
				goto err
			}
			...
			for {
				...
				r = parse_endpoint(tls, ctx, endpoint+uintptr(i)*20, buffer, size)
				if r < 0 {
					goto err
				}
				if r == 0 {
...
var __func__107 = [16]int8{'p', 'a', 'r', 's', 'e', '_', 'i', 'n', 't', 'e', 'r', 'f', 'a', 'c', 'e'}
...
func clear_configuration(tls *libc.TLS, config uintptr) {
	...
	if (*libusb_config_descriptor)(unsafe.Pointer(config)).Finterface1 != 0 {
		...
		for {
			...
			clear_interface(tls, (*libusb_config_descriptor)(unsafe.Pointer(config)).Finterface1+uintptr(i)*8)
			goto _1
		_1:
			;
			i = i + 1
...
func parse_configuration(tls *libc.TLS, ctx uintptr, config uintptr, buffer uintptr, size int32) (r1 int32) {
	...
	if size < int32(9) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__108)), __ccgo_ts+8888, libc.VaList(bp+8, size, int32(9)))
		return int32(LIBUSB_ERROR_IO)
	}
	...
	if libc.Int32FromUint8((*libusb_config_descriptor)(unsafe.Pointer(config)).FbDescriptorType) != int32(LIBUSB_DT_CONFIG) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__108)), __ccgo_ts+8537, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_config_descriptor)(unsafe.Pointer(config)).FbDescriptorType), int32(LIBUSB_DT_CONFIG)))
		return int32(LIBUSB_ERROR_IO)
	} else {
		if libc.Int32FromUint8((*libusb_config_descriptor)(unsafe.Pointer(config)).FbLength) < int32(9) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__108)), __ccgo_ts+8923, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_config_descriptor)(unsafe.Pointer(config)).FbLength)))
			return int32(LIBUSB_ERROR_IO)
		} else {
			if libc.Int32FromUint8((*libusb_config_descriptor)(unsafe.Pointer(config)).FbLength) > size {
				usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__108)), __ccgo_ts+8951, libc.VaList(bp+8, size, libc.Int32FromUint8((*libusb_config_descriptor)(unsafe.Pointer(config)).FbLength)))
				return int32(LIBUSB_ERROR_IO)
			} else {
				if libc.Int32FromUint8((*libusb_config_descriptor)(unsafe.Pointer(config)).FbNumInterfaces) > int32(32) {
					usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__108)), __ccgo_ts+8986, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_config_descriptor)(unsafe.Pointer(config)).FbNumInterfaces)))
					return int32(LIBUSB_ERROR_IO)
				}
			}
		}
	}
	usb_interface = libc.Xcalloc(tls, uint32((*libusb_config_descriptor)(unsafe.Pointer(config)).FbNumInterfaces), uint32(8))
	if !(usb_interface != 0) {
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	(*libusb_config_descriptor)(unsafe.Pointer(config)).Finterface1 = usb_interface
	buffer = buffer + uintptr((*libusb_config_descriptor)(unsafe.Pointer(config)).FbLength)
	size = size - libc.Int32FromUint8((*libusb_config_descriptor)(unsafe.Pointer(config)).FbLength)
	i = uint8(0)
	for {
		if !(libc.Int32FromUint8(i) < libc.Int32FromUint8((*libusb_config_descriptor)(unsafe.Pointer(config)).FbNumInterfaces)) {
			break
		...
		for size >= int32(2) {
			header = buffer
			if libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength) < int32(2) {
				usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__108)), __ccgo_ts+9011, libc.VaList(bp+8, libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)))
				r = int32(LIBUSB_ERROR_IO)
				goto err
			} else {
				if libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength) > size {
					usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__108)), __ccgo_ts+9046, libc.VaList(bp+8, size, libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)))
			...
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__108)), __ccgo_ts+8709, libc.VaList(bp+8, libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbDescriptorType)))
			buffer = buffer + uintptr((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)
			size = size - libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)
		}
		len1 = int32(buffer) - int32(begin)
		if len1 > 0 {
			extra = libc.Xrealloc(tls, (*libusb_config_descriptor)(unsafe.Pointer(config)).Fextra, libc.Uint32FromInt32((*libusb_config_descriptor)(unsafe.Pointer(config)).Fextra_length)+libc.Uint32FromInt32(len1))
			if !(extra != 0) {
				r = int32(LIBUSB_ERROR_NO_MEM)
				goto err
			}
			libc.Xmemcpy(tls, extra+uintptr((*libusb_config_descriptor)(unsafe.Pointer(config)).Fextra_length), begin, libc.Uint32FromInt32(len1))
			(*libusb_config_descriptor)(unsafe.Pointer(config)).Fextra = extra
			*(*int32)(unsafe.Pointer(config + 20)) += len1
		}
		r = parse_interface(tls, ctx, usb_interface+uintptr(i)*8, buffer, size)
		if r < 0 {
			goto err
		}
		if r == 0 {
...
var __func__108 = [20]int8{'p', 'a', 'r', 's', 'e', '_', 'c', 'o', 'n', 'f', 'i', 'g', 'u', 'r', 'a', 't', 'i', 'o', 'n'}
...
func raw_desc_to_config(tls *libc.TLS, ctx uintptr, buf uintptr, size int32, config uintptr) (r1 int32) {
	...
	var r int32
	_, _ = _config, r
	_config = libc.Xcalloc(tls, uint32(1), uint32(24))
	if !(_config != 0) {
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	r = parse_configuration(tls, ctx, _config, buf, size)
	if r < 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__109)), __ccgo_ts+9081, libc.VaList(bp+8, r))
		libc.Xfree(tls, _config)
		return r
	} else {
		if r > 0 {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__109)), __ccgo_ts+9122, libc.VaList(bp+8, r))
		}
	}
...
var __func__109 = [19]int8{'r', 'a', 'w', '_', 'd', 'e', 's', 'c', '_', 't', 'o', '_', 'c', 'o', 'n', 'f', 'i', 'g'}
...
func get_active_config_descriptor(tls *libc.TLS, dev uintptr, buffer uintptr, size size_t) (r1 int32) {
	...
	if r < int32(9) {
		usbi_log(tls, (*libusb_device)(unsafe.Pointer(dev)).Fctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__110)), __ccgo_ts+8888, libc.VaList(bp+8, r, int32(9)))
		return int32(LIBUSB_ERROR_IO)
	} else {
		if r != libc.Int32FromUint32(size) {
			usbi_log(tls, (*libusb_device)(unsafe.Pointer(dev)).Fctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__110)), __ccgo_ts+8888, libc.VaList(bp+8, r, libc.Int32FromUint32(size)))
		}
	}
	return r
}

var __func__110 = [29]int8{'g', 'e', 't', '_', 'a', 'c', 't', 'i', 'v', 'e', '_', 'c', 'o', 'n', 'f', 'i', 'g', '_', 'd', 'e', 's', 'c', 'r', 'i', 'p', 't', 'o', 'r'}
...
func get_config_descriptor(tls *libc.TLS, dev uintptr, config_idx uint8_t, buffer uintptr, size size_t) (r1 int32) {
	...
	if r < int32(9) {
		usbi_log(tls, (*libusb_device)(unsafe.Pointer(dev)).Fctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__111)), __ccgo_ts+8888, libc.VaList(bp+8, r, int32(9)))
		return int32(LIBUSB_ERROR_IO)
	} else {
		if r != libc.Int32FromUint32(size) {
			usbi_log(tls, (*libusb_device)(unsafe.Pointer(dev)).Fctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__111)), __ccgo_ts+8888, libc.VaList(bp+8, r, libc.Int32FromUint32(size)))
		}
	}
	return r
}

var __func__111 = [22]int8{'g', 'e', 't', '_', 'c', 'o', 'n', 'f', 'i', 'g', '_', 'd', 'e', 's', 'c', 'r', 'i', 'p', 't', 'o', 'r'}
...
var __func__112 = [29]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 'd', 'e', 'v', 'i', 'c', 'e', '_', 'd', 'e', 's', 'c', 'r', 'i', 'p', 't', 'o', 'r'}
...
func libusb_get_active_config_descriptor(tls *libc.TLS, dev uintptr, config uintptr) (r1 int32) {
	...
	r = get_active_config_descriptor(tls, dev, bp, uint32(9))
	if r < 0 {
		return r
	}
	config_len = libusb_cpu_to_le16(tls, (*(*usbi_configuration_descriptor)(unsafe.Pointer(bp))).FwTotalLength)
	buf = libc.Xmalloc(tls, uint32(config_len))
	if !(buf != 0) {
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	r = get_active_config_descriptor(tls, dev, buf, uint32(config_len))
	if r >= 0 {
...
func libusb_get_config_descriptor(tls *libc.TLS, dev uintptr, config_index uint8_t, config uintptr) (r1 int32) {
	...
	var _ /* _config at bp+0 */ usbi_config_desc_buf
	_, _, _ = buf, config_len, r
	usbi_log(tls, (*libusb_device)(unsafe.Pointer(dev)).Fctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__113)), __ccgo_ts+9161, libc.VaList(bp+24, libc.Int32FromUint8(config_index)))
	if libc.Int32FromUint8(config_index) >= libc.Int32FromUint8((*libusb_device)(unsafe.Pointer(dev)).Fdevice_descriptor.FbNumConfigurations) {
		return int32(LIBUSB_ERROR_NOT_FOUND)
	}
	r = get_config_descriptor(tls, dev, config_index, bp, uint32(9))
	if r < 0 {
		return r
	}
	config_len = libusb_cpu_to_le16(tls, (*(*usbi_configuration_descriptor)(unsafe.Pointer(bp))).FwTotalLength)
	...
	r = get_config_descriptor(tls, dev, config_index, buf, uint32(config_len))
	if r >= 0 {
		r = raw_desc_to_config(tls, (*libusb_device)(unsafe.Pointer(dev)).Fctx, buf, r, config)
	}
	libc.Xfree(tls, buf)
...
var __func__113 = [29]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 'c', 'o', 'n', 'f', 'i', 'g', '_', 'd', 'e', 's', 'c', 'r', 'i', 'p', 't', 'o', 'r'}
...
func libusb_get_config_descriptor_by_value(tls *libc.TLS, dev uintptr, bConfigurationValue uint8_t, config uintptr) (r1 int32) {
	...
	var idx uint8_t
	var r int32
	var _ /* _config at bp+4 */ usbi_config_desc_buf
	...
	usbi_log(tls, (*libusb_device)(unsafe.Pointer(dev)).Fctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__114)), __ccgo_ts+9170, libc.VaList(bp+24, libc.Int32FromUint8(bConfigurationValue)))
	idx = uint8(0)
	for {
		if !(libc.Int32FromUint8(idx) < libc.Int32FromUint8((*libusb_device)(unsafe.Pointer(dev)).Fdevice_descriptor.FbNumConfigurations)) {
			break
		}
		r = get_config_descriptor(tls, dev, idx, bp+4, uint32(9))
		if r < 0 {
			return r
		}
		if libc.Int32FromUint8((*(*usbi_configuration_descriptor)(unsafe.Pointer(bp + 4))).FbConfigurationValue) == libc.Int32FromUint8(bConfigurationValue) {
...
var __func__114 = [38]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 'c', 'o', 'n', 'f', 'i', 'g', '_', 'd', 'e', 's', 'c', 'r', 'i', 'p', 't', 'o', 'r', '_', 'b', 'y', '_', 'v', 'a', 'l', 'u', 'e'}
	...
	*(*uintptr)(unsafe.Pointer(ep_comp)) = libc.UintptrFromInt32(0)
	for size >= int32(2) {
		...
		if libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbDescriptorType) != int32(LIBUSB_DT_SS_ENDPOINT_COMPANION) {
			if libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength) < int32(2) {
				usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__115)), __ccgo_ts+9179, libc.VaList(bp+8, libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)))
				return int32(LIBUSB_ERROR_IO)
			}
			buffer = buffer + uintptr((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)
			size = size - libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)
			...
			if libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength) < int32(6) {
				usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__115)), __ccgo_ts+9208, libc.VaList(bp+8, libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)))
				return int32(LIBUSB_ERROR_IO)
			} else {
				if libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength) > size {
					usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__115)), __ccgo_ts+9242, libc.VaList(bp+8, size, libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)))
					return int32(LIBUSB_ERROR_IO)
				}
			}
		}
		*(*uintptr)(unsafe.Pointer(ep_comp)) = libc.Xmalloc(tls, uint32(6))
...
var __func__115 = [44]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 's', 's', '_', 'e', 'n', 'd', 'p', 'o', 'i', 'n', 't', '_', 'c', 'o', 'm', 'p', 'a', 'n', 'i', 'o', 'n', '_', 'd', 'e', 's', 'c', 'r', 'i', 'p', 't', 'o', 'r'}
...
func parse_bos(tls *libc.TLS, ctx uintptr, bos uintptr, buffer uintptr, size int32) (r int32) {
	...
	if size < int32(5) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__116)), __ccgo_ts+9275, libc.VaList(bp+8, size, int32(5)))
		return int32(LIBUSB_ERROR_IO)
	}
	bos_desc = buffer
	if libc.Int32FromUint8((*usbi_bos_descriptor)(unsafe.Pointer(bos_desc)).FbDescriptorType) != int32(LIBUSB_DT_BOS) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__116)), __ccgo_ts+8537, libc.VaList(bp+8, libc.Int32FromUint8((*usbi_bos_descriptor)(unsafe.Pointer(bos_desc)).FbDescriptorType), int32(LIBUSB_DT_BOS)))
		return int32(LIBUSB_ERROR_IO)
	} else {
		if libc.Int32FromUint8((*usbi_bos_descriptor)(unsafe.Pointer(bos_desc)).FbLength) < int32(5) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__116)), __ccgo_ts+9307, libc.VaList(bp+8, libc.Int32FromUint8((*usbi_bos_descriptor)(unsafe.Pointer(bos_desc)).FbLength)))
			return int32(LIBUSB_ERROR_IO)
		} else {
			if libc.Int32FromUint8((*usbi_bos_descriptor)(unsafe.Pointer(bos_desc)).FbLength) > size {
				usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__116)), __ccgo_ts+9332, libc.VaList(bp+8, size, libc.Int32FromUint8((*usbi_bos_descriptor)(unsafe.Pointer(bos_desc)).FbLength)))
				return int32(LIBUSB_ERROR_IO)
			}
		}
	}
	_bos = libc.Xcalloc(tls, uint32(1), uint32(8)+uint32((*usbi_bos_descriptor)(unsafe.Pointer(bos_desc)).FbNumDeviceCaps)*uint32(4))
	if !(_bos != 0) {
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	...
	buffer = buffer + uintptr((*libusb_bos_descriptor)(unsafe.Pointer(_bos)).FbLength)
	size = size - libc.Int32FromUint8((*libusb_bos_descriptor)(unsafe.Pointer(_bos)).FbLength)
	i = uint8(0)
	for {
		...
		if size < int32(3) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__116)), __ccgo_ts+9364, libc.VaList(bp+8, size, int32(3)))
			break
		}
		header = buffer
		if libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbDescriptorType) != int32(LIBUSB_DT_DEVICE_CAPABILITY) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__116)), __ccgo_ts+8537, libc.VaList(bp+8, libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbDescriptorType), int32(LIBUSB_DT_DEVICE_CAPABILITY)))
			break
		} else {
			if libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength) < int32(3) {
				usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__116)), __ccgo_ts+9400, libc.VaList(bp+8, libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)))
				libusb_free_bos_descriptor(tls, _bos)
				return int32(LIBUSB_ERROR_IO)
			} else {
				if libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength) > size {
					usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__116)), __ccgo_ts+9429, libc.VaList(bp+8, size, libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)))
					break
				}
			}
		}
		*(*uintptr)(unsafe.Pointer(_bos + 8 + uintptr(i)*4)) = libc.Xmalloc(tls, uint32((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength))
		if !(*(*uintptr)(unsafe.Pointer(_bos + 8 + uintptr(i)*4)) != 0) {
			libusb_free_bos_descriptor(tls, _bos)
			return int32(LIBUSB_ERROR_NO_MEM)
		}
		libc.Xmemcpy(tls, *(*uintptr)(unsafe.Pointer(_bos + 8 + uintptr(i)*4)), buffer, uint32((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength))
		buffer = buffer + uintptr((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)
		size = size - libc.Int32FromUint8((*usbi_descriptor_header)(unsafe.Pointer(header)).FbLength)
		goto _1
	_1:
...
func libusb_get_bos_descriptor(tls *libc.TLS, dev_handle uintptr, bos uintptr) (r1 int32) {
	...
	if r < 0 {
		if r != int32(LIBUSB_ERROR_PIPE) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__117)), __ccgo_ts+9465, libc.VaList(bp+16, r))
		}
		return r
	}
	if r < int32(5) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__117)), __ccgo_ts+9489, libc.VaList(bp+16, r, int32(5)))
		return int32(LIBUSB_ERROR_IO)
	}
	bos_len = libusb_cpu_to_le16(tls, (*(*usbi_bos_descriptor)(unsafe.Pointer(bp))).FwTotalLength)
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__117)), __ccgo_ts+9510, libc.VaList(bp+16, libc.Int32FromUint16(bos_len), libc.Int32FromUint8((*(*usbi_bos_descriptor)(unsafe.Pointer(bp))).FbNumDeviceCaps)))
	bos_data = libc.Xcalloc(tls, uint32(1), uint32(bos_len))
	if !(bos_data != 0) {
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	...
	if r >= 0 {
		if r != libc.Int32FromUint16(bos_len) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__117)), __ccgo_ts+9563, libc.VaList(bp+16, r, libc.Int32FromUint16(bos_len)))
		}
		if dev_handle != 0 {
			v1 = (*libusb_device)(unsafe.Pointer((*libusb_device_handle)(unsafe.Pointer(dev_handle)).Fdev)).Fctx
		} else {
		...
		r = parse_bos(tls, v1, bos, bos_data, r)
	} else {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__117)), __ccgo_ts+9465, libc.VaList(bp+16, r))
	}
...
var __func__117 = [26]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 'b', 'o', 's', '_', 'd', 'e', 's', 'c', 'r', 'i', 'p', 't', 'o', 'r'}
...
func libusb_free_bos_descriptor(tls *libc.TLS, bos uintptr) {
	...
	for {
		...
		libc.Xfree(tls, *(*uintptr)(unsafe.Pointer(bos + 8 + uintptr(i)*4)))
		goto _1
	_1:
		;
		i = i + 1
...
func libusb_get_usb_2_0_extension_descriptor(tls *libc.TLS, ctx uintptr, dev_cap uintptr, usb_2_0_extension uintptr) (r int32) {
	...
	if libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbDevCapabilityType) != int32(LIBUSB_BT_USB_2_0_EXTENSION) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__118)), __ccgo_ts+9584, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbDevCapabilityType), int32(LIBUSB_BT_USB_2_0_EXTENSION)))
		return int32(LIBUSB_ERROR_INVALID_PARAM)
	} else {
		if libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbLength) < int32(7) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__118)), __ccgo_ts+9635, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbLength), int32(7)))
			return int32(LIBUSB_ERROR_IO)
		}
	}
	_usb_2_0_extension = libc.Xmalloc(tls, uint32(8))
...
var __func__118 = [40]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 'u', 's', 'b', '_', '2', '_', '0', '_', 'e', 'x', 't', 'e', 'n', 's', 'i', 'o', 'n', '_', 'd', 'e', 's', 'c', 'r', 'i', 'p', 't', 'o', 'r'}
...
func libusb_get_ss_usb_device_capability_descriptor(tls *libc.TLS, ctx uintptr, dev_cap uintptr, ss_usb_device_cap uintptr) (r int32) {
	...
	if libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbDevCapabilityType) != int32(LIBUSB_BT_SS_USB_DEVICE_CAPABILITY) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__119)), __ccgo_ts+9584, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbDevCapabilityType), int32(LIBUSB_BT_SS_USB_DEVICE_CAPABILITY)))
		return int32(LIBUSB_ERROR_INVALID_PARAM)
	} else {
		if libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbLength) < int32(10) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__119)), __ccgo_ts+9635, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbLength), int32(10)))
			return int32(LIBUSB_ERROR_IO)
		}
	}
	_ss_usb_device_cap = libc.Xmalloc(tls, uint32(10))
...
var __func__119 = [47]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 's', 's', '_', 'u', 's', 'b', '_', 'd', 'e', 'v', 'i', 'c', 'e', '_', 'c', 'a', 'p', 'a', 'b', 'i', 'l', 'i', 't', 'y', '_', 'd', 'e', 's', 'c', 'r', 'i', 'p', 't', 'o', 'r'}
...
func libusb_get_ssplus_usb_device_capability_descriptor(tls *libc.TLS, ctx uintptr, dev_cap uintptr, ssplus_usb_device_cap uintptr) (r int32) {
	...
	var v2 int32
	_, _, _, _, _, _, _, _ = _ssplus_cap, attr, base, dev_capability_data, i, numSublikSpeedAttributes, parsedDescriptor, v2
	if libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbDevCapabilityType) != int32(LIBUSB_BT_SUPERSPEED_PLUS_CAPABILITY) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__120)), __ccgo_ts+9584, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbDevCapabilityType), int32(LIBUSB_BT_SUPERSPEED_PLUS_CAPABILITY)))
		return int32(LIBUSB_ERROR_INVALID_PARAM)
	} else {
		if libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbLength) < int32(12) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__120)), __ccgo_ts+9635, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbLength), int32(12)))
			return int32(LIBUSB_ERROR_IO)
		}
	}
	...
	_ssplus_cap = libc.Xmalloc(tls, uint32(8)+uint32(numSublikSpeedAttributes)*uint32(24))
	if !(_ssplus_cap != 0) {
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	...
	if uint32((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbLength) < uint32(12)+uint32((*libusb_ssplus_usb_device_capability_descriptor)(unsafe.Pointer(_ssplus_cap)).FnumSublinkSpeedAttributes)*uint32(4) {
		libc.Xfree(tls, _ssplus_cap)
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__120)), __ccgo_ts+9671, 0)
		return int32(LIBUSB_ERROR_IO)
	}
	...
	for {
		...
		attr = ReadLittleEndian32(tls, base+uintptr(uint32(i)*libc.Uint32FromInt64(4)))
		...
		if attr&uint32(0x80) != 0 {
			v2 = int32(LIBUSB_SSPLUS_ATTR_DIR_TX)
		} else {
			v2 = int32(LIBUSB_SSPLUS_ATTR_DIR_RX)
		}
		(*(*libusb_ssplus_sublink_attribute)(unsafe.Pointer(_ssplus_cap + 8 + uintptr(i)*24))).Fdirection = v2
		if attr&uint32(0x4000) != 0 {
			v2 = int32(LIBUSB_SSPLUS_ATTR_PROT_SSPLUS)
		} else {
			v2 = int32(LIBUSB_SSPLUS_ATTR_PROT_SS)
		}
		(*(*libusb_ssplus_sublink_attribute)(unsafe.Pointer(_ssplus_cap + 8 + uintptr(i)*24))).Fprotocol = v2
		goto _1
	_1:
		;
		i = i + 1
...
var __func__120 = [51]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 's', 's', 'p', 'l', 'u', 's', '_', 'u', 's', 'b', '_', 'd', 'e', 'v', 'i', 'c', 'e', '_', 'c', 'a', 'p', 'a', 'b', 'i', 'l', 'i', 't', 'y', '_', 'd', 'e', 's', 'c', 'r', 'i', 'p', 't', 'o', 'r'}
...
func libusb_get_container_id_descriptor(tls *libc.TLS, ctx uintptr, dev_cap uintptr, container_id uintptr) (r int32) {
	...
	if libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbDevCapabilityType) != int32(LIBUSB_BT_CONTAINER_ID) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__121)), __ccgo_ts+9584, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbDevCapabilityType), int32(LIBUSB_BT_CONTAINER_ID)))
		return int32(LIBUSB_ERROR_INVALID_PARAM)
	} else {
		if libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbLength) < int32(20) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__121)), __ccgo_ts+9635, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbLength), int32(20)))
			return int32(LIBUSB_ERROR_IO)
		}
	}
	_container_id = libc.Xmalloc(tls, uint32(20))
	if !(_container_id != 0) {
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	...
	libc.Xmemcpy(tls, _container_id+4, dev_cap+3+1, uint32(16))
	*(*uintptr)(unsafe.Pointer(container_id)) = _container_id
	return int32(LIBUSB_SUCCESS)
}

var __func__121 = [35]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 'c', 'o', 'n', 't', 'a', 'i', 'n', 'e', 'r', '_', 'i', 'd', '_', 'd', 'e', 's', 'c', 'r', 'i', 'p', 't', 'o', 'r'}
...
func libusb_get_platform_descriptor(tls *libc.TLS, ctx uintptr, dev_cap uintptr, platform_descriptor uintptr) (r int32) {
	...
	if libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbDevCapabilityType) != int32(LIBUSB_BT_PLATFORM_DESCRIPTOR) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__122)), __ccgo_ts+9584, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbDevCapabilityType), int32(LIBUSB_BT_PLATFORM_DESCRIPTOR)))
		return int32(LIBUSB_ERROR_INVALID_PARAM)
	} else {
		if libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbLength) < int32(20) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__122)), __ccgo_ts+9635, libc.VaList(bp+8, libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbLength), int32(20)))
			return int32(LIBUSB_ERROR_IO)
		}
	}
	_platform_descriptor = libc.Xmalloc(tls, uint32((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbLength))
	...
	libc.Xmemcpy(tls, _platform_descriptor+4, dev_cap+3+1, uint32(16))
	capability_data = dev_cap + 3 + uintptr(1) + uintptr(16)
	capability_data_length = libc.Uint32FromInt32(libc.Int32FromUint8((*libusb_bos_dev_capability_descriptor)(unsafe.Pointer(dev_cap)).FbLength) - (libc.Int32FromInt32(3) + libc.Int32FromInt32(1) + libc.Int32FromInt32(16)))
...
var __func__122 = [31]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 'p', 'l', 'a', 't', 'f', 'o', 'r', 'm', '_', 'd', 'e', 's', 'c', 'r', 'i', 'p', 't', 'o', 'r'}
...
func libusb_get_string_descriptor_ascii(tls *libc.TLS, dev_handle uintptr, desc_index uint8_t, data uintptr, length int32) (r1 int32) {
	...
	_, _, _, _, _, _, _, _, _ = dest_max, idx, idx_max, langid, r, src_max, wdata, v1, v4
	...
	if r < 0 {
		...
		if r != int32(4) || libc.Int32FromUint8((*(*usbi_string_desc_buf)(unsafe.Pointer(bp))).Fdesc.FbLength) < int32(4) || libc.Int32FromUint8((*(*usbi_string_desc_buf)(unsafe.Pointer(bp))).Fdesc.FbDescriptorType) != int32(LIBUSB_DT_STRING) {
			...
			usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__123)), __ccgo_ts+9748, 0)
			return int32(LIBUSB_ERROR_IO)
		} else {
			if libc.Int32FromUint8((*(*usbi_string_desc_buf)(unsafe.Pointer(bp))).Fdesc.FbLength)&int32(1) != 0 {
				...
				usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__123)), __ccgo_ts+9786, libc.VaList(bp+264, libc.Int32FromUint8((*(*usbi_string_desc_buf)(unsafe.Pointer(bp))).Fdesc.FbLength)))
			}
		}
	}
	...
	if r < 0 {
		...
		if r < int32(2) || libc.Int32FromUint8((*(*usbi_string_desc_buf)(unsafe.Pointer(bp))).Fdesc.FbLength) > r || libc.Int32FromUint8((*(*usbi_string_desc_buf)(unsafe.Pointer(bp))).Fdesc.FbDescriptorType) != int32(LIBUSB_DT_STRING) {
			...
			if libc.Int32FromUint8((*(*usbi_string_desc_buf)(unsafe.Pointer(bp))).Fdesc.FbLength)&int32(1) != 0 || libc.Int32FromUint8((*(*usbi_string_desc_buf)(unsafe.Pointer(bp))).Fdesc.FbLength) != r {
				...
				usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__123)), __ccgo_ts+9842, libc.VaList(bp+264, libc.Int32FromUint8((*(*usbi_string_desc_buf)(unsafe.Pointer(bp))).Fdesc.FbLength), r))
			}
		}
	}
...
var __func__123 = [35]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 's', 't', 'r', 'i', 'n', 'g', '_', 'd', 'e', 's', 'c', 'r', 'i', 'p', 't', 'o', 'r', '_', 'a', 's', 'c', 'i', 'i'}
...
func parse_iad_array(tls *libc.TLS, ctx uintptr, iad_array uintptr, buffer uintptr, size int32) (r int32) {
	...
	buf = buffer
	if size < int32(9) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__124)), __ccgo_ts+8888, libc.VaList(bp+8, size, int32(9)))
		return int32(LIBUSB_ERROR_IO)
	}
	...
	for consumed < size {
		...
		if libc.Int32FromUint8(header.FbLength) < int32(2) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__124)), __ccgo_ts+9896, libc.VaList(bp+8, libc.Int32FromUint8(header.FbLength)))
			return int32(LIBUSB_ERROR_IO)
		} else {
			if libc.Int32FromUint8(header.FbLength) > size {
				usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__124)), __ccgo_ts+8951, libc.VaList(bp+8, size, libc.Int32FromUint8(header.FbLength)))
				return int32(LIBUSB_ERROR_IO)
			}
		}
		if libc.Int32FromUint8(header.FbDescriptorType) == int32(LIBUSB_DT_INTERFACE_ASSOCIATION) {
			(*libusb_interface_association_descriptor_array)(unsafe.Pointer(iad_array)).Flength = (*libusb_interface_association_descriptor_array)(unsafe.Pointer(iad_array)).Flength + 1
		}
		buf = buf + uintptr(header.FbLength)
		consumed = consumed + libc.Int32FromUint8(header.FbLength)
	}
	...
	if (*libusb_interface_association_descriptor_array)(unsafe.Pointer(iad_array)).Flength > 0 {
		iad = libc.Xcalloc(tls, libc.Uint32FromInt32((*libusb_interface_association_descriptor_array)(unsafe.Pointer(iad_array)).Flength), uint32(8))
		if !(iad != 0) {
			return int32(LIBUSB_ERROR_NO_MEM)
		}
		...
		for cond := true; cond; cond = int32(1) != 0 {
			...
			remaining = remaining - libc.Int32FromUint8(header.FbLength)
			if remaining < int32(2) {
				break
			}
			buffer = buffer + uintptr(header.FbLength)
		}
	}
	return int32(LIBUSB_SUCCESS)
}

var __func__124 = [16]int8{'p', 'a', 'r', 's', 'e', '_', 'i', 'a', 'd', '_', 'a', 'r', 'r', 'a', 'y'}
...
func raw_desc_to_iad_array(tls *libc.TLS, ctx uintptr, buf uintptr, size int32, iad_array uintptr) (r1 int32) {
	...
	var r int32
	_, _ = _iad_array, r
	_iad_array = libc.Xcalloc(tls, uint32(1), uint32(8))
	if !(_iad_array != 0) {
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	r = parse_iad_array(tls, ctx, _iad_array, buf, size)
	if r < 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__125)), __ccgo_ts+9926, libc.VaList(bp+8, r))
...
var __func__125 = [22]int8{'r', 'a', 'w', '_', 'd', 'e', 's', 'c', '_', 't', 'o', '_', 'i', 'a', 'd', '_', 'a', 'r', 'r', 'a', 'y'}
...
func libusb_get_interface_association_descriptors(tls *libc.TLS, dev uintptr, config_index uint8_t, iad_array uintptr) (r1 int32) {
	...
	usbi_log(tls, (*libusb_device)(unsafe.Pointer(dev)).Fctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__126)), __ccgo_ts+9963, libc.VaList(bp+24, libc.Int32FromUint8(config_index)))
	if libc.Int32FromUint8(config_index) >= libc.Int32FromUint8((*libusb_device)(unsafe.Pointer(dev)).Fdevice_descriptor.FbNumConfigurations) {
		return int32(LIBUSB_ERROR_NOT_FOUND)
	}
	r = get_config_descriptor(tls, dev, config_index, bp, uint32(9))
...
var __func__126 = [45]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 'i', 'n', 't', 'e', 'r', 'f', 'a', 'c', 'e', '_', 'a', 's', 's', 'o', 'c', 'i', 'a', 't', 'i', 'o', 'n', '_', 'd', 'e', 's', 'c', 'r', 'i', 'p', 't', 'o', 'r', 's'}
...
func usbi_utf8_copy(tls *libc.TLS, tgt uintptr, src uintptr, tgt_size int32) (r int32) {
	...
	if libc.UintptrFromInt32(0) == src {
		if libc.UintptrFromInt32(0) != tgt && tgt_size > 0 {
			*(*int8)(unsafe.Pointer(tgt)) = 0
		}
		return int32(1)
	}
	if libc.UintptrFromInt32(0) == tgt || tgt_size <= 0 {
		return libc.Int32FromUint32(libc.Xstrlen(tls, src) + libc.Uint32FromInt32(1))
	}
	k = 0
	k = 0
	for {
...
func libusb_get_device_string(tls *libc.TLS, dev uintptr, string_type libusb_device_string_type, data uintptr, length int32) (r int32) {
	...
	if libc.UintptrFromInt32(0) == data {
		...
		if length > 0 {
			*(*int8)(unsafe.Pointer(data)) = 0
		}
	}
	if libc.UintptrFromInt32(0) == *(*uintptr)(unsafe.Pointer(dev + 56 + uintptr(string_type)*4)) {
		if usbi_backend.Fget_device_string != 0 {
			s = libc.Xmalloc(tls, libc.Uint32FromUint32(384))
			...
			if rv < 0 {
				...
				*(*uintptr)(unsafe.Pointer(dev + 56 + uintptr(string_type)*4)) = s
			}
		} else {
			return int32(LIBUSB_ERROR_NOT_SUPPORTED)
		}
	}
	s = *(*uintptr)(unsafe.Pointer(dev + 56 + uintptr(string_type)*4))
...
func usbi_hotplug_init(tls *libc.TLS, ctx uintptr) {
	...
	usbi_mutex_init(tls, ctx+84)
	list_init(tls, ctx+108)
	(*libusb_context)(unsafe.Pointer(ctx)).Fnext_hotplug_cb_handle = int32(1)
	libc.X__c11_atomic_storeInt32(tls, ctx+120, int32(libc.Int32FromInt32(1)), libc.Int32FromInt32(5))
}
...
func usbi_recursively_remove_parents(tls *libc.TLS, dev uintptr, next_dev uintptr) {
	...
	if dev != 0 && (*libusb_device)(unsafe.Pointer(dev)).Fparent_dev != 0 {
		if int32(libc.X__c11_atomic_loadInt32(tls, (*libusb_device)(unsafe.Pointer(dev)).Fparent_dev, libc.Int32FromInt32(5))) == int32(1) {
			if v1 = (*libusb_device)(unsafe.Pointer(dev)).Fparent_dev != next_dev; !v1 {
				libc.X__assert_fail(tls, __ccgo_ts+9988, __ccgo_ts+10016, int32(175), uintptr(unsafe.Pointer(&__func__127)))
			}
			_ = v1 || libc.Bool(libc.Int32FromInt32(0) != 0)
			if (*libusb_device)(unsafe.Pointer((*libusb_device)(unsafe.Pointer(dev)).Fparent_dev)).Flist.Fnext != 0 && (*libusb_device)(unsafe.Pointer((*libusb_device)(unsafe.Pointer(dev)).Fparent_dev)).Flist.Fprev != 0 {
				list_del(tls, (*libusb_device)(unsafe.Pointer(dev)).Fparent_dev+20)
			}
		}
...
var __func__127 = [32]int8{'u', 's', 'b', 'i', '_', 'r', 'e', 'c', 'u', 'r', 's', 'i', 'v', 'e', 'l', 'y', '_', 'r', 'e', 'm', 'o', 'v', 'e', '_', 'p', 'a', 'r', 'e', 'n', 't', 's'}

func usbi_hotplug_exit(tls *libc.TLS, ctx uintptr) {
	var dev, hotplug_cb, msg, next_cb, next_dev uintptr
	_, _, _, _, _ = dev, hotplug_cb, msg, next_cb, next_dev
	if !(libusb_has_capability(tls, uint32(LIBUSB_CAP_HAS_HOTPLUG)) != 0) {
		return
	}
	if !(libc.X__c11_atomic_loadInt32(tls, ctx+120, libc.Int32FromInt32(5)) != 0) {
		return
	}
	hotplug_cb = uintptr(uint32((*list_head)(unsafe.Pointer(ctx+108)).Fnext) - uint32(libc.UintptrFromInt32(0)+20))
	next_cb = uintptr(uint32((*usbi_hotplug_callback)(unsafe.Pointer(hotplug_cb)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+20))
	for {
		if !(hotplug_cb+20 != ctx+108) {
			break
		}
		list_del(tls, hotplug_cb+20)
		libc.Xfree(tls, hotplug_cb)
		goto _1
	_1:
		;
		hotplug_cb = next_cb
		next_cb = uintptr(uint32((*usbi_hotplug_callback)(unsafe.Pointer(next_cb)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+20))
	}
	for !((*list_head)(unsafe.Pointer(ctx+328)).Fnext == ctx+328) {
		msg = uintptr(uint32((*list_head)(unsafe.Pointer(ctx+328)).Fnext) - uint32(libc.UintptrFromInt32(0)+8))
	...
	usbi_mutex_lock(tls, ctx+20)
	dev = uintptr(uint32((*list_head)(unsafe.Pointer(ctx+44)).Fnext) - uint32(libc.UintptrFromInt32(0)+20))
	next_dev = uintptr(uint32((*libusb_device)(unsafe.Pointer(dev)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+20))
	for {
		if !(dev+20 != ctx+44) {
			break
		}
		if int32(libc.X__c11_atomic_loadInt32(tls, dev, libc.Int32FromInt32(5))) == int32(1) {
			list_del(tls, dev+20)
		}
	...
	_2:
		;
		dev = next_dev
		next_dev = uintptr(uint32((*libusb_device)(unsafe.Pointer(next_dev)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+20))
	}
	usbi_mutex_unlock(tls, ctx+20)
	usbi_mutex_destroy(tls, ctx+84)
}
...
func usbi_hotplug_notification(tls *libc.TLS, ctx uintptr, dev uintptr, event libusb_hotplug_event) {
	...
	msg = libc.Xcalloc(tls, uint32(1), uint32(16))
	if !(msg != 0) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__128)), __ccgo_ts+10060, 0)
		return
	}
	...
	usbi_mutex_lock(tls, ctx+272)
	event_flags = (*libusb_context)(unsafe.Pointer(ctx)).Fevent_flags
	*(*uint32)(unsafe.Pointer(ctx + 296)) |= uint32(USBI_EVENT_HOTPLUG_MSG_PENDING)
	list_add_tail(tls, msg+8, ctx+328)
	if !(event_flags != 0) {
		usbi_signal_event(tls, ctx+12)
	}
	usbi_mutex_unlock(tls, ctx+272)
...
var __func__128 = [26]int8{'u', 's', 'b', 'i', '_', 'h', 'o', 't', 'p', 'l', 'u', 'g', '_', 'n', 'o', 't', 'i', 'f', 'i', 'c', 'a', 't', 'i', 'o', 'n'}
...
func usbi_hotplug_process(tls *libc.TLS, ctx uintptr, hotplug_msgs uintptr) {
	...
	usbi_mutex_lock(tls, ctx+84)
	for !((*list_head)(unsafe.Pointer(hotplug_msgs)).Fnext == hotplug_msgs) {
		msg = uintptr(uint32((*list_head)(unsafe.Pointer(hotplug_msgs)).Fnext) - uint32(libc.UintptrFromInt32(0)+8))
		hotplug_cb = uintptr(uint32((*list_head)(unsafe.Pointer(ctx+108)).Fnext) - uint32(libc.UintptrFromInt32(0)+20))
		next_cb = uintptr(uint32((*usbi_hotplug_callback)(unsafe.Pointer(hotplug_cb)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+20))
		for {
			if !(hotplug_cb+20 != ctx+108) {
	...
	for {
		...
		if libc.Int32FromUint8((*usbi_hotplug_callback)(unsafe.Pointer(hotplug_cb)).Fflags)&int32(USBI_HOTPLUG_NEEDS_FREE) != 0 {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__129)), __ccgo_ts+10093, libc.VaList(bp+8, hotplug_cb, (*usbi_hotplug_callback)(unsafe.Pointer(hotplug_cb)).Fhandle))
			list_del(tls, hotplug_cb+20)
			libc.Xfree(tls, hotplug_cb)
		}
		goto _2
...
var __func__129 = [21]int8{'u', 's', 'b', 'i', '_', 'h', 'o', 't', 'p', 'l', 'u', 'g', '_', 'p', 'r', 'o', 'c', 'e', 's', 's'}
...
func libusb_hotplug_register_callback(tls *libc.TLS, ctx uintptr, events int32, flags int32, vendor_id int32, product_id int32, dev_class int32, __ccgo_fp_cb_fn libusb_hotplug_callback_fn, user_data uintptr, callback_handle uintptr) (r int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	var hotplug_cb, v1 uintptr
	var i, len1 ssize_t
	var v4 libusb_hotplug_callback_handle
	var _ /* devs at bp+0 */ uintptr
	_, _, _, _, _ = hotplug_cb, i, len1, v1, v4
	...
	ctx = usbi_get_context(tls, ctx)
	hotplug_cb = libc.Xcalloc(tls, uint32(1), uint32(28))
	if !(hotplug_cb != 0) {
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	...
	if -int32(1) != vendor_id {
		v1 = hotplug_cb
		*(*uint8_t)(unsafe.Pointer(v1)) = uint8_t(int32(*(*uint8_t)(unsafe.Pointer(v1))) | int32(USBI_HOTPLUG_VENDOR_ID_VALID))
		(*usbi_hotplug_callback)(unsafe.Pointer(hotplug_cb)).Fvendor_id = libc.Uint16FromInt32(vendor_id)
	}
	if -int32(1) != product_id {
		v1 = hotplug_cb
		*(*uint8_t)(unsafe.Pointer(v1)) = uint8_t(int32(*(*uint8_t)(unsafe.Pointer(v1))) | int32(USBI_HOTPLUG_PRODUCT_ID_VALID))
		(*usbi_hotplug_callback)(unsafe.Pointer(hotplug_cb)).Fproduct_id = libc.Uint16FromInt32(product_id)
	}
	if -int32(1) != dev_class {
		v1 = hotplug_cb
		*(*uint8_t)(unsafe.Pointer(v1)) = uint8_t(int32(*(*uint8_t)(unsafe.Pointer(v1))) | int32(USBI_HOTPLUG_DEV_CLASS_VALID))
	...
	usbi_mutex_lock(tls, ctx+84)
	v1 = ctx + 116
	v4 = *(*libusb_hotplug_callback_handle)(unsafe.Pointer(v1))
	*(*libusb_hotplug_callback_handle)(unsafe.Pointer(v1)) = *(*libusb_hotplug_callback_handle)(unsafe.Pointer(v1)) + 1
	(*usbi_hotplug_callback)(unsafe.Pointer(hotplug_cb)).Fhandle = v4
	if (*libusb_context)(unsafe.Pointer(ctx)).Fnext_hotplug_cb_handle < 0 {
		(*libusb_context)(unsafe.Pointer(ctx)).Fnext_hotplug_cb_handle = int32(1)
	}
	list_add(tls, hotplug_cb+20, ctx+108)
	usbi_mutex_unlock(tls, ctx+84)
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__130)), __ccgo_ts+10130, libc.VaList(bp+16, hotplug_cb, (*usbi_hotplug_callback)(unsafe.Pointer(hotplug_cb)).Fhandle))
	if flags&int32(LIBUSB_HOTPLUG_ENUMERATE) != 0 && events&int32(LIBUSB_HOTPLUG_EVENT_DEVICE_ARRIVED) != 0 {
		...
		for {
			...
			usbi_hotplug_match_cb(tls, *(*uintptr)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp)) + uintptr(i)*4)), int32(LIBUSB_HOTPLUG_EVENT_DEVICE_ARRIVED), hotplug_cb)
			goto _6
		_6:
			;
			i = i + 1
...
var __func__130 = [33]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'h', 'o', 't', 'p', 'l', 'u', 'g', '_', 'r', 'e', 'g', 'i', 's', 't', 'e', 'r', '_', 'c', 'a', 'l', 'l', 'b', 'a', 'c', 'k'}
...
func libusb_hotplug_deregister_callback(tls *libc.TLS, ctx uintptr, callback_handle libusb_hotplug_callback_handle) {
	...
	var event_flags uint32
	var hotplug_cb, v2 uintptr
	_, _, _, _ = deregistered, event_flags, hotplug_cb, v2
	deregistered = 0
	if !(libusb_has_capability(tls, uint32(LIBUSB_CAP_HAS_HOTPLUG)) != 0) {
		return
	}
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__131)), __ccgo_ts+10163, libc.VaList(bp+8, callback_handle))
	ctx = usbi_get_context(tls, ctx)
	usbi_mutex_lock(tls, ctx+84)
	hotplug_cb = uintptr(uint32((*list_head)(unsafe.Pointer(ctx+108)).Fnext) - uint32(libc.UintptrFromInt32(0)+20))
	for {
		...
		if callback_handle == (*usbi_hotplug_callback)(unsafe.Pointer(hotplug_cb)).Fhandle {
			v2 = hotplug_cb
			*(*uint8_t)(unsafe.Pointer(v2)) = uint8_t(int32(*(*uint8_t)(unsafe.Pointer(v2))) | int32(USBI_HOTPLUG_NEEDS_FREE))
	...
	_1:
		;
		hotplug_cb = uintptr(uint32((*usbi_hotplug_callback)(unsafe.Pointer(hotplug_cb)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+20))
	}
	usbi_mutex_unlock(tls, ctx+84)
	if deregistered != 0 {
		usbi_mutex_lock(tls, ctx+272)
		event_flags = (*libusb_context)(unsafe.Pointer(ctx)).Fevent_flags
		*(*uint32)(unsafe.Pointer(ctx + 296)) |= uint32(USBI_EVENT_HOTPLUG_CB_DEREGISTERED)
		if !(event_flags != 0) {
			usbi_signal_event(tls, ctx+12)
		}
		usbi_mutex_unlock(tls, ctx+272)
...
var __func__131 = [35]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'h', 'o', 't', 'p', 'l', 'u', 'g', '_', 'd', 'e', 'r', 'e', 'g', 'i', 's', 't', 'e', 'r', '_', 'c', 'a', 'l', 'l', 'b', 'a', 'c', 'k'}
...
func libusb_hotplug_get_user_data(tls *libc.TLS, ctx uintptr, callback_handle libusb_hotplug_callback_handle) (r uintptr) {
	...
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__132)), __ccgo_ts+10188, libc.VaList(bp+8, callback_handle))
	ctx = usbi_get_context(tls, ctx)
	usbi_mutex_lock(tls, ctx+84)
	hotplug_cb = uintptr(uint32((*list_head)(unsafe.Pointer(ctx+108)).Fnext) - uint32(libc.UintptrFromInt32(0)+20))
	for {
...
var __func__132 = [29]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'h', 'o', 't', 'p', 'l', 'u', 'g', '_', 'g', 'e', 't', '_', 'u', 's', 'e', 'r', '_', 'd', 'a', 't', 'a'}

func usbi_io_init(tls *libc.TLS, ctx uintptr) (r1 int32) {
	var r int32
	_ = r
	usbi_mutex_init(tls, ctx+124)
	usbi_mutex_init(tls, ctx+168)
	usbi_mutex_init(tls, ctx+200)
	usbi_cond_init(tls, ctx+224)
	usbi_mutex_init(tls, ctx+272)
	usbi_tls_key_create(tls, ctx+196)
	list_init(tls, ctx+148)
	list_init(tls, ctx+304)
	list_init(tls, ctx+312)
	list_init(tls, ctx+328)
	list_init(tls, ctx+336)
	r = usbi_create_event(tls, ctx+12)
	if r < 0 {
		goto err
	}
	r = usbi_add_event_source(tls, ctx, *(*int32)(unsafe.Pointer(ctx + 12)), int16(0x001))
	if r < 0 {
		goto err_destroy_event
	}
	return 0
...
err_destroy_event:
	;
	usbi_destroy_event(tls, ctx+12)
	goto err
err:
	;
	usbi_mutex_destroy(tls, ctx+124)
	usbi_mutex_destroy(tls, ctx+168)
	usbi_mutex_destroy(tls, ctx+200)
	usbi_cond_destroy(tls, ctx+224)
	usbi_mutex_destroy(tls, ctx+272)
...
func cleanup_removed_event_sources(tls *libc.TLS, ctx uintptr) {
	...
	ievent_source = uintptr(uint32((*list_head)(unsafe.Pointer(ctx+312)).Fnext) - uint32(libc.UintptrFromInt32(0)+8))
	tmp = uintptr(uint32((*usbi_event_source)(unsafe.Pointer(ievent_source)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+8))
	for {
		if !(ievent_source+8 != ctx+312) {
			break
		}
	...
	_1:
		;
		ievent_source = tmp
		tmp = uintptr(uint32((*usbi_event_source)(unsafe.Pointer(tmp)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+8))
	}
}

func usbi_io_exit(tls *libc.TLS, ctx uintptr) {
	usbi_remove_event_source(tls, ctx, *(*int32)(unsafe.Pointer(ctx + 12)))
	usbi_destroy_event(tls, ctx+12)
	usbi_mutex_destroy(tls, ctx+124)
	usbi_mutex_destroy(tls, ctx+168)
	usbi_mutex_destroy(tls, ctx+200)
...
func calculate_timeout(tls *libc.TLS, itransfer uintptr) {
	var timeout uint32
	var transfer, v2 uintptr
	var v1 int32
	_, _, _, _ = timeout, transfer, v1, v2
	transfer = itransfer + uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
	timeout = (*libusb_transfer)(unsafe.Pointer(transfer)).Ftimeout
	if !(timeout != 0) {
		v1 = libc.Int32FromInt32(0)
		(*timespec)(unsafe.Pointer(itransfer + 44)).Ftv_nsec = v1
		(*timespec)(unsafe.Pointer(itransfer + 44)).Ftv_sec = int64(v1)
		return
	}
	usbi_get_monotonic_time(tls, itransfer+44)
	(*usbi_transfer)(unsafe.Pointer(itransfer)).Ftimeout.Ftv_sec += libc.Int64FromUint32(timeout / uint32(1000))
	v2 = itransfer + 44 + 8
	*(*int32)(unsafe.Pointer(v2)) = int32(uint32(*(*int32)(unsafe.Pointer(v2))) + uint32(timeout%libc.Uint32FromUint32(1000))*libc.Uint32FromInt32(1000000))
	if (*usbi_transfer)(unsafe.Pointer(itransfer)).Ftimeout.Ftv_nsec >= int32(1000000000) {
		(*usbi_transfer)(unsafe.Pointer(itransfer)).Ftimeout.Ftv_sec = (*usbi_transfer)(unsafe.Pointer(itransfer)).Ftimeout.Ftv_sec + 1
		(*usbi_transfer)(unsafe.Pointer(itransfer)).Ftimeout.Ftv_nsec -= int32(1000000000)
	}
}
...
func libusb_alloc_transfer(tls *libc.TLS, iso_packets int32) (r uintptr) {
	...
	if v1 = iso_packets >= 0; !v1 {
		libc.X__assert_fail(tls, __ccgo_ts+10216, __ccgo_ts+10233, int32(1292), uintptr(unsafe.Pointer(&__func__133)))
	}
	_ = v1 || libc.Bool(libc.Int32FromInt32(0) != 0)
	if iso_packets < 0 {
		return libc.UintptrFromInt32(0)
	}
	priv_size = uint32((usbi_backend.Ftransfer_priv_size + (libc.Uint32FromInt64(4) - libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4) - libc.Uint32FromInt32(1)))
	usbi_transfer_size = uint32((libc.Uint32FromInt64(84) + (libc.Uint32FromInt64(4) - libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4) - libc.Uint32FromInt32(1)))
	libusb_transfer_size = uint32((libc.Uint32FromInt64(40) + (libc.Uint32FromInt64(4) - libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4) - libc.Uint32FromInt32(1)))
	iso_packets_size = uint32(12) * uint32(libc.Uint32FromInt32(iso_packets))
	alloc_size = priv_size + usbi_transfer_size + libusb_transfer_size + iso_packets_size
	ptr = libc.Xcalloc(tls, uint32(1), alloc_size)
	if !(ptr != 0) {
		return libc.UintptrFromInt32(0)
	}
...
var __func__133 = [22]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'a', 'l', 'l', 'o', 'c', '_', 't', 'r', 'a', 'n', 's', 'f', 'e', 'r'}
...
func libusb_free_transfer(tls *libc.TLS, transfer uintptr) {
	...
	usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__134)), __ccgo_ts+10272, libc.VaList(bp+8, transfer))
	...
	itransfer = transfer - uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
	usbi_mutex_destroy(tls, itransfer)
	if (*usbi_transfer)(unsafe.Pointer(itransfer)).Fdev != 0 {
		libusb_unref_device(tls, (*usbi_transfer)(unsafe.Pointer(itransfer)).Fdev)
	}
	ptr = itransfer - uintptr((usbi_backend.Ftransfer_priv_size+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
	if v2 = ptr == (*usbi_transfer)(unsafe.Pointer(itransfer)).Fpriv; !v2 {
		libc.X__assert_fail(tls, __ccgo_ts+10284, __ccgo_ts+10233, int32(1346), uintptr(unsafe.Pointer(&__func__134)))
	}
	_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
	libc.Xfree(tls, ptr)
}

var __func__134 = [21]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'f', 'r', 'e', 'e', '_', 't', 'r', 'a', 'n', 's', 'f', 'e', 'r'}
...
func add_to_flying_list(tls *libc.TLS, itransfer uintptr) (r1 int32) {
	...
	if (*list_head)(unsafe.Pointer(ctx+148)).Fnext == ctx+148 {
		list_add(tls, itransfer+28, ctx+148)
		goto out
	}
	if !((*timespec)(unsafe.Pointer(timeout)).Ftv_sec != 0 || (*timespec)(unsafe.Pointer(timeout)).Ftv_nsec != 0) {
		list_add_tail(tls, itransfer+28, ctx+148)
		goto out
	}
	cur = uintptr(uint32((*list_head)(unsafe.Pointer(ctx+148)).Fnext) - uint32(libc.UintptrFromInt32(0)+28))
	for {
		if !(cur+28 != ctx+148) {
			break
		}
		...
		if v4 || v3 != 0 {
			list_add_tail(tls, itransfer+28, cur+28)
			goto out
		}
		first = 0
		goto _2
	_2:
		;
		cur = uintptr(uint32((*usbi_transfer)(unsafe.Pointer(cur)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+28))
	}
	list_add_tail(tls, itransfer+28, ctx+148)
	goto out
out:
...
func remove_from_flying_list(tls *libc.TLS, itransfer uintptr) (r1 int32) {
	...
	ctx = v1
	r = 0
	rearm_timer = libc.BoolInt32(((*timespec)(unsafe.Pointer(itransfer+44)).Ftv_sec != 0 || (*timespec)(unsafe.Pointer(itransfer+44)).Ftv_nsec != 0) && uintptr(uint32((*list_head)(unsafe.Pointer(ctx+148)).Fnext)-uint32(libc.UintptrFromInt32(0)+28)) == itransfer)
	list_del(tls, itransfer+28)
	if rearm_timer != 0 {
...
func libusb_submit_transfer(tls *libc.TLS, transfer uintptr) (r1 int32) {
	...
	if v1 = (*libusb_transfer)(unsafe.Pointer(transfer)).Fdev_handle != 0; !v1 {
		libc.X__assert_fail(tls, __ccgo_ts+10307, __ccgo_ts+10233, int32(1497), uintptr(unsafe.Pointer(&__func__135)))
	}
	_ = v1 || libc.Bool(libc.Int32FromInt32(0) != 0)
	if (*usbi_transfer)(unsafe.Pointer(itransfer)).Fdev != 0 {
		libusb_unref_device(tls, (*usbi_transfer)(unsafe.Pointer(itransfer)).Fdev)
	...
	ctx = v2
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__135)), __ccgo_ts+10272, libc.VaList(bp+8, transfer))
	usbi_mutex_lock(tls, ctx+124)
	usbi_mutex_lock(tls, itransfer)
	...
	if r == int32(LIBUSB_SUCCESS) {
		*(*uint32_t)(unsafe.Pointer(itransfer + 68)) |= uint32(USBI_TRANSFER_IN_FLIGHT)
	}
	usbi_mutex_unlock(tls, itransfer)
	if r != int32(LIBUSB_SUCCESS) {
		usbi_mutex_lock(tls, ctx+124)
...
var __func__135 = [23]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 's', 'u', 'b', 'm', 'i', 't', '_', 't', 'r', 'a', 'n', 's', 'f', 'e', 'r'}
...
func libusb_cancel_transfer(tls *libc.TLS, transfer uintptr) (r1 int32) {
	...
	ctx = v1
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__136)), __ccgo_ts+10272, libc.VaList(bp+8, transfer))
	usbi_mutex_lock(tls, itransfer)
	...
	if r < 0 {
		if r != int32(LIBUSB_ERROR_NOT_FOUND) && r != int32(LIBUSB_ERROR_NO_DEVICE) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__136)), __ccgo_ts+10328, libc.VaList(bp+8, r))
		} else {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__136)), __ccgo_ts+10328, libc.VaList(bp+8, r))
		}
		if r == int32(LIBUSB_ERROR_NO_DEVICE) {
			*(*uint32_t)(unsafe.Pointer(itransfer + 68)) |= uint32(USBI_TRANSFER_DEVICE_DISAPPEARED)
		}
	}
	*(*uint32_t)(unsafe.Pointer(itransfer + 68)) |= uint32(USBI_TRANSFER_CANCELLING)
	goto out
out:
	;
	usbi_mutex_unlock(tls, itransfer)
...
var __func__136 = [23]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'c', 'a', 'n', 'c', 'e', 'l', '_', 't', 'r', 'a', 'n', 's', 'f', 'e', 'r'}
...
func usbi_handle_transfer_completion(tls *libc.TLS, itransfer uintptr, status libusb_transfer_status) (r1 int32) {
	...
	usbi_mutex_unlock(tls, ctx+124)
	if r < 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__137)), __ccgo_ts+10360, 0)
	}
	usbi_mutex_lock(tls, itransfer)
	*(*uint32_t)(unsafe.Pointer(itransfer + 68)) &= libc.Uint32FromInt32(^int32(USBI_TRANSFER_IN_FLIGHT))
	usbi_mutex_unlock(tls, itransfer)
	if status == int32(LIBUSB_TRANSFER_COMPLETED) && libc.Int32FromUint8((*libusb_transfer)(unsafe.Pointer(transfer)).Fflags)&int32(LIBUSB_TRANSFER_SHORT_NOT_OK) != 0 {
		...
		if libc.Int32FromUint8((*libusb_transfer)(unsafe.Pointer(transfer)).Ftype1) == int32(LIBUSB_TRANSFER_TYPE_CONTROL) {
			rqlen = libc.Int32FromUint32(uint32(rqlen) - libc.Uint32FromInt64(8))
		}
		if rqlen != (*usbi_transfer)(unsafe.Pointer(itransfer)).Ftransferred {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__137)), __ccgo_ts+10397, 0)
			status = int32(LIBUSB_TRANSFER_ERROR)
		}
	}
	...
	if v2 = (*libusb_transfer)(unsafe.Pointer(transfer)).Factual_length >= 0; !v2 {
		libc.X__assert_fail(tls, __ccgo_ts+10434, __ccgo_ts+10233, int32(1721), uintptr(unsafe.Pointer(&__func__137)))
	}
	_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__137)), __ccgo_ts+10463, libc.VaList(bp+8, transfer, (*libusb_transfer)(unsafe.Pointer(transfer)).Fcallback))
...
var __func__137 = [32]int8{'u', 's', 'b', 'i', '_', 'h', 'a', 'n', 'd', 'l', 'e', '_', 't', 'r', 'a', 'n', 's', 'f', 'e', 'r', '_', 'c', 'o', 'm', 'p', 'l', 'e', 't', 'i', 'o', 'n'}
...
func usbi_handle_transfer_cancellation(tls *libc.TLS, itransfer uintptr) (r int32) {
	...
	usbi_mutex_unlock(tls, ctx+124)
	if timed_out != 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__138)), __ccgo_ts+10491, 0)
...
var __func__138 = [34]int8{'u', 's', 'b', 'i', '_', 'h', 'a', 'n', 'd', 'l', 'e', '_', 't', 'r', 'a', 'n', 's', 'f', 'e', 'r', '_', 'c', 'a', 'n', 'c', 'e', 'l', 'l', 'a', 't', 'i', 'o', 'n'}
...
func usbi_signal_transfer_completion(tls *libc.TLS, itransfer uintptr) {
	...
	if dev != 0 {
		...
		usbi_mutex_lock(tls, ctx+272)
		event_flags = (*libusb_context)(unsafe.Pointer(ctx)).Fevent_flags
		*(*uint32)(unsafe.Pointer(ctx + 296)) |= uint32(USBI_EVENT_TRANSFER_COMPLETED)
		list_add_tail(tls, itransfer+36, ctx+336)
		if !(event_flags != 0) {
			usbi_signal_event(tls, ctx+12)
		}
		usbi_mutex_unlock(tls, ctx+272)
...
func libusb_try_lock_events(tls *libc.TLS, ctx uintptr) (r1 int32) {
	...
	usbi_mutex_unlock(tls, ctx+272)
	if ru != 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__139)), __ccgo_ts+10521, 0)
		return int32(1)
	}
	r = usbi_mutex_trylock(tls, ctx+168)
	if !(r != 0) {
		return int32(1)
	}
...
var __func__139 = [23]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 't', 'r', 'y', '_', 'l', 'o', 'c', 'k', '_', 'e', 'v', 'e', 'n', 't', 's'}

func libusb_lock_events(tls *libc.TLS, ctx uintptr) {
	ctx = usbi_get_context(tls, ctx)
	usbi_mutex_lock(tls, ctx+168)
	(*libusb_context)(unsafe.Pointer(ctx)).Fevent_handler_active = int32(1)
}
...
func libusb_unlock_events(tls *libc.TLS, ctx uintptr) {
	...
	usbi_mutex_unlock(tls, ctx+168)
	usbi_mutex_lock(tls, ctx+200)
	usbi_cond_broadcast(tls, ctx+224)
	usbi_mutex_unlock(tls, ctx+200)
}
...
func libusb_event_handling_ok(tls *libc.TLS, ctx uintptr) (r1 int32) {
	...
	usbi_mutex_unlock(tls, ctx+272)
	if r != 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__140)), __ccgo_ts+10521, 0)
		return 0
	}
	return int32(1)
}

var __func__140 = [25]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'e', 'v', 'e', 'n', 't', '_', 'h', 'a', 'n', 'd', 'l', 'i', 'n', 'g', '_', 'o', 'k'}
...
func libusb_event_handler_active(tls *libc.TLS, ctx uintptr) (r1 int32) {
	...
	usbi_mutex_unlock(tls, ctx+272)
	if r != 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__141)), __ccgo_ts+10521, 0)
		return int32(1)
	}
	return (*libusb_context)(unsafe.Pointer(ctx)).Fevent_handler_active
}

var __func__141 = [28]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'e', 'v', 'e', 'n', 't', '_', 'h', 'a', 'n', 'd', 'l', 'e', 'r', '_', 'a', 'c', 't', 'i', 'v', 'e'}
...
func libusb_interrupt_event_handler(tls *libc.TLS, ctx uintptr) {
	...
	usbi_mutex_lock(tls, ctx+272)
	event_flags = (*libusb_context)(unsafe.Pointer(ctx)).Fevent_flags
	*(*uint32)(unsafe.Pointer(ctx + 296)) |= uint32(USBI_EVENT_USER_INTERRUPT)
	if !(event_flags != 0) {
		usbi_signal_event(tls, ctx+12)
	}
	usbi_mutex_unlock(tls, ctx+272)
...
var __func__142 = [31]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'i', 'n', 't', 'e', 'r', 'r', 'u', 'p', 't', '_', 'e', 'v', 'e', 'n', 't', '_', 'h', 'a', 'n', 'd', 'l', 'e', 'r'}
...
func libusb_wait_for_event(tls *libc.TLS, ctx uintptr, tv uintptr) (r1 int32) {
	...
	ctx = usbi_get_context(tls, ctx)
	if !(tv != 0) {
		usbi_cond_wait(tls, ctx+224, ctx+200)
		return 0
	}
	...
	r = usbi_cond_timedwait(tls, ctx+224, ctx+200, tv)
	if r < 0 {
...
func handle_timeout(tls *libc.TLS, itransfer uintptr) {
	...
	_, _, _ = r, transfer, v1
	transfer = itransfer + uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
	*(*uint32_t)(unsafe.Pointer(itransfer + 72)) |= uint32(USBI_TRANSFER_TIMEOUT_HANDLED)
	r = libusb_cancel_transfer(tls, transfer)
	if r == int32(LIBUSB_SUCCESS) {
		*(*uint32_t)(unsafe.Pointer(itransfer + 72)) |= uint32(USBI_TRANSFER_TIMED_OUT)
	} else {
		if (*usbi_transfer)(unsafe.Pointer(transfer-uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev != 0 {
			v1 = (*libusb_device)(unsafe.Pointer((*usbi_transfer)(unsafe.Pointer(transfer - uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev)).Fctx
		} else {
		...
		usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__143)), __ccgo_ts+10554, libc.VaList(bp+8, r))
	}
}

var __func__143 = [15]int8{'h', 'a', 'n', 'd', 'l', 'e', '_', 't', 'i', 'm', 'e', 'o', 'u', 't'}
...
func handle_timeouts_locked(tls *libc.TLS, ctx uintptr) {
	...
	_1:
		;
		itransfer = uintptr(uint32((*usbi_transfer)(unsafe.Pointer(itransfer)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+28))
	}
}
...
func handle_event_trigger(tls *libc.TLS, ctx uintptr) (r1 int32) {
	...
	var v1 bool
	var _ /* completed_transfers at bp+8 */ list_head
	var _ /* hotplug_msgs at bp+0 */ list_head
	_, _, _, _, _ = hotplug_event, itransfer, r, tmp, v1
	hotplug_event = 0
	r = 0
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__144)), __ccgo_ts+10577, 0)
	list_init(tls, bp)
	usbi_mutex_lock(tls, ctx+272)
	if (*libusb_context)(unsafe.Pointer(ctx)).Fevent_flags&uint32(USBI_EVENT_EVENT_SOURCES_MODIFIED) != 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__144)), __ccgo_ts+10593, 0)
	}
	if (*libusb_context)(unsafe.Pointer(ctx)).Fevent_flags&uint32(USBI_EVENT_USER_INTERRUPT) != 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__144)), __ccgo_ts+10627, 0)
		*(*uint32)(unsafe.Pointer(ctx + 296)) &= libc.Uint32FromInt32(^int32(USBI_EVENT_USER_INTERRUPT))
	}
	if (*libusb_context)(unsafe.Pointer(ctx)).Fevent_flags&uint32(USBI_EVENT_HOTPLUG_CB_DEREGISTERED) != 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__144)), __ccgo_ts+10660, 0)
		*(*uint32)(unsafe.Pointer(ctx + 296)) &= libc.Uint32FromInt32(^int32(USBI_EVENT_HOTPLUG_CB_DEREGISTERED))
		hotplug_event = int32(1)
	}
	if (*libusb_context)(unsafe.Pointer(ctx)).Fevent_flags&uint32(USBI_EVENT_DEVICE_CLOSE) != 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__144)), __ccgo_ts+10694, 0)
	}
	if (*libusb_context)(unsafe.Pointer(ctx)).Fevent_flags&uint32(USBI_EVENT_HOTPLUG_MSG_PENDING) != 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__144)), __ccgo_ts+10722, 0)
		*(*uint32)(unsafe.Pointer(ctx + 296)) &= libc.Uint32FromInt32(^int32(USBI_EVENT_HOTPLUG_MSG_PENDING))
		hotplug_event = int32(1)
		if v1 = !((*list_head)(unsafe.Pointer(ctx+328)).Fnext == ctx+328); !v1 {
			libc.X__assert_fail(tls, __ccgo_ts+10747, __ccgo_ts+10233, int32(2147), uintptr(unsafe.Pointer(&__func__144)))
		}
		_ = v1 || libc.Bool(libc.Int32FromInt32(0) != 0)
		list_cut(tls, bp, ctx+328)
	}
	if (*libusb_context)(unsafe.Pointer(ctx)).Fevent_flags&uint32(USBI_EVENT_TRANSFER_COMPLETED) != 0 {
		if v1 = !((*list_head)(unsafe.Pointer(ctx+336)).Fnext == ctx+336); !v1 {
			libc.X__assert_fail(tls, __ccgo_ts+10779, __ccgo_ts+10233, int32(2156), uintptr(unsafe.Pointer(&__func__144)))
		}
		_ = v1 || libc.Bool(libc.Int32FromInt32(0) != 0)
		list_cut(tls, bp+8, ctx+336)
		usbi_mutex_unlock(tls, ctx+272)
		itransfer = uintptr(uint32((*list_head)(unsafe.Pointer(bp+8)).Fnext) - uint32(libc.UintptrFromInt32(0)+36))
		tmp = uintptr(uint32((*usbi_transfer)(unsafe.Pointer(itransfer)).Fcompleted_list.Fnext) - uint32(libc.UintptrFromInt32(0)+36))
		for {
			if !(itransfer+36 != bp+8) {
				break
			}
			list_del(tls, itransfer+36)
			r = (*(*func(*libc.TLS, uintptr) int32)(unsafe.Pointer(&struct{ uintptr }{usbi_backend.Fhandle_transfer_completion})))(tls, itransfer)
			if r != 0 {
				usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__144)), __ccgo_ts+10818, libc.VaList(bp+24, r))
				break
			}
			goto _3
		_3:
			;
			itransfer = tmp
			tmp = uintptr(uint32((*usbi_transfer)(unsafe.Pointer(tmp)).Fcompleted_list.Fnext) - uint32(libc.UintptrFromInt32(0)+36))
		}
		usbi_mutex_lock(tls, ctx+272)
		if !((*list_head)(unsafe.Pointer(bp+8)).Fnext == bp+8) {
			list_splice_front(tls, bp+8, ctx+336)
		} else {
			if (*list_head)(unsafe.Pointer(ctx+336)).Fnext == ctx+336 {
				*(*uint32)(unsafe.Pointer(ctx + 296)) &= libc.Uint32FromInt32(^int32(USBI_EVENT_TRANSFER_COMPLETED))
			}
		}
	}
	if !((*libusb_context)(unsafe.Pointer(ctx)).Fevent_flags != 0) {
...
var __func__144 = [21]int8{'h', 'a', 'n', 'd', 'l', 'e', '_', 'e', 'v', 'e', 'n', 't', '_', 't', 'r', 'i', 'g', 'g', 'e', 'r'}
...
func handle_events(tls *libc.TLS, ctx uintptr, tv uintptr) (r1 int32) {
	...
	usbi_mutex_lock(tls, ctx+272)
	if (*libusb_context)(unsafe.Pointer(ctx)).Fevent_flags&uint32(USBI_EVENT_EVENT_SOURCES_MODIFIED) != 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__145)), __ccgo_ts+10874, 0)
		cleanup_removed_event_sources(tls, ctx)
		...
		*(*uint32)(unsafe.Pointer(ctx + 296)) &= libc.Uint32FromInt32(^int32(USBI_EVENT_EVENT_SOURCES_MODIFIED))
		if !((*libusb_context)(unsafe.Pointer(ctx)).Fevent_flags != 0) {
			usbi_clear_event(tls, ctx+12)
		}
	}
	...
	*(*uint32)(unsafe.Pointer(&*(*usbi_reported_events)(unsafe.Pointer(bp)))) = uint32(0)
	...
	if r != 0 {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__145)), __ccgo_ts+10922, libc.VaList(bp+24, r))
	}
	goto done
done:
	;
...
var __func__145 = [14]int8{'h', 'a', 'n', 'd', 'l', 'e', '_', 'e', 'v', 'e', 'n', 't', 's'}
...
retry:
	...
	if libusb_try_lock_events(tls, ctx) == 0 {
		if completed == libc.UintptrFromInt32(0) || !(*(*int32)(unsafe.Pointer(completed)) != 0) {
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__146)), __ccgo_ts+10965, 0)
	...
	if !(libusb_event_handler_active(tls, ctx) != 0) {
		libusb_unlock_event_waiters(tls, ctx)
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__146)), __ccgo_ts+10994, 0)
		goto retry
	}
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__146)), __ccgo_ts+11043, 0)
...
var __func__146 = [39]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'h', 'a', 'n', 'd', 'l', 'e', '_', 'e', 'v', 'e', 'n', 't', 's', '_', 't', 'i', 'm', 'e', 'o', 'u', 't', '_', 'c', 'o', 'm', 'p', 'l', 'e', 't', 'e', 'd'}
...
func libusb_get_next_timeout(tls *libc.TLS, ctx uintptr, tv uintptr) (r int32) {
	...
	*(*timespec)(unsafe.Pointer(bp + 16)) = timespec{}
	...
	if (*list_head)(unsafe.Pointer(ctx+148)).Fnext == ctx+148 {
		usbi_mutex_unlock(tls, ctx+124)
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__147)), __ccgo_ts+11082, 0)
		return 0
	}
	itransfer = uintptr(uint32((*list_head)(unsafe.Pointer(ctx+148)).Fnext) - uint32(libc.UintptrFromInt32(0)+28))
	for {
		...
		if !((*timespec)(unsafe.Pointer(itransfer+44)).Ftv_sec != 0 || (*timespec)(unsafe.Pointer(itransfer+44)).Ftv_nsec != 0) {
			break
		}
	...
	if !((*timespec)(unsafe.Pointer(bp+16)).Ftv_sec != 0 || (*timespec)(unsafe.Pointer(bp+16)).Ftv_nsec != 0) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__147)), __ccgo_ts+11103, 0)
		return 0
	}
	usbi_get_monotonic_time(tls, bp)
	...
	if !(v2 != 0) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__147)), __ccgo_ts+11157, 0)
		...
		if (*timespec)(unsafe.Pointer(bp+16)).Ftv_nsec < 0 {
			(*timespec)(unsafe.Pointer(bp + 16)).Ftv_sec = (*timespec)(unsafe.Pointer(bp+16)).Ftv_sec - 1
			*(*int32)(unsafe.Pointer(bp + 16 + 8)) += int32(1000000000)
		}
		(*timeval)(unsafe.Pointer(tv)).Ftv_sec = (*timespec)(unsafe.Pointer(bp + 16)).Ftv_sec
		(*timeval)(unsafe.Pointer(tv)).Ftv_usec = int64((*timespec)(unsafe.Pointer(bp+16)).Ftv_nsec / int32(1000))
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__147)), __ccgo_ts+11187, libc.VaList(bp+40, int32((*timeval)(unsafe.Pointer(tv)).Ftv_sec), int32((*timeval)(unsafe.Pointer(tv)).Ftv_usec)))
	}
	return int32(1)
}

var __func__147 = [24]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'g', 'e', 't', '_', 'n', 'e', 'x', 't', '_', 't', 'i', 'm', 'e', 'o', 'u', 't'}
...
func usbi_event_source_notification(tls *libc.TLS, ctx uintptr) {
	...
	_ = event_flags
	event_flags = (*libusb_context)(unsafe.Pointer(ctx)).Fevent_flags
	*(*uint32)(unsafe.Pointer(ctx + 296)) |= uint32(USBI_EVENT_EVENT_SOURCES_MODIFIED)
	if !(event_flags != 0) {
		usbi_signal_event(tls, ctx+12)
	}
}
...
func usbi_add_event_source(tls *libc.TLS, ctx uintptr, os_handle usbi_os_handle_t, poll_events int16) (r int32) {
	...
	_ = ievent_source
	ievent_source = libc.Xmalloc(tls, uint32(16))
	if !(ievent_source != 0) {
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__148)), __ccgo_ts+11214, libc.VaList(bp+8, os_handle, int32(poll_events)))
	...
	usbi_mutex_lock(tls, ctx+272)
	list_add_tail(tls, ievent_source+8, ctx+304)
...
var __func__148 = [22]int8{'u', 's', 'b', 'i', '_', 'a', 'd', 'd', '_', 'e', 'v', 'e', 'n', 't', '_', 's', 'o', 'u', 'r', 'c', 'e'}
...
func usbi_remove_event_source(tls *libc.TLS, ctx uintptr, os_handle usbi_os_handle_t) {
	...
	found = 0
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__149)), __ccgo_ts+11234, libc.VaList(bp+8, os_handle))
	usbi_mutex_lock(tls, ctx+272)
	ievent_source = uintptr(uint32((*list_head)(unsafe.Pointer(ctx+304)).Fnext) - uint32(libc.UintptrFromInt32(0)+8))
	for {
		if !(ievent_source+8 != ctx+304) {
	...
	if !(found != 0) {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__149)), __ccgo_ts+11247, libc.VaList(bp+8, os_handle))
		usbi_mutex_unlock(tls, ctx+272)
		return
	}
	list_del(tls, ievent_source+8)
	list_add_tail(tls, ievent_source+8, ctx+312)
	usbi_event_source_notification(tls, ctx)
	usbi_mutex_unlock(tls, ctx+272)
...
var __func__149 = [25]int8{'u', 's', 'b', 'i', '_', 'r', 'e', 'm', 'o', 'v', 'e', '_', 'e', 'v', 'e', 'n', 't', '_', 's', 'o', 'u', 'r', 'c', 'e'}
...
func libusb_get_pollfds(tls *libc.TLS, ctx uintptr) (r uintptr) {
	...
	ret = libc.Xcalloc(tls, i+uint32(1), uint32(4))
	if !(ret != 0) {
		goto out
	}
	i = uint32(0)
	...
	for {
		...
		v3 = i
		i = i + 1
		*(*uintptr)(unsafe.Pointer(ret + uintptr(v3)*4)) = ievent_source
		goto _2
	_2:
		;
		ievent_source = uintptr(uint32((*usbi_event_source)(unsafe.Pointer(ievent_source)).Flist.Fnext) - uint32(libc.UintptrFromInt32(0)+8))
...
func usbi_handle_disconnect(tls *libc.TLS, ctx uintptr, dev_handle uintptr) {
	...
	for int32(1) != 0 {
		...
		for {
			...
			cur_transfer = cur + uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
		...
		transfer_to_cancel = to_cancel + uintptr((libc.Uint32FromInt64(84)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__150)), __ccgo_ts+11290, libc.VaList(bp+8, transfer_to_cancel))
...
var __func__150 = [23]int8{'u', 's', 'b', 'i', '_', 'h', 'a', 'n', 'd', 'l', 'e', '_', 'd', 'i', 's', 'c', 'o', 'n', 'n', 'e', 'c', 't'}
...
func libusb_setlocale(tls *libc.TLS, locale uintptr) (r int32) {
	var i size_t
	_ = i
	if !(locale != 0) || libc.Xstrlen(tls, locale) < uint32(2) || int32(*(*int8)(unsafe.Pointer(locale + 2))) != int32('\000') && int32(*(*int8)(unsafe.Pointer(locale + 2))) != int32('-') && int32(*(*int8)(unsafe.Pointer(locale + 2))) != int32('_') && int32(*(*int8)(unsafe.Pointer(locale + 2))) != int32('.') {
		return int32(LIBUSB_ERROR_INVALID_PARAM)
	}
	i = uint32(0)
	for {
		...
		if int32(*(*int8)(unsafe.Pointer(usbi_locale_supported[i]))) == libc.Xtolower(tls, libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(locale))))) && int32(*(*int8)(unsafe.Pointer(usbi_locale_supported[i] + 1))) == libc.Xtolower(tls, libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(locale + 1))))) {
			break
		}
		goto _1
	_1:
	...
	usbi_error_strings = uintptr(unsafe.Pointer(&usbi_localized_errors)) + uintptr(i)*56
	return int32(LIBUSB_SUCCESS)
}
...
func libusb_strerror(tls *libc.TLS, errcode int32) (r uintptr) {
	...
	return *(*uintptr)(unsafe.Pointer(usbi_error_strings + uintptr(errcode_index)*4))
}
...
func sync_transfer_cb(tls *libc.TLS, transfer uintptr) {
	...
	usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__151)), __ccgo_ts+13959, libc.VaList(bp+8, (*libusb_transfer)(unsafe.Pointer(transfer)).Factual_length))
	completed = (*libusb_transfer)(unsafe.Pointer(transfer)).Fuser_data
	*(*int32)(unsafe.Pointer(completed)) = int32(1)
}

var __func__151 = [17]int8{'s', 'y', 'n', 'c', '_', 't', 'r', 'a', 'n', 's', 'f', 'e', 'r', '_', 'c', 'b'}
...
func sync_transfer_wait_for_completion(tls *libc.TLS, transfer uintptr) {
	...
	for !(*(*int32)(unsafe.Pointer(completed)) != 0) {
		...
		if r < 0 {
			...
			usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__152)), __ccgo_ts+13976, libc.VaList(bp+8, libusb_error_name(tls, r)))
...
var __func__152 = [34]int8{'s', 'y', 'n', 'c', '_', 't', 'r', 'a', 'n', 's', 'f', 'e', 'r', '_', 'w', 'a', 'i', 't', '_', 'f', 'o', 'r', '_', 'c', 'o', 'm', 'p', 'l', 'e', 't', 'i', 'o', 'n'}
...
func libusb_control_transfer(tls *libc.TLS, dev_handle uintptr, bmRequestType uint8_t, bRequest uint8_t, wValue uint16_t, wIndex uint16_t, data uintptr, wLength uint16_t, timeout uint32) (r1 int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	var buffer, transfer, v1 uintptr
	var r int32
	var _ /* completed at bp+0 */ int32
	_, _, _, _ = buffer, r, transfer, v1
	*(*int32)(unsafe.Pointer(bp)) = 0
	if dev_handle != 0 {
		v1 = (*libusb_device)(unsafe.Pointer((*libusb_device_handle)(unsafe.Pointer(dev_handle)).Fdev)).Fctx
	} else {
	...
	buffer = libc.Xmalloc(tls, uint32(libc.Uint32FromInt64(8)+uint32(wLength)))
	if !(buffer != 0) {
		libusb_free_transfer(tls, transfer)
		return int32(LIBUSB_ERROR_NO_MEM)
	}
	...
	if libc.Int32FromUint8(bmRequestType)&int32(0x80) == int32(LIBUSB_ENDPOINT_OUT) {
		libc.Xmemcpy(tls, buffer+uintptr(libc.Uint32FromInt64(8)), data, uint32(wLength))
	}
	...
	if libc.Int32FromUint8(bmRequestType)&int32(0x80) == int32(LIBUSB_ENDPOINT_IN) {
		libc.Xmemcpy(tls, data, libusb_control_transfer_get_data(tls, transfer), libc.Uint32FromInt32((*libusb_transfer)(unsafe.Pointer(transfer)).Factual_length))
	}
	...
	default:
		...
		usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__153)), __ccgo_ts+14042, libc.VaList(bp+16, (*libusb_transfer)(unsafe.Pointer(transfer)).Fstatus))
...
var __func__153 = [24]int8{'l', 'i', 'b', 'u', 's', 'b', '_', 'c', 'o', 'n', 't', 'r', 'o', 'l', '_', 't', 'r', 'a', 'n', 's', 'f', 'e', 'r'}
...
func do_sync_bulk_transfer(tls *libc.TLS, dev_handle uintptr, endpoint uint8, buffer uintptr, length int32, transferred uintptr, timeout uint32, type1 uint8) (r1 int32) {
	...
	*(*int32)(unsafe.Pointer(bp)) = 0
	...
	if transferred != 0 {
		if v2 = (*libusb_transfer)(unsafe.Pointer(transfer)).Factual_length >= 0; !v2 {
			libc.X__assert_fail(tls, __ccgo_ts+10434, __ccgo_ts+14070, int32(203), uintptr(unsafe.Pointer(&__func__154)))
		}
		_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
	...
	default:
		...
		usbi_log(tls, v1, int32(LIBUSB_LOG_LEVEL_WARNING), uintptr(unsafe.Pointer(&__func__154)), __ccgo_ts+14042, libc.VaList(bp+16, (*libusb_transfer)(unsafe.Pointer(transfer)).Fstatus))
		r = int32(LIBUSB_ERROR_OTHER)
	}
	libusb_free_transfer(tls, transfer)
	return r
...
var __func__154 = [22]int8{'d', 'o', '_', 's', 'y', 'n', 'c', '_', 'b', 'u', 'l', 'k', '_', 't', 'r', 'a', 'n', 's', 'f', 'e', 'r'}
...
func hidapi_thread_state_init(tls *libc.TLS, state uintptr) {
	libc.Xpthread_mutex_init(tls, state+4, libc.UintptrFromInt32(0))
	libc.Xpthread_cond_init(tls, state+28, libc.UintptrFromInt32(0))
	libc.Xpthread_barrier_init(tls, state+76, libc.UintptrFromInt32(0), uint32(2))
}

func hidapi_thread_state_destroy(tls *libc.TLS, state uintptr) {
	libc.Xpthread_barrier_destroy(tls, state+76)
	libc.Xpthread_cond_destroy(tls, state+28)
	libc.Xpthread_mutex_destroy(tls, state+4)
}

func hidapi_thread_mutex_lock(tls *libc.TLS, state uintptr) {
	libc.Xpthread_mutex_lock(tls, state+4)
}

func hidapi_thread_mutex_unlock(tls *libc.TLS, state uintptr) {
	libc.Xpthread_mutex_unlock(tls, state+4)
}

func hidapi_thread_cond_wait(tls *libc.TLS, state uintptr) {
	libc.Xpthread_cond_wait(tls, state+28, state+4)
}

func hidapi_thread_cond_timedwait(tls *libc.TLS, state uintptr, ts uintptr) (r int32) {
	return libc.Xpthread_cond_timedwait(tls, state+28, state+4, ts)
}

func hidapi_thread_cond_signal(tls *libc.TLS, state uintptr) {
	libc.Xpthread_cond_signal(tls, state+28)
}

func hidapi_thread_cond_broadcast(tls *libc.TLS, state uintptr) {
	libc.Xpthread_cond_broadcast(tls, state+28)
}

func hidapi_thread_barrier_wait(tls *libc.TLS, state uintptr) {
	libc.Xpthread_barrier_wait(tls, state+76)
}
...
func hidapi_thread_addtime(tls *libc.TLS, ts uintptr, milliseconds int32) {
	...
	*(*int32)(unsafe.Pointer(ts + 8)) += milliseconds % int32(1000) * int32(1000000)
	if (*hidapi_timespec)(unsafe.Pointer(ts)).Ftv_nsec >= int32(1000000000) {
		(*hidapi_timespec)(unsafe.Pointer(ts)).Ftv_sec = (*hidapi_timespec)(unsafe.Pointer(ts)).Ftv_sec + 1
		*(*int32)(unsafe.Pointer(ts + 8)) -= int32(1000000000)
	}
}
...
func new_hid_device(tls *libc.TLS) (r uintptr) {
	var dev uintptr
	_ = dev
	dev = libc.Xcalloc(tls, uint32(1), uint32(164))
	if !(dev != 0) {
		return libc.UintptrFromInt32(0)
	}
	(*hid_device)(unsafe.Pointer(dev)).Fblocking = int32(1)
	hidapi_thread_state_init(tls, dev+48)
	return dev
}

func free_hid_device(tls *libc.TLS, dev uintptr) {
	hidapi_thread_state_destroy(tls, dev+48)
...
func get_bytes(tls *libc.TLS, rpt uintptr, len1 size_t, num_bytes size_t, cur size_t) (r uint32_t) {
	...
	if num_bytes == uint32(0) {
		return uint32(0)
	} else {
		if num_bytes == uint32(1) {
			return uint32(*(*uint8_t)(unsafe.Pointer(rpt + uintptr(cur+uint32(1)))))
		} else {
			if num_bytes == uint32(2) {
				return libc.Uint32FromInt32(libc.Int32FromUint8(*(*uint8_t)(unsafe.Pointer(rpt + uintptr(cur+uint32(2)))))*libc.Int32FromInt32(256) + libc.Int32FromUint8(*(*uint8_t)(unsafe.Pointer(rpt + uintptr(cur+uint32(1))))))
			} else {
				if num_bytes == uint32(4) {
					return libc.Uint32FromInt32(libc.Int32FromUint8(*(*uint8_t)(unsafe.Pointer(rpt + uintptr(cur+uint32(4)))))*libc.Int32FromInt32(0x01000000) + libc.Int32FromUint8(*(*uint8_t)(unsafe.Pointer(rpt + uintptr(cur+uint32(3)))))*libc.Int32FromInt32(0x00010000) + libc.Int32FromUint8(*(*uint8_t)(unsafe.Pointer(rpt + uintptr(cur+uint32(2)))))*libc.Int32FromInt32(0x00000100) + libc.Int32FromUint8(*(*uint8_t)(unsafe.Pointer(rpt + uintptr(cur+uint32(1)))))*libc.Int32FromInt32(0x00000001))
				} else {
					return uint32(0)
				}
			}
...
func get_usage(tls *libc.TLS, report_descriptor uintptr, size size_t, usage_page uintptr, usage uintptr) (r int32) {
	...
	for i < size {
		...
		if key_cmd == int32(0x4) {
			*(*uint16)(unsafe.Pointer(usage_page)) = uint16(get_bytes(tls, report_descriptor, size, libc.Uint32FromInt32(data_len), i))
			usage_page_found = int32(1)
		}
		if key_cmd == int32(0x8) {
			if data_len == int32(4) {
				*(*uint16)(unsafe.Pointer(usage_page)) = uint16(get_bytes(tls, report_descriptor, size, uint32(2), i+uint32(2)))
				usage_page_found = int32(1)
				*(*uint16)(unsafe.Pointer(usage)) = uint16(get_bytes(tls, report_descriptor, size, uint32(2), i))
				usage_found = int32(1)
			} else {
				*(*uint16)(unsafe.Pointer(usage)) = uint16(get_bytes(tls, report_descriptor, size, libc.Uint32FromInt32(data_len), i))
				usage_found = int32(1)
			}
		}
		...
		i = i + libc.Uint32FromInt32(data_len+key_size)
	}
	return -int32(1)
}
...
func get_usb_string(tls *libc.TLS, dev uintptr, idx uint8_t) (r uintptr) {
	...
	var _ /* inptr at bp+1544 */ uintptr
	var _ /* outbytes at bp+1540 */ size_t
	var _ /* outptr at bp+1548 */ uintptr
	...
	ic = libc.Xiconv_open(tls, __ccgo_ts+14111, __ccgo_ts+14119)
	if ic == uintptr(-libc.Int32FromInt32(1)) {
		return libc.UintptrFromInt32(0)
	}
	*(*uintptr)(unsafe.Pointer(bp + 1544)) = bp + uintptr(2)
	*(*size_t)(unsafe.Pointer(bp + 1536)) = libc.Uint32FromInt32(len1 - int32(2))
	*(*uintptr)(unsafe.Pointer(bp + 1548)) = bp + 512
	*(*size_t)(unsafe.Pointer(bp + 1540)) = uint32(1024)
	res = libc.Xiconv(tls, ic, bp+1544, bp+1536, bp+1548, bp+1540)
	if res == libc.Uint32FromInt32(-libc.Int32FromInt32(1)) {
		goto err
	}
	(*(*[256]wchar_t)(unsafe.Pointer(bp + 512)))[libc.Uint32FromInt64(1024)/libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)] = 0x00000000
	if *(*size_t)(unsafe.Pointer(bp + 1540)) >= uint32(4) {
		*(*wchar_t)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 1548)))) = 0x00000000
	}
...
func get_path(tls *libc.TLS, result uintptr, dev uintptr, config_number int32, interface_number int32) {
	...
	*(*[8]uint8_t)(unsafe.Pointer(bp)) = [8]uint8_t{}
	...
	if num_ports > 0 {
		n = libc.X__builtin_snprintf(tls, str, uint32(8), __ccgo_ts+14128, libc.VaList(bp+16, libc.Int32FromUint8(libusb_get_bus_number(tls, dev)), libc.Int32FromUint8((*(*[8]uint8_t)(unsafe.Pointer(bp)))[0])))
		i = uint8(1)
		for {
			if !(libc.Int32FromUint8(i) < num_ports) {
				break
			}
			n = n + libc.X__builtin_snprintf(tls, str+uintptr(n), uint32(5), __ccgo_ts+14134, libc.VaList(bp+16, libc.Int32FromUint8((*(*[8]uint8_t)(unsafe.Pointer(bp)))[i])))
			goto _1
		_1:
			;
			i = i + 1
		}
		n = n + libc.X__builtin_snprintf(tls, str+uintptr(n), uint32(9), __ccgo_ts+14138, libc.VaList(bp+16, libc.Int32FromUint8(libc.Uint8FromInt32(config_number)), libc.Int32FromUint8(libc.Uint8FromInt32(interface_number))))
		*(*int8)(unsafe.Pointer(str + uintptr(n))) = int8('\000')
	} else {
		if num_ports == int32(LIBUSB_ERROR_OVERFLOW) {
		} else {
		}
		*(*int8)(unsafe.Pointer(str)) = int8('\000')
	}
}
...
func hid_init(tls *libc.TLS) (r int32) {
	...
	if !(usb_context != 0) {
		...
		if !(locale != 0) {
			libc.Xsetlocale(tls, 0, __ccgo_ts+14152)
		}
	}
	return 0
}
...
func hid_get_report_descriptor_libusb(tls *libc.TLS, handle uintptr, interface_num int32, expected_report_descriptor_size uint16_t, buf uintptr, buf_size size_t) (r int32) {
	...
	if res > libc.Int32FromUint32(buf_size) {
		res = libc.Int32FromUint32(buf_size)
	}
	libc.Xmemcpy(tls, buf, bp, libc.Uint32FromInt32(res))
	return res
}
...
func fill_device_info_usage(tls *libc.TLS, cur_dev uintptr, handle uintptr, interface_num int32, expected_report_descriptor_size uint16_t) {
	...
	*(*uint16)(unsafe.Pointer(bp + 4098)) = uint16(0)
	res = hid_get_report_descriptor_libusb(tls, handle, interface_num, expected_report_descriptor_size, bp, uint32(4096))
	if res >= 0 {
		get_usage(tls, bp, libc.Uint32FromInt32(res), bp+4096, bp+4098)
	}
...
func create_device_info_for_device(tls *libc.TLS, device uintptr, handle uintptr, desc uintptr, config_number int32, interface_num int32) (r uintptr) {
	var cur_dev uintptr
	_ = cur_dev
	cur_dev = libc.Xcalloc(tls, uint32(1), uint32(40))
...
func get_report_descriptor_size_from_interface_descriptors(tls *libc.TLS, intf_desc uintptr) (r uint16_t) {
	...
	for extra_length >= int32(2) {
		...
		extra_length = extra_length - libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(extra)))
		extra = extra + uintptr(*(*uint8)(unsafe.Pointer(extra)))
	}
	return result
}
...
func is_xbox360(tls *libc.TLS, vendor_id uint16, intf_desc uintptr) (r int32) {
	...
	if libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(intf_desc)).FbInterfaceClass) == int32(LIBUSB_CLASS_VENDOR_SPEC) && libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(intf_desc)).FbInterfaceSubClass) == xb360_iface_subclass && (libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(intf_desc)).FbInterfaceProtocol) == xb360_iface_protocol || libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(intf_desc)).FbInterfaceProtocol) == xb360w_iface_protocol) {
		i = uint32(0)
		for {
			if !(i < libc.Uint32FromInt64(104)/libc.Uint32FromInt64(4)) {
				break
			}
...
func is_xboxone(tls *libc.TLS, vendor_id uint16, intf_desc uintptr) (r int32) {
	...
	if libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(intf_desc)).FbInterfaceNumber) == 0 && libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(intf_desc)).FbInterfaceClass) == int32(LIBUSB_CLASS_VENDOR_SPEC) && libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(intf_desc)).FbInterfaceSubClass) == xb1_iface_subclass && libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(intf_desc)).FbInterfaceProtocol) == xb1_iface_protocol {
		i = uint32(0)
		for {
			if !(i < libc.Uint32FromInt64(48)/libc.Uint32FromInt64(4)) {
				break
			}
...
func hid_enumerate(tls *libc.TLS, vendor_id uint16, product_id uint16) (r uintptr) {
	...
	var _ /* conf_desc at bp+28 */ uintptr
	var _ /* desc at bp+8 */ libusb_device_descriptor
	var _ /* devs at bp+0 */ uintptr
	var _ /* handle at bp+4 */ uintptr
	...
	*(*uintptr)(unsafe.Pointer(bp + 4)) = libc.UintptrFromInt32(0)
	...
	for {
		...
		*(*uintptr)(unsafe.Pointer(bp + 28)) = libc.UintptrFromInt32(0)
		res = libusb_get_device_descriptor(tls, dev, bp+8)
		if res < 0 {
			continue
		}
		dev_vid = (*(*libusb_device_descriptor)(unsafe.Pointer(bp + 8))).FidVendor
		dev_pid = (*(*libusb_device_descriptor)(unsafe.Pointer(bp + 8))).FidProduct
		...
		res = libusb_get_active_config_descriptor(tls, dev, bp+28)
		if res < 0 {
			libusb_get_config_descriptor(tls, dev, uint8(0), bp+28)
		}
		if *(*uintptr)(unsafe.Pointer(bp + 28)) != 0 {
			j = 0
			for {
				if !(j < libc.Int32FromUint8((*libusb_config_descriptor)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 28)))).FbNumInterfaces)) {
					break
				}
				intf = (*libusb_config_descriptor)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 28)))).Finterface1 + uintptr(j)*8
				k = 0
				for {
					if !(k < (*libusb_interface)(unsafe.Pointer(intf)).Fnum_altsetting) {
						break
					}
					intf_desc = (*libusb_interface)(unsafe.Pointer(intf)).Faltsetting + uintptr(k)*24
					if should_enumerate_interface(tls, dev_vid, intf_desc) != 0 {
						res = libusb_open(tls, dev, bp+4)
						tmp = create_device_info_for_device(tls, dev, *(*uintptr)(unsafe.Pointer(bp + 4)), bp+8, libc.Int32FromUint8((*libusb_config_descriptor)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 28)))).FbConfigurationValue), libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(intf_desc)).FbInterfaceNumber))
						if tmp != 0 {
							if cur_dev != 0 {
						...
						if res >= 0 {
							libusb_close(tls, *(*uintptr)(unsafe.Pointer(bp + 4)))
							*(*uintptr)(unsafe.Pointer(bp + 4)) = libc.UintptrFromInt32(0)
						}
						break
					}
			...
			libusb_free_config_descriptor(tls, *(*uintptr)(unsafe.Pointer(bp + 28)))
		}
	}
	libusb_free_device_list(tls, *(*uintptr)(unsafe.Pointer(bp)), int32(1))
	return root
...
func read_callback(tls *libc.TLS, transfer uintptr) {
	...
	if (*libusb_transfer)(unsafe.Pointer(transfer)).Fstatus == int32(LIBUSB_TRANSFER_COMPLETED) {
		rpt = libc.Xmalloc(tls, uint32(12))
		(*input_report)(unsafe.Pointer(rpt)).Fdata = libc.Xmalloc(tls, libc.Uint32FromInt32((*libusb_transfer)(unsafe.Pointer(transfer)).Factual_length))
		libc.Xmemcpy(tls, (*input_report)(unsafe.Pointer(rpt)).Fdata, (*libusb_transfer)(unsafe.Pointer(transfer)).Fbuffer, libc.Uint32FromInt32((*libusb_transfer)(unsafe.Pointer(transfer)).Factual_length))
		(*input_report)(unsafe.Pointer(rpt)).Flen1 = libc.Uint32FromInt32((*libusb_transfer)(unsafe.Pointer(transfer)).Factual_length)
		(*input_report)(unsafe.Pointer(rpt)).Fnext = libc.UintptrFromInt32(0)
		hidapi_thread_mutex_lock(tls, dev+48)
		if (*hid_device)(unsafe.Pointer(dev)).Finput_reports == libc.UintptrFromInt32(0) {
			(*hid_device)(unsafe.Pointer(dev)).Finput_reports = rpt
			hidapi_thread_cond_signal(tls, dev+48)
		} else {
			...
			if num_queued > int32(30) {
				return_data(tls, dev, libc.UintptrFromInt32(0), uint32(0))
			}
		}
		hidapi_thread_mutex_unlock(tls, dev+48)
	} else {
...
func read_thread(tls *libc.TLS, param uintptr) (r uintptr) {
	...
	dev = param
	length = libc.Uint32FromInt32((*hid_device)(unsafe.Pointer(dev)).Finput_ep_max_packet_size)
	buf = libc.Xmalloc(tls, length)
	(*hid_device)(unsafe.Pointer(dev)).Ftransfer = libusb_alloc_transfer(tls, 0)
	libusb_fill_interrupt_transfer(tls, (*hid_device)(unsafe.Pointer(dev)).Ftransfer, (*hid_device)(unsafe.Pointer(dev)).Fdevice_handle, libc.Uint8FromInt32((*hid_device)(unsafe.Pointer(dev)).Finput_endpoint), buf, libc.Int32FromUint32(length), __ccgo_fp(read_callback), dev, uint32(5000))
	res = libusb_submit_transfer(tls, (*hid_device)(unsafe.Pointer(dev)).Ftransfer)
	if res < 0 {
		(*hid_device)(unsafe.Pointer(dev)).Fshutdown_thread = int32(1)
		(*hid_device)(unsafe.Pointer(dev)).Ftransfer_loop_finished = int32(1)
	}
	hidapi_thread_barrier_wait(tls, dev+48)
	...
	for !((*hid_device)(unsafe.Pointer(dev)).Ftransfer_loop_finished != 0) {
		libusb_handle_events_completed(tls, usb_context, dev+148)
	}
	hidapi_thread_mutex_lock(tls, dev+48)
	hidapi_thread_cond_broadcast(tls, dev+48)
	hidapi_thread_mutex_unlock(tls, dev+48)
	return libc.UintptrFromInt32(0)
}
...
func init_xboxone(tls *libc.TLS, device_handle uintptr, idVendor uint16, idProduct uint16, conf_desc uintptr) {
	...
	for {
		...
		intf = (*libusb_config_descriptor)(unsafe.Pointer(conf_desc)).Finterface1 + uintptr(j)*8
		k = 0
		for {
			if !(k < (*libusb_interface)(unsafe.Pointer(intf)).Fnum_altsetting) {
				break
...
func hidapi_initialize_device(tls *libc.TLS, dev uintptr, intf_desc uintptr, conf_desc uintptr) (r int32) {
	...
	for {
		...
		ep = (*libusb_interface_descriptor)(unsafe.Pointer(intf_desc)).Fendpoint + uintptr(i)*20
	...
	hidapi_thread_create(tls, dev+48, __ccgo_fp(read_thread), dev)
	hidapi_thread_barrier_wait(tls, dev+48)
	return int32(1)
}
...
func hid_open_path(tls *libc.TLS, path uintptr) (r uintptr) {
	...
	var _ /* conf_desc at bp+24 */ uintptr
	var _ /* desc at bp+4 */ libusb_device_descriptor
	var _ /* dev_path at bp+28 */ [64]int8
	var _ /* devs at bp+0 */ uintptr
	...
	*(*uintptr)(unsafe.Pointer(bp)) = libc.UintptrFromInt32(0)
	...
	for {
		...
		*(*uintptr)(unsafe.Pointer(bp + 24)) = libc.UintptrFromInt32(0)
		res = libusb_get_device_descriptor(tls, usb_dev, bp+4)
		if res < 0 {
			continue
		}
		res = libusb_get_active_config_descriptor(tls, usb_dev, bp+24)
		if res < 0 {
			libusb_get_config_descriptor(tls, usb_dev, uint8(0), bp+24)
		}
		...
		j = 0
		for {
			if !(j < libc.Int32FromUint8((*libusb_config_descriptor)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 24)))).FbNumInterfaces) && !(good_open != 0)) {
				break
			}
			intf = (*libusb_config_descriptor)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 24)))).Finterface1 + uintptr(j)*8
			k = 0
			for {
				...
				intf_desc = (*libusb_interface)(unsafe.Pointer(intf)).Faltsetting + uintptr(k)*24
				if should_enumerate_interface(tls, (*(*libusb_device_descriptor)(unsafe.Pointer(bp + 4))).FidVendor, intf_desc) != 0 {
					get_path(tls, bp+28, usb_dev, libc.Int32FromUint8((*libusb_config_descriptor)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 24)))).FbConfigurationValue), libc.Int32FromUint8((*libusb_interface_descriptor)(unsafe.Pointer(intf_desc)).FbInterfaceNumber))
					if !(libc.Xstrcmp(tls, bp+28, path) != 0) {
						res = libusb_open(tls, usb_dev, dev)
						if res < 0 {
							break
						}
						good_open = hidapi_initialize_device(tls, dev, intf_desc, *(*uintptr)(unsafe.Pointer(bp + 24)))
						if !(good_open != 0) {
		...
		libusb_free_config_descriptor(tls, *(*uintptr)(unsafe.Pointer(bp + 24)))
	}
	libusb_free_device_list(tls, *(*uintptr)(unsafe.Pointer(bp)), int32(1))
	if good_open != 0 {
		return dev
...
func hid_libusb_wrap_sys_device(tls *libc.TLS, sys_dev intptr_t, interface_num int32) (r uintptr) {
	...
	*(*uintptr)(unsafe.Pointer(bp)) = libc.UintptrFromInt32(0)
	...
	for {
		...
		intf = (*libusb_config_descriptor)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp)))).Finterface1 + uintptr(j)*8
		k = 0
		for {
			if !(k < (*libusb_interface)(unsafe.Pointer(intf)).Fnum_altsetting) {
				break
...
func hid_write(tls *libc.TLS, dev uintptr, data uintptr, length size_t) (r int32) {
	...
	res = libusb_interrupt_transfer(tls, (*hid_device)(unsafe.Pointer(dev)).Fdevice_handle, libc.Uint8FromInt32((*hid_device)(unsafe.Pointer(dev)).Foutput_endpoint), data, libc.Int32FromUint32(length), bp, uint32(1000))
	if res < 0 {
		return -int32(1)
	}
...
func hid_read_timeout(tls *libc.TLS, dev uintptr, data uintptr, length size_t, milliseconds int32) (r int32) {
	...
	var _ /* ts at bp+12 */ hidapi_timespec
	_, _ = bytes_read, res
	hidapi_thread_mutex_lock(tls, dev+48)
	...
	if milliseconds == -int32(1) {
		for !((*hid_device)(unsafe.Pointer(dev)).Finput_reports != 0) && !((*hid_device)(unsafe.Pointer(dev)).Fshutdown_thread != 0) {
			hidapi_thread_cond_wait(tls, dev+48)
		}
		if (*hid_device)(unsafe.Pointer(dev)).Finput_reports != 0 {
			bytes_read = return_data(tls, dev, data, length)
		}
		...
		if milliseconds > 0 {
			hidapi_thread_gettime(tls, bp+12)
			hidapi_thread_addtime(tls, bp+12, milliseconds)
			for !((*hid_device)(unsafe.Pointer(dev)).Finput_reports != 0) && !((*hid_device)(unsafe.Pointer(dev)).Fshutdown_thread != 0) {
				res = hidapi_thread_cond_timedwait(tls, dev+48, bp+12)
				if res == 0 {
					if (*hid_device)(unsafe.Pointer(dev)).Finput_reports != 0 {
						bytes_read = return_data(tls, dev, data, length)
						break
...
func hid_send_feature_report(tls *libc.TLS, dev uintptr, data uintptr, length size_t) (r int32) {
	...
	return libc.Int32FromUint32(length)
}
...
func hid_get_indexed_string(tls *libc.TLS, dev uintptr, string_index int32, string1 uintptr, maxlen size_t) (r int32) {
	...
	if str != 0 {
		...
		*(*wchar_t)(unsafe.Pointer(string1 + uintptr(maxlen-uint32(1))*4)) = int32('\000')
		libc.Xfree(tls, str)
		return 0
	} else {
		return -int32(1)
...
var lang_map = [134]lang_map_entry{
	0: {
		Fname:        __ccgo_ts + 14437,
		Fstring_code: __ccgo_ts + 14447,
		Fusb_code:    uint16(0x0436),
	},
	1: {
		Fname:        __ccgo_ts + 14450,
		Fstring_code: __ccgo_ts + 14459,
		Fusb_code:    uint16(0x041C),
	},
	2: {
		Fname:        __ccgo_ts + 14462,
		Fstring_code: __ccgo_ts + 14492,
		Fusb_code:    uint16(0x3801),
	},
	3: {
		Fname:        __ccgo_ts + 14498,
		Fstring_code: __ccgo_ts + 14515,
		Fusb_code:    uint16(0x3C01),
	},
	4: {
		Fname:        __ccgo_ts + 14521,
		Fstring_code: __ccgo_ts + 14538,
		Fusb_code:    uint16(0x1401),
	},
	5: {
		Fname:        __ccgo_ts + 14544,
		Fstring_code: __ccgo_ts + 14559,
		Fusb_code:    uint16(0x0C01),
	},
	6: {
		Fname:        __ccgo_ts + 14565,
		Fstring_code: __ccgo_ts + 14579,
		Fusb_code:    uint16(0x0801),
	},
	7: {
		Fname:        __ccgo_ts + 14585,
		Fstring_code: __ccgo_ts + 14601,
		Fusb_code:    uint16(0x2C01),
	},
	8: {
		Fname:        __ccgo_ts + 14607,
		Fstring_code: __ccgo_ts + 14623,
		Fusb_code:    uint16(0x3401),
	},
	9: {
		Fname:        __ccgo_ts + 14629,
		Fstring_code: __ccgo_ts + 14646,
		Fusb_code:    uint16(0x3001),
	},
	10: {
		Fname:        __ccgo_ts + 14652,
		Fstring_code: __ccgo_ts + 14667,
		Fusb_code:    uint16(0x1001),
	},
	11: {
		Fname:        __ccgo_ts + 14673,
		Fstring_code: __ccgo_ts + 14690,
		Fusb_code:    uint16(0x1801),
	},
	12: {
		Fname:        __ccgo_ts + 14696,
		Fstring_code: __ccgo_ts + 14710,
		Fusb_code:    uint16(0x2001),
	},
	13: {
		Fname:        __ccgo_ts + 14716,
		Fstring_code: __ccgo_ts + 14731,
		Fusb_code:    uint16(0x4001),
	},
	14: {
		Fname:        __ccgo_ts + 14737,
		Fstring_code: __ccgo_ts + 14759,
		Fusb_code:    uint16(0x0401),
	},
	15: {
		Fname:        __ccgo_ts + 14765,
		Fstring_code: __ccgo_ts + 14780,
		Fusb_code:    uint16(0x2801),
	},
	16: {
		Fname:        __ccgo_ts + 14786,
		Fstring_code: __ccgo_ts + 14803,
		Fusb_code:    uint16(0x1C01),
	},
	17: {
		Fname:        __ccgo_ts + 14809,
		Fstring_code: __ccgo_ts + 14824,
		Fusb_code:    uint16(0x2401),
	},
	18: {
		Fname:        __ccgo_ts + 14830,
		Fstring_code: __ccgo_ts + 14839,
		Fusb_code:    uint16(0x042B),
	},
	19: {
		Fname:        __ccgo_ts + 14842,
		Fstring_code: __ccgo_ts + 14856,
		Fusb_code:    uint16(0x042C),
	},
	20: {
		Fname:        __ccgo_ts + 14862,
		Fstring_code: __ccgo_ts + 14856,
		Fusb_code:    uint16(0x082C),
	},
	21: {
		Fname:        __ccgo_ts + 14879,
		Fstring_code: __ccgo_ts + 14886,
		Fusb_code:    uint16(0x042D),
	},
	22: {
		Fname:        __ccgo_ts + 14889,
		Fstring_code: __ccgo_ts + 14900,
		Fusb_code:    uint16(0x0423),
	},
	23: {
		Fname:        __ccgo_ts + 14903,
		Fstring_code: __ccgo_ts + 14913,
		Fusb_code:    uint16(0x0402),
	},
	24: {
		Fname:        __ccgo_ts + 14916,
		Fstring_code: __ccgo_ts + 14924,
		Fusb_code:    uint16(0x0403),
	},
	25: {
		Fname:        __ccgo_ts + 14927,
		Fstring_code: __ccgo_ts + 14943,
		Fusb_code:    uint16(0x0804),
	},
	26: {
		Fname:        __ccgo_ts + 14949,
		Fstring_code: __ccgo_ts + 14973,
		Fusb_code:    uint16(0x0C04),
	},
	27: {
		Fname:        __ccgo_ts + 14979,
		Fstring_code: __ccgo_ts + 14999,
		Fusb_code:    uint16(0x1404),
	},
	28: {
		Fname:        __ccgo_ts + 15005,
		Fstring_code: __ccgo_ts + 15025,
		Fusb_code:    uint16(0x1004),
	},
	29: {
		Fname:        __ccgo_ts + 15031,
		Fstring_code: __ccgo_ts + 15048,
		Fusb_code:    uint16(0x0404),
	},
	30: {
		Fname:        __ccgo_ts + 15054,
		Fstring_code: __ccgo_ts + 15063,
		Fusb_code:    uint16(0x041A),
	},
	31: {
		Fname:        __ccgo_ts + 15066,
		Fstring_code: __ccgo_ts + 15072,
		Fusb_code:    uint16(0x0405),
	},
	32: {
		Fname:        __ccgo_ts + 15075,
		Fstring_code: __ccgo_ts + 15082,
		Fusb_code:    uint16(0x0406),
	},
	33: {
		Fname:        __ccgo_ts + 15085,
		Fstring_code: __ccgo_ts + 15105,
		Fusb_code:    uint16(0x0413),
	},
	34: {
		Fname:        __ccgo_ts + 15111,
		Fstring_code: __ccgo_ts + 15127,
		Fusb_code:    uint16(0x0813),
	},
	35: {
		Fname:        __ccgo_ts + 15133,
		Fstring_code: __ccgo_ts + 15153,
		Fusb_code:    uint16(0x0C09),
	},
	36: {
		Fname:        __ccgo_ts + 15159,
		Fstring_code: __ccgo_ts + 15176,
		Fusb_code:    uint16(0x2809),
	},
	37: {
		Fname:        __ccgo_ts + 15182,
		Fstring_code: __ccgo_ts + 15199,
		Fusb_code:    uint16(0x1009),
	},
	38: {
		Fname:        __ccgo_ts + 15205,
		Fstring_code: __ccgo_ts + 15225,
		Fusb_code:    uint16(0x2409),
	},
	39: {
		Fname:        __ccgo_ts + 15231,
		Fstring_code: __ccgo_ts + 15249,
		Fusb_code:    uint16(0x1809),
	},
	40: {
		Fname:        __ccgo_ts + 15255,
		Fstring_code: __ccgo_ts + 15273,
		Fusb_code:    uint16(0x2009),
	},
	41: {
		Fname:        __ccgo_ts + 15279,
		Fstring_code: __ccgo_ts + 15301,
		Fusb_code:    uint16(0x1409),
	},
	42: {
		Fname:        __ccgo_ts + 15307,
		Fstring_code: __ccgo_ts + 15329,
		Fusb_code:    uint16(0x3409),
	},
	43: {
		Fname:        __ccgo_ts + 15335,
		Fstring_code: __ccgo_ts + 15361,
		Fusb_code:    uint16(0x1C09),
	},
	44: {
		Fname:        __ccgo_ts + 15367,
		Fstring_code: __ccgo_ts + 15386,
		Fusb_code:    uint16(0x2C09),
	},
	45: {
		Fname:        __ccgo_ts + 15392,
		Fstring_code: __ccgo_ts + 15416,
		Fusb_code:    uint16(0x0809),
	},
	46: {
		Fname:        __ccgo_ts + 15422,
		Fstring_code: __ccgo_ts + 15446,
		Fusb_code:    uint16(0x0409),
	},
	47: {
		Fname:        __ccgo_ts + 15452,
		Fstring_code: __ccgo_ts + 15461,
		Fusb_code:    uint16(0x0425),
	},
	48: {
		Fname:        __ccgo_ts + 15464,
		Fstring_code: __ccgo_ts + 15470,
		Fusb_code:    uint16(0x0429),
	},
	49: {
		Fname:        __ccgo_ts + 15473,
		Fstring_code: __ccgo_ts + 15481,
		Fusb_code:    uint16(0x040B),
	},
	50: {
		Fname:        __ccgo_ts + 15484,
		Fstring_code: __ccgo_ts + 15492,
		Fusb_code:    uint16(0x0438),
	},
	51: {
		Fname:        __ccgo_ts + 15495,
		Fstring_code: __ccgo_ts + 15511,
		Fusb_code:    uint16(0x040C),
	},
	52: {
		Fname:        __ccgo_ts + 15517,
		Fstring_code: __ccgo_ts + 15534,
		Fusb_code:    uint16(0x080C),
	},
	53: {
		Fname:        __ccgo_ts + 15540,
		Fstring_code: __ccgo_ts + 15556,
		Fusb_code:    uint16(0x0C0C),
	},
	54: {
		Fname:        __ccgo_ts + 15562,
		Fstring_code: __ccgo_ts + 15582,
		Fusb_code:    uint16(0x140C),
	},
	55: {
		Fname:        __ccgo_ts + 15588,
		Fstring_code: __ccgo_ts + 15609,
		Fusb_code:    uint16(0x100C),
	},
	56: {
		Fname:        __ccgo_ts + 15615,
		Fstring_code: __ccgo_ts + 15632,
		Fusb_code:    uint16(0x083C),
	},
	57: {
		Fname:        __ccgo_ts + 15638,
		Fstring_code: __ccgo_ts + 15656,
		Fusb_code:    uint16(0x043C),
	},
	58: {
		Fname:        __ccgo_ts + 15659,
		Fstring_code: __ccgo_ts + 15676,
		Fusb_code:    uint16(0x0407),
	},
	59: {
		Fname:        __ccgo_ts + 15682,
		Fstring_code: __ccgo_ts + 15699,
		Fusb_code:    uint16(0x0C07),
	},
	60: {
		Fname:        __ccgo_ts + 15705,
		Fstring_code: __ccgo_ts + 15728,
		Fusb_code:    uint16(0x1407),
	},
	61: {
		Fname:        __ccgo_ts + 15734,
		Fstring_code: __ccgo_ts + 15754,
		Fusb_code:    uint16(0x1007),
	},
	62: {
		Fname:        __ccgo_ts + 15760,
		Fstring_code: __ccgo_ts + 15781,
		Fusb_code:    uint16(0x0807),
	},
	63: {
		Fname:        __ccgo_ts + 15787,
		Fstring_code: __ccgo_ts + 15793,
		Fusb_code:    uint16(0x0408),
	},
	64: {
		Fname:        __ccgo_ts + 15796,
		Fstring_code: __ccgo_ts + 15803,
		Fusb_code:    uint16(0x040D),
	},
	65: {
		Fname:        __ccgo_ts + 15806,
		Fstring_code: __ccgo_ts + 15812,
		Fusb_code:    uint16(0x0439),
	},
	66: {
		Fname:        __ccgo_ts + 15815,
		Fstring_code: __ccgo_ts + 11344,
		Fusb_code:    uint16(0x040E),
	},
	67: {
		Fname:        __ccgo_ts + 15825,
		Fstring_code: __ccgo_ts + 15835,
		Fusb_code:    uint16(0x040F),
	},
	68: {
		Fname:        __ccgo_ts + 15838,
		Fstring_code: __ccgo_ts + 15849,
		Fusb_code:    uint16(0x0421),
	},
	69: {
		Fname:        __ccgo_ts + 15852,
		Fstring_code: __ccgo_ts + 15868,
		Fusb_code:    uint16(0x0410),
	},
	70: {
		Fname:        __ccgo_ts + 15874,
		Fstring_code: __ccgo_ts + 15896,
		Fusb_code:    uint16(0x0810),
	},
	71: {
		Fname:        __ccgo_ts + 15902,
		Fstring_code: __ccgo_ts + 15911,
		Fusb_code:    uint16(0x0411),
	},
	72: {
		Fname:        __ccgo_ts + 15914,
		Fstring_code: __ccgo_ts + 15921,
		Fusb_code:    uint16(0x0412),
	},
	73: {
		Fname:        __ccgo_ts + 15924,
		Fstring_code: __ccgo_ts + 15932,
		Fusb_code:    uint16(0x0426),
	},
	74: {
		Fname:        __ccgo_ts + 15935,
		Fstring_code: __ccgo_ts + 15946,
		Fusb_code:    uint16(0x0427),
	},
	75: {
		Fname:        __ccgo_ts + 15949,
		Fstring_code: __ccgo_ts + 15968,
		Fusb_code:    uint16(0x042F),
	},
	76: {
		Fname:        __ccgo_ts + 15971,
		Fstring_code: __ccgo_ts + 15988,
		Fusb_code:    uint16(0x043E),
	},
	77: {
		Fname:        __ccgo_ts + 15994,
		Fstring_code: __ccgo_ts + 16011,
		Fusb_code:    uint16(0x083E),
	},
	78: {
		Fname:        __ccgo_ts + 16017,
		Fstring_code: __ccgo_ts + 16025,
		Fusb_code:    uint16(0x043A),
	},
	79: {
		Fname:        __ccgo_ts + 16028,
		Fstring_code: __ccgo_ts + 16036,
		Fusb_code:    uint16(0x044E),
	},
	80: {
		Fname:        __ccgo_ts + 16039,
		Fstring_code: __ccgo_ts + 16057,
		Fusb_code:    uint16(0x0414),
	},
	81: {
		Fname:        __ccgo_ts + 16063,
		Fstring_code: __ccgo_ts + 16057,
		Fusb_code:    uint16(0x0814),
	},
	82: {
		Fname:        __ccgo_ts + 16083,
		Fstring_code: __ccgo_ts + 16090,
		Fusb_code:    uint16(0x0415),
	},
	83: {
		Fname:        __ccgo_ts + 16093,
		Fstring_code: __ccgo_ts + 16115,
		Fusb_code:    uint16(0x0816),
	},
	84: {
		Fname:        __ccgo_ts + 16121,
		Fstring_code: __ccgo_ts + 16141,
		Fusb_code:    uint16(0x0416),
	},
	85: {
		Fname:        __ccgo_ts + 16147,
		Fstring_code: __ccgo_ts + 16161,
		Fusb_code:    uint16(0x0417),
	},
	86: {
		Fname:        __ccgo_ts + 16164,
		Fstring_code: __ccgo_ts + 16183,
		Fusb_code:    uint16(0x0418),
	},
	87: {
		Fname:        __ccgo_ts + 16186,
		Fstring_code: __ccgo_ts + 16217,
		Fusb_code:    uint16(0x0818),
	},
	88: {
		Fname:        __ccgo_ts + 16223,
		Fstring_code: __ccgo_ts + 11338,
		Fusb_code:    uint16(0x0419),
	},
	89: {
		Fname:        __ccgo_ts + 16231,
		Fstring_code: __ccgo_ts + 16261,
		Fusb_code:    uint16(0x0819),
	},
	90: {
		Fname:        __ccgo_ts + 16267,
		Fstring_code: __ccgo_ts + 16276,
		Fusb_code:    uint16(0x044F),
	},
	91: {
		Fname:        __ccgo_ts + 16279,
		Fstring_code: __ccgo_ts + 16298,
		Fusb_code:    uint16(0x0C1A),
	},
	92: {
		Fname:        __ccgo_ts + 16304,
		Fstring_code: __ccgo_ts + 16298,
		Fusb_code:    uint16(0x081A),
	},
	93: {
		Fname:        __ccgo_ts + 16320,
		Fstring_code: __ccgo_ts + 16329,
		Fusb_code:    uint16(0x0432),
	},
	94: {
		Fname:        __ccgo_ts + 16332,
		Fstring_code: __ccgo_ts + 16342,
		Fusb_code:    uint16(0x0424),
	},
	95: {
		Fname:        __ccgo_ts + 16345,
		Fstring_code: __ccgo_ts + 16352,
		Fusb_code:    uint16(0x041B),
	},
	96: {
		Fname:        __ccgo_ts + 16355,
		Fstring_code: __ccgo_ts + 16363,
		Fusb_code:    uint16(0x042E),
	},
	97: {
		Fname:        __ccgo_ts + 16366,
		Fstring_code: __ccgo_ts + 16396,
		Fusb_code:    uint16(0x040A),
	},
	98: {
		Fname:        __ccgo_ts + 16402,
		Fstring_code: __ccgo_ts + 16422,
		Fusb_code:    uint16(0x2C0A),
	},
	99: {
		Fname:        __ccgo_ts + 16428,
		Fstring_code: __ccgo_ts + 16446,
		Fusb_code:    uint16(0x400A),
	},
	100: {
		Fname:        __ccgo_ts + 16452,
		Fstring_code: __ccgo_ts + 16468,
		Fusb_code:    uint16(0x340A),
	},
	101: {
		Fname:        __ccgo_ts + 16474,
		Fstring_code: __ccgo_ts + 16493,
		Fusb_code:    uint16(0x240A),
	},
	102: {
		Fname:        __ccgo_ts + 16499,
		Fstring_code: __ccgo_ts + 16520,
		Fusb_code:    uint16(0x140A),
	},
	103: {
		Fname:        __ccgo_ts + 16526,
		Fstring_code: __ccgo_ts + 16555,
		Fusb_code:    uint16(0x1C0A),
	},
	104: {
		Fname:        __ccgo_ts + 16561,
		Fstring_code: __ccgo_ts + 16579,
		Fusb_code:    uint16(0x300A),
	},
	105: {
		Fname:        __ccgo_ts + 16585,
		Fstring_code: __ccgo_ts + 16605,
		Fusb_code:    uint16(0x100A),
	},
	106: {
		Fname:        __ccgo_ts + 16611,
		Fstring_code: __ccgo_ts + 16630,
		Fusb_code:    uint16(0x480A),
	},
	107: {
		Fname:        __ccgo_ts + 16636,
		Fstring_code: __ccgo_ts + 16653,
		Fusb_code:    uint16(0x080A),
	},
	108: {
		Fname:        __ccgo_ts + 16659,
		Fstring_code: __ccgo_ts + 16679,
		Fusb_code:    uint16(0x4C0A),
	},
	109: {
		Fname:        __ccgo_ts + 16685,
		Fstring_code: __ccgo_ts + 16702,
		Fusb_code:    uint16(0x180A),
	},
	110: {
		Fname:        __ccgo_ts + 16708,
		Fstring_code: __ccgo_ts + 16723,
		Fusb_code:    uint16(0x280A),
	},
	111: {
		Fname:        __ccgo_ts + 16729,
		Fstring_code: __ccgo_ts + 16751,
		Fusb_code:    uint16(0x500A),
	},
	112: {
		Fname:        __ccgo_ts + 16757,
		Fstring_code: __ccgo_ts + 16776,
		Fusb_code:    uint16(0x3C0A),
	},
	113: {
		Fname:        __ccgo_ts + 16782,
		Fstring_code: __ccgo_ts + 16804,
		Fusb_code:    uint16(0x440A),
	},
	114: {
		Fname:        __ccgo_ts + 16810,
		Fstring_code: __ccgo_ts + 16828,
		Fusb_code:    uint16(0x380A),
	},
	115: {
		Fname:        __ccgo_ts + 16834,
		Fstring_code: __ccgo_ts + 16854,
		Fusb_code:    uint16(0x200A),
	},
	116: {
		Fname:        __ccgo_ts + 16860,
		Fstring_code: __ccgo_ts + 16875,
		Fusb_code:    uint16(0x0430),
	},
	117: {
		Fname:        __ccgo_ts + 16878,
		Fstring_code: __ccgo_ts + 16886,
		Fusb_code:    uint16(0x0441),
	},
	118: {
		Fname:        __ccgo_ts + 16889,
		Fstring_code: __ccgo_ts + 16906,
		Fusb_code:    uint16(0x041D),
	},
	119: {
		Fname:        __ccgo_ts + 16912,
		Fstring_code: __ccgo_ts + 16930,
		Fusb_code:    uint16(0x081D),
	},
	120: {
		Fname:        __ccgo_ts + 16936,
		Fstring_code: __ccgo_ts + 16942,
		Fusb_code:    uint16(0x0449),
	},
	121: {
		Fname:        __ccgo_ts + 16945,
		Fstring_code: __ccgo_ts + 16951,
		Fusb_code:    uint16(0x0444),
	},
	122: {
		Fname:        __ccgo_ts + 16954,
		Fstring_code: __ccgo_ts + 16959,
		Fusb_code:    uint16(0x041E),
	},
	123: {
		Fname:        __ccgo_ts + 16962,
		Fstring_code: __ccgo_ts + 16970,
		Fusb_code:    uint16(0x041F),
	},
	124: {
		Fname:        __ccgo_ts + 16973,
		Fstring_code: __ccgo_ts + 16980,
		Fusb_code:    uint16(0x0431),
	},
	125: {
		Fname:        __ccgo_ts + 16983,
		Fstring_code: __ccgo_ts + 16993,
		Fusb_code:    uint16(0x0422),
	},
	126: {
		Fname:        __ccgo_ts + 16996,
		Fstring_code: __ccgo_ts + 17001,
		Fusb_code:    uint16(0x0420),
	},
	127: {
		Fname:        __ccgo_ts + 17004,
		Fstring_code: __ccgo_ts + 17021,
		Fusb_code:    uint16(0x0843),
	},
	128: {
		Fname:        __ccgo_ts + 17027,
		Fstring_code: __ccgo_ts + 17021,
		Fusb_code:    uint16(0x0443),
	},
	129: {
		Fname:        __ccgo_ts + 17043,
		Fstring_code: __ccgo_ts + 17054,
		Fusb_code:    uint16(0x042A),
	},
	130: {
		Fname:        __ccgo_ts + 17057,
		Fstring_code: __ccgo_ts + 17063,
		Fusb_code:    uint16(0x0434),
	},
	131: {
		Fname:        __ccgo_ts + 17066,
		Fstring_code: __ccgo_ts + 17074,
		Fusb_code:    uint16(0x043D),
	},
	132: {
		Fname:        __ccgo_ts + 17077,
		Fstring_code: __ccgo_ts + 17082,
...
func get_usb_code_for_current_locale(tls *libc.TLS) (r uint16_t) {
	...
	var _ /* search_string at bp+0 */ [64]int8
	_, _, _ = lang, locale, ptr
	locale = libc.Xsetlocale(tls, 0, libc.UintptrFromInt32(0))
	if !(locale != 0) {
		return uint16(0x0)
	}
	libc.Xstrncpy(tls, bp, locale, uint32(libc.Uint32FromInt64(64)-libc.Uint32FromInt32(1)))
	(*(*[64]int8)(unsafe.Pointer(bp)))[libc.Uint32FromInt64(64)-libc.Uint32FromInt32(1)] = int8('\000')
	ptr = bp
	for *(*int8)(unsafe.Pointer(ptr)) != 0 {
		*(*int8)(unsafe.Pointer(ptr)) = int8(libc.Xtolower(tls, int32(*(*int8)(unsafe.Pointer(ptr)))))
		if int32(*(*int8)(unsafe.Pointer(ptr))) == int32('.') {
			*(*int8)(unsafe.Pointer(ptr)) = int8('\000')
			break
		}
		ptr = ptr + 1
	}
	...
	for *(*int8)(unsafe.Pointer(ptr)) != 0 {
		*(*int8)(unsafe.Pointer(ptr)) = int8(libc.Xtolower(tls, int32(*(*int8)(unsafe.Pointer(ptr)))))
		if int32(*(*int8)(unsafe.Pointer(ptr))) == int32('_') {
			*(*int8)(unsafe.Pointer(ptr)) = int8('\000')
			break
		}
		ptr = ptr + 1
...
var usbi_backend = usbi_os_backend{
	...
	Fcontext_priv_size:       uint32(4),
	Fdevice_priv_size:        uint32(20),
	Fdevice_handle_priv_size: uint32(16),
	Ftransfer_priv_size:      uint32(24),
}
