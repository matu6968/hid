// Code generated for linux/loong64 by 'ccgo -o /zram/hid/hid_ccgo_linux_loong64.go /zram/hid/amalgamation/hid_libusb_amalgamation.c', DO NOT EDIT.

//go:build !cgo && linux && loong64
...
func read_sysfs_attr(tls *libc.TLS, ctx uintptr, sysfs_dir uintptr, attr uintptr, max_value int32, value_p uintptr) (r1 int32) {
	...
	if !(libc.BoolInt32(libc.Uint32FromInt8((*(*[20]int8)(unsafe.Pointer(bp)))[0])-libc.Uint32FromUint8('0') < libc.Uint32FromInt32(10)) != 0) {
		...
		if int32((*(*[20]int8)(unsafe.Pointer(bp)))[r-int64(1)]) != int32('\n') {
	...
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	...
	if bp == *(*uintptr)(unsafe.Pointer(bp + 24)) || value < 0 || value > int64(max_value) || *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != 0 {
		...
		if int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 24))))) != int32('\000') {
			if int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 24))))) == int32('.') && libc.BoolInt32(libc.Uint32FromInt8(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 24)) + libc.UintptrFromInt32(1))))-uint32('0') < uint32(10)) != 0 {
				*(*uintptr)(unsafe.Pointer(bp + 24))++
				for libc.BoolInt32(libc.Uint32FromInt8(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 24)))))-uint32('0') < uint32(10)) != 0 {
					*(*uintptr)(unsafe.Pointer(bp + 24))++
				}
			}
			if int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 24))))) != int32('\000') {
...
func linux_get_parent_info(tls *libc.TLS, dev uintptr, sysfs_dir uintptr) (r int32) {
	...
	*(*uintptr)(unsafe.Pointer(bp)) = libc.Xstrdup(tls, sysfs_dir)
	...
	if v3 || v2 != 0 {
		...
		if port_number < 0 || port_number > int64(0x7fffffff) || start == *(*uintptr)(unsafe.Pointer(bp + 8)) || int32('\000') != int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 8))))) {
...
func sysfs_get_device_list(tls *libc.TLS, ctx uintptr) (r int32) {
	...
	for {
		...
		if !(libc.BoolInt32(libc.Uint32FromInt8(*(*int8)(unsafe.Pointer(entry + 19)))-libc.Uint32FromUint8('0') < libc.Uint32FromInt32(10)) != 0) && libc.Xstrncmp(tls, entry+19, __ccgo_ts+2835, uint64(3)) != 0 || libc.Xstrchr(tls, entry+19, int32(':')) != 0 {
			continue
		}
		num_devices++
...
func libusb_setlocale(tls *libc.TLS, locale uintptr) (r int32) {
	var i size_t
	_ = i
	if !(locale != 0) || libc.Xstrlen(tls, locale) < uint64(2) || int32(*(*int8)(unsafe.Pointer(locale + 2))) != int32('\000') && int32(*(*int8)(unsafe.Pointer(locale + 2))) != int32('-') && int32(*(*int8)(unsafe.Pointer(locale + 2))) != int32('_') && int32(*(*int8)(unsafe.Pointer(locale + 2))) != int32('.') {
		return int32(LIBUSB_ERROR_INVALID_PARAM)
	}
	i = uint64(0)
	for {
...
func hid_open_path(tls *libc.TLS, path uintptr) (r uintptr) {
	...
	var _ /* dev_path at bp+40 */ [64]int8
	var _ /* devs at bp+0 */ uintptr
...
func get_usb_code_for_current_locale(tls *libc.TLS) (r uint16_t) {
	...
	(*(*[64]int8)(unsafe.Pointer(bp)))[libc.Uint64FromInt64(64)-libc.Uint64FromInt32(1)] = int8('\000')
	ptr = bp
