// Code generated for linux/arm by 'ccgo -o test.go /home/builduser/hid/amalgamation/hid_libusb_amalgamation.c', DO NOT EDIT.
...
func op_init(tls *libc.TLS, ctx uintptr) (r1 int32) {
	...
	if !(kernel_version_ge(tls, bp, int32(2), int32(6), int32(32)) != 0) {
		...
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_ERROR), uintptr(unsafe.Pointer(&__func__25)), __ccgo_ts+1463, libc.VaList(bp+112, (*(*kernel_version)(unsafe.Pointer(bp))).Fmajor, (*(*kernel_version)(unsafe.Pointer(bp))).Fminor, v1))
		return int32(LIBUSB_ERROR_NOT_SUPPORTED)
	}
	usbfs_path = find_usbfs_path(tls)
	if !(usbfs_path != 0) {
		usbfs_path = __ccgo_ts + 1348
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__25)), __ccgo_ts+1512, libc.VaList(bp+112, usbfs_path))
	} else {
		usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__25)), __ccgo_ts+1551, libc.VaList(bp+112, usbfs_path))
	}
	...
	usbi_log(tls, ctx, int32(LIBUSB_LOG_LEVEL_DEBUG), uintptr(unsafe.Pointer(&__func__25)), __ccgo_ts+1569, libc.VaList(bp+112, max_iso_packet_len))
	if sysfs_available == -int32(1) {
		r = libc.Xstatfs(tls, __ccgo_ts+1612, bp+16)
		if r == 0 && (*(*statfs1)(unsafe.Pointer(bp + 16))).Ff_type == uint32(0x62656572) {
...
func read_sysfs_attr(tls *libc.TLS, ctx uintptr, sysfs_dir uintptr, attr uintptr, max_value int32, value_p uintptr) (r1 int32) {
	...
	if !(libc.BoolInt32(uint32((*(*[20]uint8)(unsafe.Pointer(bp)))[0])-libc.Uint32FromUint8('0') < libc.Uint32FromInt32(10)) != 0) {
		...
		if libc.Int32FromUint8((*(*[20]uint8)(unsafe.Pointer(bp)))[r-int32(1)]) != int32('\n') {
	...
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	...
	if bp == *(*uintptr)(unsafe.Pointer(bp + 20)) || value < 0 || value > max_value || *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != 0 {
		...
		if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 20))))) != int32('\000') {
			if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 20))))) == int32('.') && libc.BoolInt32(uint32(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 20)) + libc.UintptrFromInt32(1))))-uint32('0') < uint32(10)) != 0 {
				*(*uintptr)(unsafe.Pointer(bp + 20)) = *(*uintptr)(unsafe.Pointer(bp + 20)) + 1
				for libc.BoolInt32(uint32(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 20)))))-uint32('0') < uint32(10)) != 0 {
					*(*uintptr)(unsafe.Pointer(bp + 20)) = *(*uintptr)(unsafe.Pointer(bp + 20)) + 1
				}
			}
			if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 20))))) != int32('\000') {
...
func linux_get_parent_info(tls *libc.TLS, dev uintptr, sysfs_dir uintptr) (r int32) {
	...
	*(*uintptr)(unsafe.Pointer(bp)) = libc.Xstrdup(tls, sysfs_dir)
	...
	if v3 || v2 != 0 {
		...
		if port_number < 0 || port_number > int32(2147483647) || start == *(*uintptr)(unsafe.Pointer(bp + 4)) || int32('\000') != libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 4))))) {
...
func sysfs_get_device_list(tls *libc.TLS, ctx uintptr) (r int32) {
	...
	for {
		...
		if !(libc.BoolInt32(uint32(*(*uint8)(unsafe.Pointer(entry + 19)))-libc.Uint32FromUint8('0') < libc.Uint32FromInt32(10)) != 0) && libc.Xstrncmp(tls, entry+19, __ccgo_ts+2835, uint32(3)) != 0 || libc.Xstrchr(tls, entry+19, int32(':')) != 0 {
			continue
		}
...
func discard_urbs(tls *libc.TLS, itransfer uintptr, first int32, last_plus_one int32) (r int32) {
	...
	transfer = itransfer + uintptr((libc.Uint32FromInt64(88)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
	...
	for {
		...
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(22) {
			if (*usbi_transfer)(unsafe.Pointer(transfer-uintptr((libc.Uint32FromInt64(88)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev != 0 {
				v2 = (*libusb_device)(unsafe.Pointer((*usbi_transfer)(unsafe.Pointer(transfer - uintptr((libc.Uint32FromInt64(88)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev)).Fctx
			} else {
				v2 = libc.UintptrFromInt32(0)
			}
...
func submit_bulk_transfer(tls *libc.TLS, itransfer uintptr) (r1 int32) {
	...
	if (*usbi_transfer)(unsafe.Pointer(transfer-uintptr((libc.Uint32FromInt64(88)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev != 0 {
		v3 = (*libusb_device)(unsafe.Pointer((*usbi_transfer)(unsafe.Pointer(transfer - uintptr((libc.Uint32FromInt64(88)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev)).Fctx
	} else {
...
func submit_control_transfer(tls *libc.TLS, itransfer uintptr) (r1 int32) {
	...
	if r < 0 {
		...
		if (*usbi_transfer)(unsafe.Pointer(transfer-uintptr((libc.Uint32FromInt64(88)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev != 0 {
			v1 = (*libusb_device)(unsafe.Pointer((*usbi_transfer)(unsafe.Pointer(transfer - uintptr((libc.Uint32FromInt64(88)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev)).Fctx
		} else {
			v1 = libc.UintptrFromInt32(0)
		}
...
func handle_bulk_completion(tls *libc.TLS, itransfer uintptr, urb uintptr) (r int32) {
	...
	if (*linux_transfer_priv)(unsafe.Pointer(tpriv)).Freap_action != int32(NORMAL) {
		...
		if (*usbfs_urb)(unsafe.Pointer(urb)).Factual_length > 0 {
			...
			*(*int32)(unsafe.Pointer(itransfer + 64)) += (*usbfs_urb)(unsafe.Pointer(urb)).Factual_length
		}
...
func calculate_timeout(tls *libc.TLS, itransfer uintptr) {
	...
	if !(timeout != 0) {
		...
		(*timespec)(unsafe.Pointer(itransfer + 48)).Ftv_nsec = v1
		(*timespec)(unsafe.Pointer(itransfer + 48)).Ftv_sec = int64(v1)
		return
	}
	usbi_get_monotonic_time(tls, itransfer+48)
...
func libusb_alloc_transfer(tls *libc.TLS, iso_packets int32) (r uintptr) {
	...
	usbi_transfer_size = uint32((libc.Uint32FromInt64(88) + (libc.Uint32FromInt64(4) - libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4) - libc.Uint32FromInt32(1)))
...
func libusb_free_transfer(tls *libc.TLS, transfer uintptr) {
	...
	itransfer = transfer - uintptr((libc.Uint32FromInt64(88)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
...
func remove_from_flying_list(tls *libc.TLS, itransfer uintptr) (r1 int32) {
	...
	ctx = v1
	r = 0
	rearm_timer = libc.BoolInt32(((*timespec)(unsafe.Pointer(itransfer+48)).Ftv_sec != 0 || (*timespec)(unsafe.Pointer(itransfer+48)).Ftv_nsec != 0) && uintptr(uint32((*list_head)(unsafe.Pointer(ctx+148)).Fnext)-uint32(libc.UintptrFromInt32(0)+28)) == itransfer)
	list_del(tls, itransfer+28)
	if rearm_timer != 0 {
...
func libusb_submit_transfer(tls *libc.TLS, transfer uintptr) (r1 int32) {
	...
	if r == int32(LIBUSB_SUCCESS) {
		*(*uint32_t)(unsafe.Pointer(itransfer + 72)) |= uint32(USBI_TRANSFER_IN_FLIGHT)
	}
	usbi_mutex_unlock(tls, itransfer)
	if r != int32(LIBUSB_SUCCESS) {
		usbi_mutex_lock(tls, ctx+124)
...
func libusb_cancel_transfer(tls *libc.TLS, transfer uintptr) (r1 int32) {
	...
	if r < 0 {
		...
		if r == int32(LIBUSB_ERROR_NO_DEVICE) {
			*(*uint32_t)(unsafe.Pointer(itransfer + 72)) |= uint32(USBI_TRANSFER_DEVICE_DISAPPEARED)
		}
	}
	*(*uint32_t)(unsafe.Pointer(itransfer + 72)) |= uint32(USBI_TRANSFER_CANCELLING)
	goto out
out:
	;
	usbi_mutex_unlock(tls, itransfer)
...
func usbi_handle_transfer_completion(tls *libc.TLS, itransfer uintptr, status libusb_transfer_status) (r1 int32) {
	...
	usbi_mutex_lock(tls, itransfer)
	*(*uint32_t)(unsafe.Pointer(itransfer + 72)) &= libc.Uint32FromInt32(^int32(USBI_TRANSFER_IN_FLIGHT))
	usbi_mutex_unlock(tls, itransfer)
...
func handle_timeout(tls *libc.TLS, itransfer uintptr) {
	...
	_, _, _ = r, transfer, v1
	transfer = itransfer + uintptr((libc.Uint32FromInt64(88)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
	*(*uint32_t)(unsafe.Pointer(itransfer + 76)) |= uint32(USBI_TRANSFER_TIMEOUT_HANDLED)
	r = libusb_cancel_transfer(tls, transfer)
	if r == int32(LIBUSB_SUCCESS) {
		*(*uint32_t)(unsafe.Pointer(itransfer + 76)) |= uint32(USBI_TRANSFER_TIMED_OUT)
	} else {
		if (*usbi_transfer)(unsafe.Pointer(transfer-uintptr((libc.Uint32FromInt64(88)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev != 0 {
			v1 = (*libusb_device)(unsafe.Pointer((*usbi_transfer)(unsafe.Pointer(transfer - uintptr((libc.Uint32FromInt64(88)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))))).Fdev)).Fctx
		} else {
...
func libusb_get_next_timeout(tls *libc.TLS, ctx uintptr, tv uintptr) (r int32) {
	...
	*(*timespec)(unsafe.Pointer(bp + 16)) = timespec{}
	...
	for {
		...
		if !((*timespec)(unsafe.Pointer(itransfer+48)).Ftv_sec != 0 || (*timespec)(unsafe.Pointer(itransfer+48)).Ftv_nsec != 0) {
			break
		}
...
func usbi_handle_disconnect(tls *libc.TLS, ctx uintptr, dev_handle uintptr) {
	...
	for int32(1) != 0 {
		...
		for {
			...
			cur_transfer = cur + uintptr((libc.Uint32FromInt64(88)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
		...
		transfer_to_cancel = to_cancel + uintptr((libc.Uint32FromInt64(88)+(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1))) & ^(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)))
...
func libusb_setlocale(tls *libc.TLS, locale uintptr) (r int32) {
	var i size_t
	_ = i
	if !(locale != 0) || libc.Xstrlen(tls, locale) < uint32(2) || libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(locale + 2))) != int32('\000') && libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(locale + 2))) != int32('-') && libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(locale + 2))) != int32('_') && libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(locale + 2))) != int32('.') {
		return int32(LIBUSB_ERROR_INVALID_PARAM)
	}
	i = uint32(0)
	for {
...
func hid_open_path(tls *libc.TLS, path uintptr) (r uintptr) {
	...
	var _ /* dev_path at bp+28 */ [64]uint8
	var _ /* devs at bp+0 */ uintptr
...
func hid_read_timeout(tls *libc.TLS, dev uintptr, data uintptr, length size_t, milliseconds int32) (r int32) {
	...
	var _ /* ts at bp+16 */ hidapi_timespec
	_, _ = bytes_read, res
	hidapi_thread_mutex_lock(tls, dev+48)
	...
	if milliseconds == -int32(1) {
		...
		if milliseconds > 0 {
			hidapi_thread_gettime(tls, bp+16)
			hidapi_thread_addtime(tls, bp+16, milliseconds)
			for !((*hid_device)(unsafe.Pointer(dev)).Finput_reports != 0) && !((*hid_device)(unsafe.Pointer(dev)).Fshutdown_thread != 0) {
				res = hidapi_thread_cond_timedwait(tls, dev+48, bp+16)
				if res == 0 {
					if (*hid_device)(unsafe.Pointer(dev)).Finput_reports != 0 {
						bytes_read = return_data(tls, dev, data, length)
						break
...
func get_usb_code_for_current_locale(tls *libc.TLS) (r uint16_t) {
	...
	(*(*[64]uint8)(unsafe.Pointer(bp)))[libc.Uint32FromInt64(64)-libc.Uint32FromInt32(1)] = uint8('\000')
	ptr = bp
